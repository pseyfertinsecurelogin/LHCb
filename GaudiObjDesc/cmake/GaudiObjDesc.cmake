...
if(GOD_FORMATTING_COMMAND)
  ...
  if(NOT EXISTS "${CMAKE_BINARY_DIR}/.clang-format" AND NOT EXISTS "${CMAKE_SOURCE_DIR}/.clang-format")
    message(STATUS "Download clang-format style for GaudiObjDesc generated files")
    file(DOWNLOAD "${GOD_CLANG_FORMAT_STYLE_URL}" "${CMAKE_BINARY_DIR}/.clang-format" STATUS GOD_CLANG_FORMAT_STYLE_DOWNLOAD_STATUS)
    if(NOT "${GOD_CLANG_FORMAT_STYLE_DOWNLOAD_STATUS}" MATCHES "^0;.*")
      message(WARNING "Download of clang-format style failed: ${GOD_CLANG_FORMAT_STYLE_DOWNLOAD_STATUS}\nformatting ignored")
      set(GOD_FORMATTING_FLAG)
      set(GOD_FORMATTING_COMMAND)
    endif()
  endif()
endif()
