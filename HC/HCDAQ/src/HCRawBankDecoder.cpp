...
HCRawBankDecoder::operator()(const LHCb::RawEvent& rawEvent, const LHCb::ODIN& odin) const
{
  ...
  if (banks.empty()) {
    Warning("Cannot find HC raw banks", StatusCode::SUCCESS).ignore();
  }
  ...
  for (const auto& bank : banks) {
    ...
    if (version != 2 && version != 3) {
      throw GaudiException("Unknown raw bank version (" + std::to_string(version ) + ")",
...
//=============================================================================
void HCRawBankDecoder::decode(const LHCb::RawBank& bank,
...
//=============================================================================
void HCRawBankDecoder::decodeErrorBank(const LHCb::RawBank& bank,
                                       const int bxid) const {
