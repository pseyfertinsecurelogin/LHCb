...
public:
  ...
  inline IDetectorElement::IDEContainer::iterator childBegin() override { return childIDetectorElements().begin(); }
  inline IDetectorElement::IDEContainer::const_iterator childBegin() const override {
    return childIDetectorElements().begin();
  }
  inline IDetectorElement::IDEContainer::iterator       childEnd() override { return childIDetectorElements().end(); }
  inline IDetectorElement::IDEContainer::const_iterator childEnd() const override {
    return childIDetectorElements().end();
  }
...
protected:
  ...
  inline void Assert( bool assertion, const std::string& message = "DetectorElement Unknown Exception" ) const;

  inline void Assert( bool assertion, const char* message ) const;
...
inline void DetectorElement::Assert( bool assertion, const char* assertionName ) const {
  if ( !assertion ) { throw DetectorElementException( assertionName, this ); }
}
///////////////////////////////////////////////////////////////////////////////
