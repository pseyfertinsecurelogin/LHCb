...
namespace DetDesc {
  namespace Params {
     ...
     *   @date 2009-12-06
     */
    GAUDI_API std::string toStr( const DetDesc::Params::Histo1D& histo );
     ...
     *   @date 2009-12-06
     */
    GAUDI_API std::string toStr( const DetDesc::Params::Histo2D& histo );
  } // namespace Params
} // namespace DetDesc
// ============================================================================
 ...
 */
template <>
inline std::string Param<DetDesc::Params::Histo1D>::toStr() const {
 ...
 */
template <>
inline std::string Param<DetDesc::Params::Histo2D>::toStr() const {
  return DetDesc::Params::toStr( m_val );
}
// ============================================================================
// The END
