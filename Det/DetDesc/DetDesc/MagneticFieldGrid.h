...
namespace LHCb {
  ...
  public:
    template <class vectype, size_t width>
    std::array<vectype, 3> horizontallyVectorizedFieldVectorClosestPoint( const std::array<vectype, 3>& point ) const {
      std::array<vectype, 3> bf{vectype{0.}, vectype{0.}, vectype{0.}};

      const std::array<vectype, 3> Nxyz{vectype{(double)m_Nxyz_V[0]}, vectype{(double)m_Nxyz_V[1]},
                                        vectype{(double)m_Nxyz_V[2]}};
      const std::array<vectype, 3> inverted_Dxyz{vectype{m_invDxyz_V[0]}, vectype{m_invDxyz_V[1]},
                                                 vectype{m_invDxyz_V[2]}};
      ...
      //      _j < m_Nxyz_V[1]-1 &&
      //      _k < m_Nxyz_V[2]-1 ) {
      const auto condition{i < Nxyz[0] - 1. && j < Nxyz[1] - 1. && k < Nxyz[2] - 1.};
    ...
    template <class vectype, size_t width>
    std::array<vectype, 3> horizontallyVectorizedFieldVector( const std::array<vectype, 3>& point ) const {
      std::array<vectype, 3> bf{vectype{0.}, vectype{0.}, vectype{0.}};
...
#if defined( __SSE__ )
template std::array<Vec2d, 3>
LHCb::MagneticFieldGrid::horizontallyVectorizedFieldVector<Vec2d, 2>( const std::array<Vec2d, 3>& ) const;
#endif
#if defined( __AVX__ )
template std::array<Vec4d, 3>
LHCb::MagneticFieldGrid::horizontallyVectorizedFieldVector<Vec4d, 4>( const std::array<Vec4d, 3>& ) const;
#endif
#if defined( __AVX512F__ )
template std::array<Vec8d, 3>
LHCb::MagneticFieldGrid::horizontallyVectorizedFieldVector<Vec8d, 8>( const std::array<Vec8d, 3>& ) const;
#endif
