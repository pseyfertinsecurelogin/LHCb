...
typedef enum { stateUndefined = 0, stateSolid, stateLiquid, stateGas } eState;
...
protected:
  ...
  Material( const std::string& name = "", const double dens = 0, const double rl = 0, const double al = 0,
...
/////////////////////////////////////////////////////////////////////////////////
inline std::ostream& operator<<( std::ostream& os, const Material& mat ) { return mat.fillStream( os ); }
/////////////////////////////////////////////////////////////////////////////////
inline MsgStream& operator<<( MsgStream& os, const Material& mat ) { return mat.fillStream( os ); }
/////////////////////////////////////////////////////////////////////////////////
...
inline const std::string& Material::name() const {
  return ( !m_name.empty() ? m_name : 0 != registry() ? registry()->identifier() : m_name );
}
