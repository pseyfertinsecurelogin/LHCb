...
///
inline std::ostream& operator<<( std::ostream& os, const IDetectorElement& de ) { return de.printOut( os ); }
///
inline std::ostream& operator<<( std::ostream& os, const IDetectorElement* de ) {
