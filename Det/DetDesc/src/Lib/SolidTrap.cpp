...
void SolidTrap::makeAll()
{
  ...
  SolidPolyHedronHelper::reset() ;
  {
    ...
    ///
    m_ph_vertices.emplace_back( -fDz * fTthetaCphi - fDy1 * fTalpha1 - fDx1 ,
                                -fDz * fTthetaSphi - fDy1 , -fDz ) ;
    m_ph_vertices.emplace_back( -fDz * fTthetaCphi - fDy1 * fTalpha1 + fDx1 ,
                                -fDz * fTthetaSphi - fDy1 , -fDz ) ;
    m_ph_vertices.emplace_back( -fDz * fTthetaCphi + fDy1 * fTalpha1 - fDx2 ,
                                -fDz * fTthetaSphi + fDy1 , -fDz ) ;
    m_ph_vertices.emplace_back( -fDz * fTthetaCphi + fDy1 * fTalpha1 + fDx2 ,
                                -fDz * fTthetaSphi + fDy1 , -fDz ) ;
    m_ph_vertices.emplace_back( +fDz * fTthetaCphi - fDy2 * fTalpha2 - fDx3 ,
                                +fDz * fTthetaSphi - fDy2 , +fDz ) ;
    m_ph_vertices.emplace_back( +fDz * fTthetaCphi - fDy2 * fTalpha2 + fDx3 ,
                                +fDz * fTthetaSphi - fDy2 , +fDz ) ;
    m_ph_vertices.emplace_back( +fDz * fTthetaCphi + fDy2 * fTalpha2 - fDx4 ,
                                +fDz * fTthetaSphi + fDy2 , +fDz ) ;
    m_ph_vertices.emplace_back( +fDz * fTthetaCphi + fDy2 * fTalpha2 + fDx4 ,
                                +fDz * fTthetaSphi + fDy2 , +fDz ) ;
    ///
