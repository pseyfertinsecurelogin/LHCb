...
namespace LHCb {
  ...
  MagneticFieldGrid::FieldGradient MagneticFieldGrid::fieldGradient( const Gaudi::XYZPoint& r ) const {
    ...
    if ( _i < ( m_Nxyz_V[0] - 1 ) && _j < ( m_Nxyz_V[1] - 1 ) && _k < ( m_Nxyz_V[2] - 1 ) ) {
  ...
  MagneticFieldGrid::FieldVector MagneticFieldGrid::fieldVector( const Gaudi::XYZPoint& r ) const {
    ...
    if ( _i < m_Nxyz_V[0] - 1 && _j < m_Nxyz_V[1] - 1 && _k < m_Nxyz_V[2] - 1 ) {
      ...
      bf_V =
          ( ( h000 * m_Q_V[ijk000] + h100 * m_Q_V[ijk000 + 1] ) + ( h001 * m_Q_V[ijk001] + h101 * m_Q_V[ijk001 + 1] ) +
            ( h010 * m_Q_V[ijk010] + h110 * m_Q_V[ijk010 + 1] ) +
            ( h011 * m_Q_V[ijk011] + h111 * m_Q_V[ijk011 + 1] ) ) *
          m_scaleFactor_V;
