...
{
  const auto pivot = ROOT::Math::Translation3D( pivotParams.begin(),
                                                pivotParams.end()   );
  const auto rot = ROOT::Math::RotationZYX( rotationParams[2],
                                           rotationParams[1],
                                           rotationParams[0]  );
  const auto trans = ROOT::Math::Translation3D( translationParams.begin(),
