...
public:
   ...
   * @return void
   */
  void calculateHits( const Gaudi::XYZPoint& entryPoint, const Gaudi::XYZPoint& exitPoint,
   ...
   * @return distance
   */
  double distanceToWire( const unsigned int aStraw, const Gaudi::XYZPoint& aPoint, const double tx,
   ...
   */
  void monoLayerIntersection( int monolayer, const Gaudi::XYZPoint& aPoint, const double tx, const double ty,
                              double& straw, double& yfrac ) const;

  /** @return distance to electronics along the wire */
  double distanceAlongWire( const double xHit, const double yHit ) const;
   ...
   * @return trajectory
   */
  std::unique_ptr<LHCb::Trajectory<double>> trajectory( const LHCb::OTChannelID& aChan, double = 0 /*offset*/ ) const;

  /** Trajectory parameterized along y-axis */
  void trajectory( unsigned int aStraw, double& dxdy, double& dzdy, double& xAtYEq0, double& zAtYEq0, double& ybegin,
                   double& yend ) const;
...
private:
   ...
   */
  void findStraws( const Gaudi::XYZPoint& entryPoint, const Gaudi::XYZPoint& exitPoint, Straws& straws ) const;
  ...
  void sCircle( const double z1, const double u1, const double z2, const double u2, const double dz, double& zc,
                double& uc, double& rc ) const;
...
inline unsigned int DeOTModule::moduleID() const { return m_moduleID; }

inline unsigned int DeOTModule::quarterID() const { return m_quarterID; }

inline unsigned int DeOTModule::layerID() const { return m_layerID; }

inline unsigned int DeOTModule::stationID() const { return m_stationID; }

inline LHCb::OTChannelID DeOTModule::elementID() const { return m_elementID; }

inline void DeOTModule::setElementID( const LHCb::OTChannelID& chanID ) { m_elementID = chanID; }

inline unsigned int DeOTModule::uniqueModule() const { return m_uniqueModuleID; }

inline bool DeOTModule::contains( LHCb::OTChannelID aChannel ) const {
  return ( m_elementID.uniqueModule() == aChannel.uniqueModule() );
}

inline bool DeOTModule::topModule() const { return m_quarterID > 1u; }

inline bool DeOTModule::bottomModule() const { return m_quarterID < 2u; }

/** Long modules go from 1-7 */
inline bool DeOTModule::longModule() const { return m_moduleID < 8u; }

inline bool DeOTModule::s1Module() const { return ( m_moduleID == 8u ); }

inline bool DeOTModule::s2Module() const { return ( ( m_quarterID == 1u || m_quarterID == 3u ) && m_moduleID == 9u ); }

inline bool DeOTModule::s3Module() const { return ( ( m_quarterID == 0u || m_quarterID == 2u ) && m_moduleID == 9u ); }

inline unsigned int DeOTModule::nModules() const { return 2 * m_nModules; }

inline unsigned int DeOTModule::nChannels() const { return 2 * m_nStraws; }

inline bool DeOTModule::monoLayerA( const unsigned int aStraw ) const { return ( aStraw <= m_nStraws ); }

inline bool DeOTModule::monoLayerB( const unsigned int aStraw ) const { return ( aStraw > m_nStraws ); }

inline unsigned char DeOTModule::mono( const unsigned int aStraw ) const { return ( aStraw - 1 ) / m_nStraws; }
...
inline double DeOTModule::sensThickness() const { return m_sensThickness; }
...
inline double DeOTModule::cellRadius() const { return m_cellRadius; }

inline double DeOTModule::angle() const { return m_angle; }

inline double DeOTModule::sinAngle() const { return m_sinAngle; }

inline double DeOTModule::cosAngle() const { return m_cosAngle; }
...
inline double DeOTModule::distanceAlongWire( const double xHit, const double yHit ) const {
...
inline Gaudi::Plane3D DeOTModule::plane() const { return m_plane; }

inline Gaudi::Plane3D DeOTModule::entryPlane() const { return m_entryPlane; }

inline Gaudi::Plane3D DeOTModule::exitPlane() const { return m_exitPlane; }
...
inline void DeOTModule::trajectory( unsigned int aStraw, double& dxdy, double& dzdy, double& xAtYEq0, double& zAtYEq0,
...
inline double DeOTModule::driftRadius( double drifttime ) const { return m_rtrelation.radius( drifttime ); }
...
inline double DeOTModule::maxDriftTime() const { return m_rtrelation.tmax(); }

inline double DeOTModule::driftTimeResolution( double radius ) const { return m_rtrelation.drifttimeError( radius ); }

inline double DeOTModule::propagationVelocity() const { return m_propagationVelocity; }

inline double DeOTModule::propagationVelocityY() const { return m_propagationVelocityY; }

inline double DeOTModule::strawT0( unsigned int istraw ) const { return m_strawt0[istraw - 1]; }
...
inline const OTDet::RtRelation& DeOTModule::rtRelation() const { return m_rtrelation; }
...
inline const OTDet::WalkRelation& DeOTModule::walkRelation() const { return m_walkrelation; }
