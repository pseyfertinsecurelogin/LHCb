...
inline unsigned int DeOTStation::stationID() const { return m_stationID; }

inline LHCb::OTChannelID DeOTStation::elementID() const { return m_elementID; }

inline void DeOTStation::setElementID( const LHCb::OTChannelID& chanID ) { m_elementID = chanID; }
...
inline DeOTLayer* DeOTStation::findLayer( const LHCb::OTChannelID& aChannel ) { return m_mapLayers[aChannel.layer()]; }
...
inline const DeOTStation::Layers& DeOTStation::layers() const { return m_layers; }
