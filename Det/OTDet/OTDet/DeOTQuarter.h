...
inline unsigned int DeOTQuarter::quarterID() const { return m_quarterID; }

inline LHCb::OTChannelID DeOTQuarter::elementID() const { return m_elementID; }

inline void DeOTQuarter::setElementID( const LHCb::OTChannelID& chanID ) { m_elementID = chanID; }
...
inline double DeOTQuarter::angle() const { return m_stereoAngle; }

inline const DeOTQuarter::Modules& DeOTQuarter::modules() const { return m_modules; }
