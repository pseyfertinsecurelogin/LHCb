...
public:
   ...
   * @return trajectory
   */
  std::unique_ptr<LHCb::Trajectory<double>> trajectoryFirstWire(const LHCb::LHCbID& id,
                                                                int monolayer=0) const;

  /** Get trajectory representing the most right wire in (second=0) monolayer
   * @return trajectory
   */
  std::unique_ptr<LHCb::Trajectory<double>> trajectoryLastWire(const LHCb::LHCbID& id,
