...
extern const CLID CLID_DERichPMTClassic;

//=============================================================================
/** @class DeRichPMTClassic DeRichPMTClassic.h RichDet/DeRichPMTClassic.h
 *
 *  PMT Photodetector
 *
 *  @author Sajan Easo
...
class DeRichPMTClassic : public DeRichPD {

public:
  /// Standard constructor
  explicit DeRichPMTClassic( const std::string& name = "" ) : DeRichPD( name ) {}

  /// Destructor
  virtual ~DeRichPMTClassic() = default;
