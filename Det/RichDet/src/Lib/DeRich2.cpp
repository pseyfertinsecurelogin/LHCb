...
DeRich2::updateMirrorParams()
{
  ...
  // Load the secondary mirrors to compute the 'nominal' settings
  {
    ...
    m_nominalPlanes[ Rich::right ] =
      Gaudi::Plane3D( nominalFMirrorPlaneRight[ 0 ] / (double)nRight,
...
//=========================================================================
const std::string
DeRich2::panelName( const Rich::Side panel ) const
{

  std::string pname =
    ( Rich::left == panel ? DeRichLocations::Rich1Panel0 : DeRichLocations::Rich1Panel1 );
