...
DeRichPMT::getPMTParameters()
{
  ...
  const auto PmtAnodeLocationInPmt =
    deRich->param< double >( "RichPmtSiliconDetectorLocalZlocation" );
...
void
DeRichPMT::setPmtIsGrandFlag( const bool isGrand )
{
...
bool
DeRichPMT::detectionPoint( const LHCb::RichSmartID smartID,
...
Gaudi::XYZPoint
DeRichPMT::detPointOnAnode( const LHCb::RichSmartID &smartID ) const
{
