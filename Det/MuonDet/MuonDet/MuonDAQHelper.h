...
public:
  ...
  std::vector<LHCb::MuonTileID> DoPadDC06( std::vector<LHCb::MuonTileID> digit, MuonTSMap* TS );
  std::vector<LHCb::MuonTileID> DoPadV1( std::vector<LHCb::MuonTileID> digit, std::vector<LHCb::MuonTileID> wrongdigit,
                                         MuonTSMap* TS );
  ...
  const std::vector<LHCb::MuonTileID>& getADDInTell1( unsigned int Tell1_num ) const;
  ...
  inline unsigned int                  TotTellNumber() { return m_TotTell1; };
  inline unsigned int                  M1TellNumber() { return m_M1Tell1; };
  inline std::string                   Tell1Name( unsigned int i ) { return m_TELL1Name[i]; };
  inline unsigned int                  ODEInTell1( unsigned int Tell1_num ) { return m_ODENumberInTell1[Tell1_num]; }
  ...
  StatusCode findHWNumber( LHCb::MuonTileID digit, long& L1Number, long& link_number, long& ODE_number, long& ode_ch );

  StatusCode findL0Number( LHCb::MuonTileID digit, std::string& ECSName, long& link_number, long& link_ch );

  std::string getODEECSName( int number );
  StatusCode  findStrips( LHCb::MuonTileID pad, LHCb::MuonTileID strips[2] );

  LHCb::MuonTileID findTS( LHCb::MuonTileID digit ) const;
  unsigned int findDigitInTS( std::string TSPath, LHCb::MuonTileID TSTile, LHCb::MuonTileID digit, bool hole = true );
  ...
  unsigned int DAQaddressInL1( LHCb::MuonTileID digitTile, long& L1Number, long& ODENumber, unsigned int& ODEAdd,
                               bool hole = true );
  std::string  getBasePath( std::string statname );
  std::vector<unsigned int> padsinTS( std::vector<unsigned int>& TSDigit, std::string TSPath );
  ...
  std::vector<int> getTell1InStation( int station ) { return m_tellPerStation[station]; }
