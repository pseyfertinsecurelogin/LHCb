...
//=============================================================================
MultipleMagneticFieldSvc::MultipleMagneticFieldSvc( const std::string& name, ISvcLocator* svc )
    : base_class( name, svc ) {
...
StatusCode MultipleMagneticFieldSvc::initialize() {
  ...
  if ( m_magneticFieldSvcs.empty() ) { log << MSG::WARNING << " No member fields configured" << endmsg; }
