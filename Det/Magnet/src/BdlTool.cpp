...
BdlTool::BdlTool( const std::string& type, const std::string& name, const IInterface* parent )
...
//****************************************************************************
void BdlTool::f_bdl( double slopeY, double zOrigin, double zStart, double zStop ) {
