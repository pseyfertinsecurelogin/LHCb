...
inline unsigned int DeSTLayer::id() const { return m_id; }

inline double DeSTLayer::angle() const { return m_angle; }

inline double DeSTLayer::cosAngle() const { return m_cosAngle; }

inline double DeSTLayer::sinAngle() const { return m_sinAngle; }

inline const DeSTLayer::Sectors& DeSTLayer::sectors() const { return m_sectors; }

inline Gaudi::Plane3D DeSTLayer::plane() const { return m_plane; }
 ...
 */
inline std::ostream& operator<<( std::ostream& os, const DeSTLayer* aLayer ) { return aLayer->printOut( os ); }
 ...
 *  @param aLayer reference to DeSTLayer object
 */
inline MsgStream& operator<<( MsgStream& os, const DeSTLayer* aLayer ) { return aLayer->printOut( os ); }

inline const std::string& DeSTLayer::nickname() const { return m_nickname; }
