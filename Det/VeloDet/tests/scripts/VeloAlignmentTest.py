...
use_cases = {
    "simple":
    "basic/plain geometry",
    "override_motion_system":
    "change the Velo position overriding motion system data",
    "override_alignment":
    "change the Velo position overriding alignment condition",
    "override_alignment2":
    "override [XY]OffsetCoeffs of alignment condition",
}
