...
private:
  DataObjectReadHandle<LHCb::VeloLiteCluster::FastContainer> m_inputLiteClusterDh = {
      this, "InputLiteClusterLocation", LHCb::VeloLiteClusterLocation::Default};
  DataObjectWriteHandle<LHCb::VeloLiteCluster::FastContainer> m_outputLiteClusterDh = {
      this, "OutputLiteClusterLocation", "/Event/Raw/Velo/LiteClustersCopy"};
  DataObjectReadHandle<LHCb::VeloClusters>  m_inputClusterDh  = {this, "InputClusterLocation",
                                                               LHCb::VeloLiteClusterLocation::Default};
  DataObjectWriteHandle<LHCb::VeloClusters> m_outputClusterDh = {this, "OutputClusterLocation",
                                                                 "/Event/Raw/Velo/ClustersCopy"};
