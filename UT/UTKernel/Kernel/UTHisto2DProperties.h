...
\*****************************************************************************/
#ifndef UTHisto2DProperties_H
#define UTHisto2DProperties_H 1
...
namespace UT {
  ...
  inline const double& Histo2DProperties::minBinX() const { return m_xMin; }

  inline const double& Histo2DProperties::maxBinX() const { return m_xMax; }

  inline const double& Histo2DProperties::minBinY() const { return m_yMin; }

  inline const double& Histo2DProperties::maxBinY() const { return m_yMax; }

  inline const unsigned int& Histo2DProperties::nBinX() const { return m_nBinX; }

  inline const unsigned int& Histo2DProperties::nBinY() const { return m_nBinY; }

  inline const std::string& Histo2DProperties::title() const { return m_title; }

  inline const std::string& Histo2DProperties::name() const { return m_name; }
