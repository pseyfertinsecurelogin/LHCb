// $Id: UTPPRepresentation.h,v 1.3 2009-01-22 11:43:44 mneedham Exp $
...
namespace UTDAQ{
  ...
  public:
    ...
    **/
    UTPPRepresentation(unsigned int pp,
    ...
    friend std::ostream& operator<< (std::ostream& s, 
                                     const UTDAQ::UTPPRepresentation& obj)
    {
...
inline UTDAQ::UTPPRepresentation::UTPPRepresentation(unsigned int pp,
                                                 unsigned int beetle,
                                                 unsigned int port,
				                 unsigned int strip){
...
inline UTDAQ::UTPPRepresentation::UTPPRepresentation(const UTDAQ::UTStripRepresentation& strip):m_value(strip.value()){
  // constructor
}

inline UTDAQ::UTPPRepresentation::operator int() const {
  return m_value;
}

inline unsigned int UTDAQ::UTPPRepresentation::value() const{
  return m_value;
}

inline void UTDAQ::UTPPRepresentation::decompose(unsigned int& pp,
                                              unsigned int& beetle,
                                              unsigned int& port,
                                              unsigned int& strip) const{
