...
namespace UTDAQ {
  ...
  public:
     ...
     **/
    UTBeetleRepresentation( unsigned int beetle, unsigned int port = 0, unsigned int strip = 0 );
    ...
    void decompose( unsigned int& beetle, unsigned int& port, unsigned int& strip ) const;

    /** decompose into beetle and strip **/
    void decompose( unsigned int& beetle, unsigned int& strip ) const;
    ...
    friend std::ostream& operator<<( std::ostream& s, const UTDAQ::UTBeetleRepresentation& obj ) {
...
inline UTDAQ::UTBeetleRepresentation::UTBeetleRepresentation( unsigned int beetle, unsigned int port,
                                                              unsigned int strip ) {
  m_value = ( LHCbConstants::nStripsInBeetle * beetle ) + ( LHCbConstants::nStripsInPort * port ) + strip;
}

inline UTDAQ::UTBeetleRepresentation::UTBeetleRepresentation( const UTDAQ::UTStripRepresentation& strip )
    : m_value( strip.value() ) {
  // constructor
}

inline UTDAQ::UTBeetleRepresentation::operator int() const { return m_value; }

inline unsigned int UTDAQ::UTBeetleRepresentation::value() const { return m_value; }
...
inline void UTDAQ::UTBeetleRepresentation::decompose( unsigned int& beetle, unsigned int& port,
...
inline void UTDAQ::UTBeetleRepresentation::decompose( unsigned int& beetle, unsigned int& strip ) const {
...
inline std::ostream& UTDAQ::UTBeetleRepresentation::fillStream( std::ostream& s ) const {
  ...
  s << "{ "
    ...
    << " Beetle: " << beetle << " Port: " << port << "Strip: " << strip << std::endl
    << "  } ";
