...
UTTell1Board::UTTell1Board(const UTTell1ID aBoard,
...
void UTTell1Board::addSector(UTChannelID aOfflineChan, unsigned int orientation,
...
bool UTTell1Board::isInside(const UTChannelID aOfflineChan,
...
UTTell1Board::chanPair UTTell1Board::DAQToOffline(const unsigned int fracStrip,
  ...
  return { UTChannelID(UTChannelID{(int)fullChan.chanID}.type(),
                       fullChan.station,
                       fullChan.layer,
                       fullChan.detRegion,
                       fullChan.sector,
...
UTTell1Board::DAQToOfflineFull(const unsigned int fracStrip,
                               const UTDAQ::version& version,
...
void UTTell1Board::ADCToOffline(const unsigned int aDAQChan,
...
unsigned int UTTell1Board::offlineToDAQ(const UTChannelID aOfflineChan,
