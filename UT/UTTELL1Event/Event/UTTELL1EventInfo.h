...
namespace LHCb {
  ...
  // Class ID definition
  static const CLID CLID_UTTELL1EventInfo = 9011;

  // Namespace for locations in TDS
  namespace UTTELL1EventInfoLocation {
    inline const std::string UTEventInfo = "Raw/UT/EventInfo";
  }

  /** @class UTTELL1EventInfo UTTELL1EventInfo.h
   *
  ...
  class UTTELL1EventInfo : public KeyedObject<int> {
  public:
    /// typedef for KeyedContainer of UTTELL1EventInfo
    typedef KeyedContainer<UTTELL1EventInfo, Containers::HashMap> Container;
    ...
    friend std::ostream& operator<<( std::ostream& str, const UTTELL1EventInfo& obj ) { return obj.fillStream( str ); }
  ...
  }; // class UTTELL1EventInfo

  /// Definition of Keyed Container for UTTELL1EventInfo
  typedef KeyedContainer<UTTELL1EventInfo, Containers::HashMap> UTTELL1EventInfos;
...
inline const CLID& LHCb::UTTELL1EventInfo::clID() const { return LHCb::UTTELL1EventInfo::classID(); }

inline const CLID& LHCb::UTTELL1EventInfo::classID() { return CLID_UTTELL1EventInfo; }

inline unsigned int LHCb::UTTELL1EventInfo::word0() const { return m_word0; }

inline void LHCb::UTTELL1EventInfo::setWord0( unsigned int value ) { m_word0 = value; }

inline short LHCb::UTTELL1EventInfo::bCnt() const { return (short)( ( m_word0 & BCntMask ) >> BCntBits ); }

inline void LHCb::UTTELL1EventInfo::setBCnt( short value ) {
  unsigned int val = (unsigned int)value;
  m_word0 &= ~BCntMask;
  m_word0 |= ( ( ( (unsigned int)val ) << BCntBits ) & BCntMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::DetectorID() const {
  return (unsigned char)( ( m_word0 & DetectorIDMask ) >> DetectorIDBits );
}

inline void LHCb::UTTELL1EventInfo::setDetectorID( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word0 &= ~DetectorIDMask;
  m_word0 |= ( ( ( (unsigned int)val ) << DetectorIDBits ) & DetectorIDMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::BankList() const {
  return (unsigned char)( ( m_word0 & BankListMask ) >> BankListBits );
}

inline void LHCb::UTTELL1EventInfo::setBankList( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word0 &= ~BankListMask;
  m_word0 |= ( ( ( (unsigned int)val ) << BankListBits ) & BankListMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::EventInformation() const {
  return (unsigned char)( ( m_word0 & EventInformationMask ) >> EventInformationBits );
}

inline void LHCb::UTTELL1EventInfo::setEventInformation( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word0 &= ~EventInformationMask;
  m_word0 |= ( ( ( (unsigned int)val ) << EventInformationBits ) & EventInformationMask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word1() const { return m_word1; }

inline void LHCb::UTTELL1EventInfo::setWord1( unsigned int value ) { m_word1 = value; }

inline int LHCb::UTTELL1EventInfo::L0EvID() const { return (int)( ( m_word1 & L0EvIDMask ) >> L0EvIDBits ); }

inline void LHCb::UTTELL1EventInfo::setL0EvID( int value ) {
  unsigned int val = (unsigned int)value;
  m_word1 &= ~L0EvIDMask;
  m_word1 |= ( ( ( (unsigned int)val ) << L0EvIDBits ) & L0EvIDMask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word2() const { return m_word2; }

inline void LHCb::UTTELL1EventInfo::setWord2( unsigned int value ) { m_word2 = value; }

inline unsigned char LHCb::UTTELL1EventInfo::pcn() const { return (unsigned char)( ( m_word2 & PCNMask ) >> PCNBits ); }

inline void LHCb::UTTELL1EventInfo::setPCN( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word2 &= ~PCNMask;
  m_word2 |= ( ( ( (unsigned int)val ) << PCNBits ) & PCNMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::ProcessInfo() const {
  return (unsigned char)( ( m_word2 & ProcessInfoMask ) >> ProcessInfoBits );
}

inline void LHCb::UTTELL1EventInfo::setProcessInfo( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word2 &= ~ProcessInfoMask;
  m_word2 |= ( ( ( (unsigned int)val ) << ProcessInfoBits ) & ProcessInfoMask );
}

inline short LHCb::UTTELL1EventInfo::R1() const { return (short)( ( m_word2 & R1Mask ) >> R1Bits ); }

inline void LHCb::UTTELL1EventInfo::setR1( short value ) {
  unsigned int val = (unsigned int)value;
  m_word2 &= ~R1Mask;
  m_word2 |= ( ( ( (unsigned int)val ) << R1Bits ) & R1Mask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word3() const { return m_word3; }

inline void LHCb::UTTELL1EventInfo::setWord3( unsigned int value ) { m_word3 = value; }

inline unsigned char LHCb::UTTELL1EventInfo::OptLnkNoEvt() const {
  return (unsigned char)( ( m_word3 & OptLnkNoEvtMask ) >> OptLnkNoEvtBits );
}

inline void LHCb::UTTELL1EventInfo::setOptLnkNoEvt( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~OptLnkNoEvtMask;
  m_word3 |= ( ( ( (unsigned int)val ) << OptLnkNoEvtBits ) & OptLnkNoEvtMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::OptLnkDisable() const {
  return (unsigned char)( ( m_word3 & OptLnkDisableMask ) >> OptLnkDisableBits );
}

inline void LHCb::UTTELL1EventInfo::setOptLnkDisable( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~OptLnkDisableMask;
  m_word3 |= ( ( ( (unsigned int)val ) << OptLnkDisableBits ) & OptLnkDisableMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::SyncEvtSizeError() const {
  return (unsigned char)( ( m_word3 & SyncEvtSizeErrorMask ) >> SyncEvtSizeErrorBits );
}

inline void LHCb::UTTELL1EventInfo::setSyncEvtSizeError( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~SyncEvtSizeErrorMask;
  m_word3 |= ( ( ( (unsigned int)val ) << SyncEvtSizeErrorBits ) & SyncEvtSizeErrorMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::tlkLnkLoss() const {
  return (unsigned char)( ( m_word3 & TLKLnkLossMask ) >> TLKLnkLossBits );
}

inline void LHCb::UTTELL1EventInfo::setTLKLnkLoss( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~TLKLnkLossMask;
  m_word3 |= ( ( ( (unsigned int)val ) << TLKLnkLossBits ) & TLKLnkLossMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::SyncRAMFull() const {
  return (unsigned char)( ( m_word3 & SyncRAMFullMask ) >> SyncRAMFullBits );
}

inline void LHCb::UTTELL1EventInfo::setSyncRAMFull( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~SyncRAMFullMask;
  m_word3 |= ( ( ( (unsigned int)val ) << SyncRAMFullBits ) & SyncRAMFullMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::ChipAddr() const {
  return (unsigned char)( ( m_word3 & ChipAddrMask ) >> ChipAddrBits );
}

inline void LHCb::UTTELL1EventInfo::setChipAddr( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word3 &= ~ChipAddrMask;
  m_word3 |= ( ( ( (unsigned int)val ) << ChipAddrBits ) & ChipAddrMask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word4() const { return m_word4; }

inline void LHCb::UTTELL1EventInfo::setWord4( unsigned int value ) { m_word4 = value; }

inline int LHCb::UTTELL1EventInfo::HeaderPseudoError() const {
  return (int)( ( m_word4 & HeaderPseudoErrorMask ) >> HeaderPseudoErrorBits );
}

inline void LHCb::UTTELL1EventInfo::setHeaderPseudoError( int value ) {
  unsigned int val = (unsigned int)value;
  m_word4 &= ~HeaderPseudoErrorMask;
  m_word4 |= ( ( ( (unsigned int)val ) << HeaderPseudoErrorBits ) & HeaderPseudoErrorMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::OptLnkNoClock() const {
  return (unsigned char)( ( m_word4 & OptLnkNoClockMask ) >> OptLnkNoClockBits );
}

inline void LHCb::UTTELL1EventInfo::setOptLnkNoClock( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word4 &= ~OptLnkNoClockMask;
  m_word4 |= ( ( ( (unsigned int)val ) << OptLnkNoClockBits ) & OptLnkNoClockMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::pcnError() const {
  return (unsigned char)( ( m_word4 & PCNErrorMask ) >> PCNErrorBits );
}

inline void LHCb::UTTELL1EventInfo::setPCNError( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word4 &= ~PCNErrorMask;
  m_word4 |= ( ( ( (unsigned int)val ) << PCNErrorBits ) & PCNErrorMask );
}

inline unsigned char LHCb::UTTELL1EventInfo::R2() const { return (unsigned char)( ( m_word4 & R2Mask ) >> R2Bits ); }

inline void LHCb::UTTELL1EventInfo::setR2( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word4 &= ~R2Mask;
  m_word4 |= ( ( ( (unsigned int)val ) << R2Bits ) & R2Mask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word5() const { return m_word5; }

inline void LHCb::UTTELL1EventInfo::setWord5( unsigned int value ) { m_word5 = value; }

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle0() const {
  return (unsigned char)( ( m_word5 & PCNBeetle0Mask ) >> PCNBeetle0Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle0( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word5 &= ~PCNBeetle0Mask;
  m_word5 |= ( ( ( (unsigned int)val ) << PCNBeetle0Bits ) & PCNBeetle0Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle1() const {
  return (unsigned char)( ( m_word5 & PCNBeetle1Mask ) >> PCNBeetle1Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle1( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word5 &= ~PCNBeetle1Mask;
  m_word5 |= ( ( ( (unsigned int)val ) << PCNBeetle1Bits ) & PCNBeetle1Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle2() const {
  return (unsigned char)( ( m_word5 & PCNBeetle2Mask ) >> PCNBeetle2Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle2( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word5 &= ~PCNBeetle2Mask;
  m_word5 |= ( ( ( (unsigned int)val ) << PCNBeetle2Bits ) & PCNBeetle2Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle3() const {
  return (unsigned char)( ( m_word5 & PCNBeetle3Mask ) >> PCNBeetle3Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle3( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word5 &= ~PCNBeetle3Mask;
  m_word5 |= ( ( ( (unsigned int)val ) << PCNBeetle3Bits ) & PCNBeetle3Mask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word6() const { return m_word6; }

inline void LHCb::UTTELL1EventInfo::setWord6( unsigned int value ) { m_word6 = value; }

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle4() const {
  return (unsigned char)( ( m_word6 & PCNBeetle4Mask ) >> PCNBeetle4Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle4( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word6 &= ~PCNBeetle4Mask;
  m_word6 |= ( ( ( (unsigned int)val ) << PCNBeetle4Bits ) & PCNBeetle4Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::pcnBeetle5() const {
  return (unsigned char)( ( m_word6 & PCNBeetle5Mask ) >> PCNBeetle5Bits );
}

inline void LHCb::UTTELL1EventInfo::setPCNBeetle5( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word6 &= ~PCNBeetle5Mask;
  m_word6 |= ( ( ( (unsigned int)val ) << PCNBeetle5Bits ) & PCNBeetle5Mask );
}

inline short LHCb::UTTELL1EventInfo::R3() const { return (short)( ( m_word6 & R3Mask ) >> R3Bits ); }

inline void LHCb::UTTELL1EventInfo::setR3( short value ) {
  unsigned int val = (unsigned int)value;
  m_word6 &= ~R3Mask;
  m_word6 |= ( ( ( (unsigned int)val ) << R3Bits ) & R3Mask );
}

inline unsigned int LHCb::UTTELL1EventInfo::word7() const { return m_word7; }

inline void LHCb::UTTELL1EventInfo::setWord7( unsigned int value ) { m_word7 = value; }

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle0() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle0Mask ) >> IHeaderBeetle0Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle0( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle0Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle0Bits ) & IHeaderBeetle0Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle1() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle1Mask ) >> IHeaderBeetle1Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle1( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle1Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle1Bits ) & IHeaderBeetle1Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle2() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle2Mask ) >> IHeaderBeetle2Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle2( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle2Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle2Bits ) & IHeaderBeetle2Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle3() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle3Mask ) >> IHeaderBeetle3Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle3( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle3Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle3Bits ) & IHeaderBeetle3Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle4() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle4Mask ) >> IHeaderBeetle4Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle4( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle4Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle4Bits ) & IHeaderBeetle4Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::iHeaderBeetle5() const {
  return (unsigned char)( ( m_word7 & IHeaderBeetle5Mask ) >> IHeaderBeetle5Bits );
}

inline void LHCb::UTTELL1EventInfo::setIHeaderBeetle5( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~IHeaderBeetle5Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << IHeaderBeetle5Bits ) & IHeaderBeetle5Mask );
}

inline unsigned char LHCb::UTTELL1EventInfo::R4() const { return (unsigned char)( ( m_word7 & R4Mask ) >> R4Bits ); }

inline void LHCb::UTTELL1EventInfo::setR4( unsigned char value ) {
  unsigned int val = (unsigned int)value;
  m_word7 &= ~R4Mask;
  m_word7 |= ( ( ( (unsigned int)val ) << R4Bits ) & R4Mask );
}

inline unsigned int LHCb::UTTELL1EventInfo::sourceID() const { return m_sourceID; }

inline void LHCb::UTTELL1EventInfo::setSourceID( unsigned int value ) { m_sourceID = value; }
