...
bool LHCb::UTTELL1EventInfo::linkEnabled(const unsigned int iLink) const{
...
bool LHCb::UTTELL1EventInfo::noEvent(const unsigned int iLink) const{
  return (OptLnkNoEvt() >> iLink & 1);
}

bool LHCb::UTTELL1EventInfo::noClock(const unsigned int iLink) const{
  return (OptLnkNoClock() >> iLink & 1);
}

bool LHCb::UTTELL1EventInfo::TLKLinkLoss(const unsigned int iLink) const{
  return (tlkLnkLoss() >> iLink & 1);
}

bool LHCb::UTTELL1EventInfo::syncRAMFull(const unsigned int iLink) const{
