...
bool LHCb::UTTELL1Error::badLink ( const unsigned int beetle,
...
bool  LHCb::UTTELL1Error::addLinkInfo (const unsigned int key,
                                   const LHCb::UTTELL1Error::FailureMode& mode ) {
...
LHCb::UTTELL1Error::FailureMode LHCb::UTTELL1Error::linkInfo(const unsigned int beetle,
                                                             const unsigned int port,
                                                             const unsigned int testpcn) const
{
