...
namespace LHCb::Event
{
  namespace experimental
  {
    ...
    namespace TrackData
    {
      SOAFIELD_TRIVIAL( f_core, core, Track );
      SOAFIELD_TRIVIAL( f_rich2, rich2, TrackExtension::Rich2States );
      SOAFIELD_TRIVIAL( f_rich1, rich1, TrackExtension::Rich1States );
      SOAFIELD_TRIVIAL( f_moreStates, moreStates, TrackExtension::AdditionalStates );
      SOAFIELD_TRIVIAL( f_origin, origin, TrackExtension::BackCompat );
      ...
      SOASKIN( LongtrackSkin, f_core, f_rich1, f_rich2, f_moreStates, f_origin )
      {
        ...
        LongtrackSkin( const LHCb::Track& t )
        {
          ...
          this->rich1()      = TrackExtension::Rich1States( states );
          this->rich2()      = TrackExtension::Rich2States( states );
          this->moreStates() = TrackExtension::AdditionalStates( std::move( states ) );
      ...
      SOASKIN( ForRich1PIDSkin, f_rich1, f_origin ) { SOASKIN_INHERIT_DEFAULT_METHODS( ForRich1PIDSkin ); };
      SOASKIN( ForRich2PIDSkin, f_rich2, f_origin ) { SOASKIN_INHERIT_DEFAULT_METHODS( ForRich2PIDSkin ); };
      SOASKIN( ForRichesPIDSkin, f_rich1, f_rich2, f_origin ) { SOASKIN_INHERIT_DEFAULT_METHODS( ForRichesPIDSkin ); };
    } // namespace TrackData
