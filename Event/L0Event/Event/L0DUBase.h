...
namespace L0DUBase {
  ...
  */
  ...
  namespace CompoundData {
    ...
    inline const std::array<std::string, NumberOf::Compounds> Name = {
        "None",          "CompoundCaloEt", "CompoundCaloAdd", "CompoundPuCont",
        "CompoundPuPos", "CompoundMuonPt", "CompoundMuonAdd", "CompoundMuonSgn"};
  ...
  namespace PredefinedData {
    ...
    inline const std::array<std::string, NumberOf::Data> Name = {
        "Electron(Et)", "Photon(Et)",     "GlobalPi0(Et)", "LocalPi0(Et)", "Hadron(Et)",         "Sum(Et)",
        "Spd(Mult)",    "PUPeak1(Cont)",  "PUPeak2(Cont)", "PUPeak1(Pos)", "PUPeak2(Pos)",       "PUHits(Mult)",
        "Muon1(Pt)",    "Muon2(Pt)",      "Muon3(Pt)",     "DiMuon(Pt)",   "DiMuonProd(Pt1Pt2)", "Electron(Add)",
        "Photon(Add)",  "GlobalPi0(Add)", "LocalPi0(Add)", "Hadron(Add)",  "Muon1(Add)",         "Muon2(Add)",
        "Muon3(Add)",   "Muon1(Sgn)",     "Muon2(Sgn)",    "Muon3(Sgn)",
    };

    // Herschel aliases
    inline const std::map<std::string, std::string> Alias = {{"HRC(F)", "LocalPi0(Et)"},
                                                             {"HRC(B)", "GlobalPi0(Et)"},
                                                             {"HRCF(Add)", "LocalPi0(Add)"},
                                                             {"HRCB(Add)", "GlobalPi0(Add)"}};

    inline const std::array<unsigned int, NumberOf::Data> CompoundType = {
        CompoundData::CaloEt,  CompoundData::CaloEt,  CompoundData::CaloEt,  CompoundData::CaloEt,
        CompoundData::CaloEt,  CompoundData::None,    CompoundData::None,    CompoundData::PuCont,
        CompoundData::PuCont,  CompoundData::PuPos,   CompoundData::PuPos,   CompoundData::None,
        CompoundData::MuonPt,  CompoundData::MuonPt,  CompoundData::MuonPt,  CompoundData::None,
        CompoundData::None,    CompoundData::CaloAdd, CompoundData::CaloAdd, CompoundData::CaloAdd,
        CompoundData::CaloAdd, CompoundData::CaloAdd, CompoundData::MuonAdd, CompoundData::MuonAdd,
        CompoundData::MuonAdd, CompoundData::MuonSgn, CompoundData::MuonSgn, CompoundData::MuonSgn};

    // - OD - 2016 :  Pi0G/Pi0L/SumEt  :  5/5/4  => 3/3/8
    inline const std::array<unsigned int, NumberOf::Data> MaxNumber = {
        8,  6, 3, 3, 8, // ElectronEt, PhotonEt, GlobalPi0Et, LocalPi0Et, HadronEt
        8,  8,          // SumEt , SpdMult
        4,  4,          // PuPeak1, PUPeak2
    ...
    inline const std::array<unsigned int, NumberOf::Data> ConditionOrder = {
  ...
  */
  namespace Fiber {
    enum Type {
      ...
      Spare7,
      Empty
    }; // MUST BE ENDED WITH 'EMPTY' fibre
  }
  ...
  */
  ...
  namespace Calo {
    namespace Et {
      constexpr unsigned int Mask = 0x1FE, Shift = 1;
    } // namespace Et
    namespace Address {
      constexpr unsigned int Mask = 0x7FFE0000, Shift = 17;
    }
    namespace BCID {
      constexpr unsigned int Mask = 0xFE00, Shift = 9;
    }
    namespace Status {
      constexpr unsigned int Mask = 0x80000000, Shift = 31;
    }
    namespace Sum {
      constexpr unsigned int Mask = 0x7FFE0000, Shift = 17;
    } // namespace Sum
  ...
  namespace Muon {
    // from CU
    namespace Pt2 {
      constexpr unsigned int Mask = 0xFE, Shift = 1;
    }
    namespace Address2 {
      constexpr unsigned int Mask = 0x7F00, Shift = 8;
    }
    namespace BCID0 {
      constexpr unsigned int Mask = 0x8000, Shift = 15;
    }
    namespace Pt1 {
      constexpr unsigned int Mask = 0xFE0000, Shift = 17;
    }
    namespace Address1 {
      constexpr unsigned int Mask = 0x7F000000, Shift = 24;
    }
    namespace BCID1 {
      constexpr unsigned int Mask = 0x80000000, Shift = 31;
    }
    // from SU
    namespace Pu2 {
      constexpr unsigned int Mask = 0x6, Shift = 1;
    } // namespace Pu2
    namespace Pb2 {
      constexpr unsigned int Mask = 0x78, Shift = 3;
    } // namespace Pb2
    namespace Sign2 {
      constexpr unsigned int Mask = 0x80, Shift = 7;
    }
    namespace BCID {
      constexpr unsigned int Mask = 0xFE00, Shift = 9;
    }
    namespace Pu1 {
      constexpr unsigned int Mask = 0x60000, Shift = 17;
    } // namespace Pu1
    namespace Pb1 {
      constexpr unsigned int Mask = 0x780000, Shift = 19;
    } // namespace Pb1
    namespace Sign1 {
      constexpr unsigned int Mask = 0x800000, Shift = 23;
    }
    namespace Status {
      constexpr unsigned int Mask = 0xF0000000, Shift = 28;
    }
  ...
  namespace L0Pu {
    ...
    namespace Address {
      constexpr unsigned int Mask = 0x1FE0000, Shift = 17;
    }
    namespace Status {
      constexpr unsigned int Mask = 0x80000000, Shift = 31;
    }
    ...
    namespace MoreInfo {
      constexpr unsigned int Mask = 0xF000000, Shift = 24;
    }
    // specific to Pu2
    namespace BCID2 {
      constexpr unsigned int Mask = 0xF800, Shift = 11;
    }
    namespace HitsLSB {
      constexpr unsigned int Mask = 0x600, Shift = 9;
    }
    namespace HitsMSB {
      constexpr unsigned int Mask = 0x7E000000, Shift = 25;
    }
  ...
  */
  ...
  namespace Electron {
    constexpr std::array<unsigned int, Index::Size>
        Et =
            {
                Fiber::CaloElectron, Type::CaloEt, Calo::Et::Mask, Calo::Et::Shift, Fiber::Empty, 0, 0, 0,
    },
  ...
  namespace Muon1 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU0,        Type::Digit,      Muon::Address1::Mask,
                   Muon::Address1::Shift, Fiber::MuonSU0,   Muon::Pu1::Mask | Muon::Pb1::Mask,
  ...
  namespace Muon2 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU0,        Type::Digit,      Muon::Address2::Mask,
                   Muon::Address2::Shift, Fiber::MuonSU0,   Muon::Pu2::Mask | Muon::Pb2::Mask,
  ...
  namespace Muon3 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU1,        Type::Digit,      Muon::Address1::Mask,
                   Muon::Address1::Shift, Fiber::MuonSU1,   Muon::Pu1::Mask | Muon::Pb1::Mask,
                   Muon::Pu1::Shift,      Muon::AddressSize},
  ...
  namespace Muon4 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU1,        Type::Digit,      Muon::Address2::Mask,
                   Muon::Address2::Shift, Fiber::MuonSU1,   Muon::Pu2::Mask | Muon::Pb2::Mask,
                   Muon::Pu2::Shift,      Muon::AddressSize},
        BCID1   = {Fiber::MuonCU1, Type::Digit,       Muon::BCID0::Mask,  Muon::BCID0::Shift,
                 Fiber::MuonCU1, Muon::BCID1::Mask, Muon::BCID1::Shift, Muon::BCID0Size},
        BCID2   = {Fiber::MuonSU1, Type::Digit, Muon::BCID::Mask, Muon::BCID::Shift, Fiber::Empty, 0, 0, 0},
  ...
  namespace Muon5 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU2,        Type::Digit,      Muon::Address1::Mask,
                   Muon::Address1::Shift, Fiber::MuonSU2,   Muon::Pu1::Mask | Muon::Pb1::Mask,
                   Muon::Pu1::Shift,      Muon::AddressSize},
  ...
  namespace Muon6 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU2,        Type::Digit,      Muon::Address2::Mask,
                   Muon::Address2::Shift, Fiber::MuonSU2,   Muon::Pu2::Mask | Muon::Pb2::Mask,
                   Muon::Pu2::Shift,      Muon::AddressSize},
        BCID1   = {Fiber::MuonCU2, Type::Digit,       Muon::BCID0::Mask,  Muon::BCID0::Shift,
                 Fiber::MuonCU2, Muon::BCID1::Mask, Muon::BCID1::Shift, Muon::BCID0Size},
        BCID2   = {Fiber::MuonSU2, Type::Digit, Muon::BCID::Mask, Muon::BCID::Shift, Fiber::Empty, 0, 0, 0},
  ...
  namespace Muon7 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU3,        Type::Digit,      Muon::Address1::Mask,
                   Muon::Address1::Shift, Fiber::MuonSU3,   Muon::Pu1::Mask | Muon::Pb1::Mask,
                   Muon::Pu1::Shift,      Muon::AddressSize},
  ...
  namespace Muon8 {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Address = {Fiber::MuonCU3,        Type::Digit,      Muon::Address2::Mask,
                   Muon::Address2::Shift, Fiber::MuonSU3,   Muon::Pu2::Mask | Muon::Pb2::Mask,
                   Muon::Pu2::Shift,      Muon::AddressSize},
        BCID1   = {Fiber::MuonCU3, Type::Digit,       Muon::BCID0::Mask,  Muon::BCID0::Shift,
                 Fiber::MuonCU3, Muon::BCID1::Mask, Muon::BCID1::Shift, Muon::BCID0Size},
        BCID2   = {Fiber::MuonSU3, Type::Digit, Muon::BCID::Mask, Muon::BCID::Shift, Fiber::Empty, 0, 0, 0},
  ...
  namespace PileUp {
    constexpr std::array<unsigned int, Index::Size>
        ...
        Peak1Pos = {Fiber::Pu1, Type::Digit, L0Pu::Address::Mask, L0Pu::Address::Shift, Fiber::Empty, 0, 0, 0},
        Peak2Pos = {Fiber::Pu2, Type::Digit, L0Pu::Address::Mask, L0Pu::Address::Shift, Fiber::Empty, 0, 0, 0},
