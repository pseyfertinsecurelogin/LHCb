...
namespace LHCb {
  ...
  public:
    ...
    [[nodiscard]] float xfraction() const noexcept { return m_fx; }
    [[nodiscard]] float yfraction() const noexcept { return m_fy; }
    ...
    [[nodiscard]] const std::vector<VPChannelID>& pixels() const noexcept { return m_pixels; }
