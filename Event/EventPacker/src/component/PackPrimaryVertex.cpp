...
namespace {
  ...
  public:
    ...
    void write( char* value, size_t l ) { m_buffer.insert( m_buffer.end(), value, value + l ); }
    template <typename T>
...
//=============================================================================
PackPrimaryVertices::PackPrimaryVertices( const std::string& name, ISvcLocator* pSvcLocator )
    : GaudiAlgorithm( name, pSvcLocator ), m_version( 1 ) {
...
UnpackPrimaryVertices::UnpackPrimaryVertices( const std::string& name, ISvcLocator* pSvcLocator )
    : GaudiAlgorithm( name, pSvcLocator ), m_version( 1 ) {
