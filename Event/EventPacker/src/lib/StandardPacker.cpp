...
int StandardPacker::reference32( DataObject* out, const DataObject* parent, const int key ) const {
...
int StandardPacker::reference32( DataObject* out, const std::string& targetName, const int key ) const {
  Warning( "Creating obsolete 32bit packed reference" );
...
bool StandardPacker::hintAndKey32( const int data, const DataObject* source, DataObject* target, int& hint,
                                   int& key ) const {
...
bool StandardPacker::hintAndKey64( const long long data, const DataObject* source, DataObject* target, int& hint,
                                   int& key ) const {
  // return status is bad by default
  bool OK = false;
