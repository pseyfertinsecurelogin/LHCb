...
namespace LHCb {
  ...
  public:
    MCSpdHitPacker( GaudiAlgorithm* parent ) : MCCaloHitPacker( parent ) { m_energyScale = 1.0e2; }
  ...
  public:
    MCPrsHitPacker( GaudiAlgorithm* parent ) : MCCaloHitPacker( parent ) { m_energyScale = 1.0e2; }
  ...
  public:
    MCEcalHitPacker( GaudiAlgorithm* parent ) : MCCaloHitPacker( parent ) { m_energyScale = 1.0e2; }
  ...
  public:
    MCHcalHitPacker( GaudiAlgorithm* parent ) : MCCaloHitPacker( parent ) { m_energyScale = 1.0e2; }
