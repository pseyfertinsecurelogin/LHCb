...
namespace LHCb {
  ...
  struct PackedTrack {
    ...
    inline void save( T& buf ) const {
      buf.io( key, chi2PerDoF, nDoF, flags, firstId, lastId, firstState, lastState, firstExtra, lastExtra, likelihood,
              ghostProba );
    }
  ...
  struct PackedState {
    ...
    template <typename T>
    inline void save( T& buf ) const {
      buf.io( flags, x, y, z, tx, ty, p, cov_00, cov_11, cov_22, cov_33, cov_44, cov_10, cov_20, cov_21, cov_30, cov_31,
