...
namespace LHCb {
  ...
  struct PackedCaloCluster {
    ...
    template <typename T>
    inline void save( T& buf ) const {
      buf.io( key, type, seed, pos_x, pos_y, pos_z, pos_e, pos_c0, pos_c1, pos_cov00, pos_cov11, pos_cov22, pos_cov10,
              pos_cov20, pos_cov21, pos_spread00, pos_spread11, pos_spread10, firstEntry, lastEntry );
    }
  ...
  public:
    /// Pack Calo Clusters
    void pack( const DataVector& clus, PackedDataVector& pclus ) const;
