...
public:
  ...
  MsgStream& print( MsgStream& stream, const LHCb::Track* track ) const;
...
private:
  ...
  /// accepted type
  std::vector<int> m_type = {LHCb::Track::Types::Long, LHCb::Track::Types::Upstream, LHCb::Track::Types::Downstream,
...
inline bool TrackUse::acceptedFitStatus( const LHCb::Track::FitStatus v ) const {
  return m_fitstatus.end() != std::find( m_fitstatus.begin(), m_fitstatus.end(), v );
}
// ============================================================================
/// type to be accepted
// ============================================================================
inline bool TrackUse::acceptedType( const LHCb::Track::Types v ) const {
  return m_type.end() != std::find( m_type.begin(), m_type.end(), v );
}
// ============================================================================
/// history to be rejected
// ============================================================================
inline bool TrackUse::rejectedHistory( const LHCb::Track::History v ) const {
  return m_history.end() != std::find( m_history.begin(), m_history.end(), v );
}
// ============================================================================
/** the basic method which defines if track selected for further processing
 *  @param track pointer to Track object
 ...
 */
// ============================================================================
inline bool TrackUse::use( const LHCb::Track* track ) const {
  if ( !track ) { return false; }  // RETURN
  if ( !check() ) { return true; } // RETURN
  /// check for flags
  if ( skipClones() && track->checkFlag( LHCb::Track::Flags::Clone ) ) { return false; }
  /// check for flags
  if ( skipInvalid() && track->checkFlag( LHCb::Track::Flags::Invalid ) ) { return false; }
  /// check for flags
  if ( skipBackward() && track->checkFlag( LHCb::Track::Flags::Backward ) ) { return false; }
  /// accepted fit status ?
...
// ============================================================================
inline MsgStream& operator<<( MsgStream& stream, const TrackUse& trUse ) { return trUse.fillStream( stream ); }
// ============================================================================
