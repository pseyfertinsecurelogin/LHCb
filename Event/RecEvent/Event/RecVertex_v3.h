...
namespace LHCb::Event::v3 {
  ...
  namespace Enum::RecVertex {
    ...
    meta_enum_class( RecVertexType, int, Unknown = 0, Vertex2D, Vertex3D, V0, Primary, LastRec = 10000 )
  ...
  public:
    ...
    RecVertex( const Gaudi::XYZPoint& position, const Gaudi::SymMatrix3x3& covMatrix,
               const LHCb::Chi2PerDoF chi2PerDof )
    ...
    void setChi2PerDoF( LHCb::Chi2PerDoF const chi2PerDof ) { m_chi2PerDoF = chi2PerDof; };
    ...
    void addToTracks( std::size_t track, const float weight = 1.0 ) { m_tracks.emplace_back( track, weight ); }
     ...
     */
    bool removeFromTracks( std::size_t track );
    ...
    std::optional<float> trackWeight( std::size_t track ) const;
