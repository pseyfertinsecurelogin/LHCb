...
namespace VeloTELL1 {
  ...
  public:
    ...
    enum NZSDataType { VeloFull = 18, VeloPedestal = 30, WriteHeaders = 40 };
    ...
    VeloTELL1FData( const int numberOfTELL1, const int dataType )
        ...
        , m_sensorType( 0 ) {}
    /// Default Constructor
    VeloTELL1FData() : m_decodedData(), m_dataType( 0 ), m_isReordered(), m_sensorType( 0 ) {}
    /// Default Destructor
...
//--
inline void VeloTELL1::VeloTELL1FData::setDecodedData( const std::vector<float>& value ) { m_decodedData = value; }
//--
inline bool VeloTELL1::VeloTELL1FData::isReordered() const { return m_isReordered; }
//--
inline void VeloTELL1::VeloTELL1FData::setIsReordered( bool value ) { m_isReordered = value; }
//--
inline void VeloTELL1::VeloTELL1FData::setSensorType( unsigned int value ) { m_sensorType = value; }
//--
inline VeloTELL1::VeloTELL1FData::ALinkPairF VeloTELL1::VeloTELL1FData::
                                             operator[]( const unsigned int ALinkNumber ) const {
...
//--
inline std::vector<float>& VeloTELL1::VeloTELL1FData::data() { return ( m_decodedData ); }
//--
inline void VeloTELL1::VeloTELL1FData::addALink( std::vector<float>& inVec ) {
  std::vector<float>::iterator datIt;
  datIt = inVec.begin();
  for ( ; datIt != inVec.end(); datIt++ ) { m_decodedData.push_back( *datIt ); }
...
inline unsigned int VeloTELL1::VeloTELL1FData::channel2ALink( const unsigned int channel ) const {
  ...
  if ( !m_isReordered && channel < SENSOR_STRIPS ) { aLink = channel / ADC_PER_ALINK; }
  return ( aLink );
}
