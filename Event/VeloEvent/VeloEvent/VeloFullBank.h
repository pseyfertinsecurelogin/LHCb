...
//=============================================================================
inline int VeloFullBank::NumberOfWordsInBlock() const { return m_NumberOfWordsInBlock; }
//=============================================================================
inline int VeloFullBank::NumberOfWordsInSection() const { return m_NumberOfWordsInSection; }
//=============================================================================
inline VeloTELL1::allEvt& VeloFullBank::getEvtInfo() { return ( m_infos ); }
//=============================================================================
inline VeloTELL1::dataVec& VeloFullBank::getSection( int blockNbn, int secNbn ) {
