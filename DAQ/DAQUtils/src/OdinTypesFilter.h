...
private:
  ...
  Gaudi::Property<std::vector<OdinTypesFilter_details::odin_trigger_type_t>> m_trs{
      this, "TriggerTypes", {OdinTypesFilter_details::odin_trigger_type_t::All()}};
  Gaudi::Property<std::vector<OdinTypesFilter_details::odin_bx_type_t>> m_bxs{
      this, "BXTypes", {OdinTypesFilter_details::odin_bx_type_t::All()}};
  Gaudi::Property<std::vector<OdinTypesFilter_details::odin_readout_type_t>> m_ros{
      this, "ReadoutTypes", {OdinTypesFilter_details::odin_readout_type_t::All()}};
  Gaudi::Property<std::vector<OdinTypesFilter_details::odin_calibration_type_t>> m_cls{
      this, "CalibrationTypes", {OdinTypesFilter_details::odin_calibration_type_t::All()}};
