...
namespace LHCb {
  ...
  inline BankWriter::BankWriter( size_t blockSize ) : m_pos( 0 ) {
    // constructor
  ...
  bool BankWriter::isFull() const { return ( m_pos >= m_byteSize ? true : false ); }
  ...
  inline std::size_t BankWriter::byteSize() const { return m_pos; }
