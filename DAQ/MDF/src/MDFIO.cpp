...
StatusCode LHCb::MDFIO::commitRawBanks( RawEvent* raw, const RawBank* hdr_bank, int compTyp, int chksumTyp,
                                        void* const ioDesc ) {
  try {
...
StatusCode LHCb::MDFIO::writeDataSpace( int compTyp, int chksumTyp, void* const ioDesc, const RawBank* hdr,
