...
vd = Decoder(
    "DecodeVeloRawBuffer/createBothVeloClusters",
    active=False,
    banks=["Velo"],
    inputs={"RawEventLocations": None},
    outputs={
        "VeloClusterLocation": None,
        "VeloLiteClustersLocation": None
    },
    properties={
...
Decoder(
    ...
    inputs={"RawEventLocations": None},
    outputs={
        "PUClusterLocation": None,
        "PUClusterNZSLocation": None
    },
...
Decoder(
    "RawBankToSTLiteClusterAlg/createTTLiteClustersExpert",
    active=False,
    banks=["TTPedestal", "TTFull", "TTProcFull", "TTError"],
    outputs={"clusterLocation": "Raw/TT/LiteClusters"},
    inputs={"RawEventLocations": None},
    conf=DecoderDB)
...
Decoder(
    ...
    banks=["TT"],
    outputs={
        "clusterLocation": "Raw/TT/Clusters",
        "summaryLocation": "Rec/TT/Summary"
    },
    inputs={"RawEventLocations": None},
    conf=DecoderDB)

Decoder(
    "RawBankToSTClusterAlg/createTTClustersExpert",
    active=False,
    banks=["TTPedestal", "TTFull", "TTProcFull", "TTError"],
    outputs={
        "clusterLocation": "Raw/TT/Clusters",
...
Decoder(
    "RawBankToSTLiteClusterAlg/createITLiteClustersExpert",
    active=False,
    banks=["ITPedestal", "ITFull", "ITProcFull", "ITError"],
    outputs={"clusterLocation": "Raw/IT/LiteClusters"},
    inputs={"RawEventLocations": None},
    properties={"DetType": "IT"},
    conf=DecoderDB)
...
Decoder(
    "RawBankToSTClusterAlg/createITClusters",
    active=True,
    banks=["IT"],
    outputs={
        "clusterLocation": "Raw/IT/Clusters",
        "summaryLocation": "Rec/IT/Summary"
    },
    inputs={"RawEventLocations": None},
    properties={"DetType": "IT"},
    conf=DecoderDB)
...
Decoder(
    "RawBankToSTClusterAlg/createITClustersExpert",
    active=False,
    banks=["ITPedestal", "ITFull", "ITProcFull", "ITError"],
    outputs={
        "clusterLocation": "Raw/IT/Clusters",
...
#===========OT===========
ottNormal = Decoder(
    "OTTimeCreator",  #the only one which makes a TES location
    active=True,
    banks=["OT"],
...
ottExpert = Decoder(
    "OTTimeCreator/OTTimeCreatorExpert",  #the only one which makes a TES location
    active=False,
    banks=["OTRaw", "OTError"],
...
Decoder(
    "CaloDigitsFromRaw/" + name,
    active=True,
    banks=["PrsE", "PrsPacked"],
...
Decoder(
    toolname, active=False, inputs={"RawEventLocations": None}, conf=DecoderDB)
...
Decoder(
    "L0MuonOutputs/OutputTool",
    active=False,
    outputs=["Trig/L0/MuonCtrl", "Trig/L0/MuonBCSU", "Trig/L0/MuonData"],
    conf=DecoderDB)

Decoder(
    "L0CaloCandidatesFromRaw/L0CaloFromRaw",
    active=True,
    banks=["L0Calo", "L0CaloFull"],
    inputs={"RawEventLocations": None},
    outputs=["Trig/L0/Calo", "Trig/L0/FullCalo"],
    conf=DecoderDB)

Decoder(
    "L0DUDecoder/L0DUFromRaw",
    active=True,
    banks=["L0DU"],
    inputs={"RawEventLocations": None},
...
Decoder(
    ...
    privateTools=[
        "CaloTriggerAdcsFromRaw/EcalTriggerAdcTool",
        "CaloTriggerAdcsFromRaw/HcalTriggerAdcTool", "CaloTriggerBitsFromRaw"
    ],
    conf=DecoderDB)
...
Decoder(
    "CaloTriggerAdcsFromRaw/HcalTriggerAdcTool",
    active=False,
...
Decoder(
    "CaloTriggerAdcsFromRaw/EcalTriggerAdcToolExpert",
    active=False,
...
Decoder(
    "CaloTriggerAdcsFromRaw/HcalTriggerAdcToolExpert",
    active=False,
