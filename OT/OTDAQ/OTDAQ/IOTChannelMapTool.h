...
struct IOTChannelMapTool : extend_interfaces<IAlgTool> {
  ...
  unsigned int straw( unsigned int station, unsigned int layer, unsigned int quadrant, unsigned int module,
                      unsigned int channel ) const;

  /// Retrieve channel (0-127) for given straw (1-128). Make sure that bank version is set!
  unsigned int channel( unsigned int station, unsigned int layer, unsigned int quadrant, unsigned int module,
