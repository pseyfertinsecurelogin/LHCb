...
class OTRawBankDecoder : public extends<Decoder::ToolBase, IOTRawBankDecoder, IIncidentListener> {

public:
  /// Standard constructor
  OTRawBankDecoder( const std::string& type, const std::string& name, const IInterface* parent );
...
private:
  ...
  Gaudi::Property<std::pair<double, double>> m_timewindow{
      this, "TimeWindow", {999 * Gaudi::Units::ns, -999 * Gaudi::Units::ns}}; ///< ignore hits outside of this window,
                                                                              ///< only if first < second; if not, use
                                                                              ///< all
  Gaudi::Property<double> m_timePerBX{this, "timePerBX", 25 * Gaudi::Units::ns}; ///< Time Per BX
  Gaudi::Property<int>    m_countsPerBX{this, "countsPerBX", 64};                ///< Counts per BX
  Gaudi::Property<int>    m_numberOfBX{this, "numberOfBX", 3};                   ///< Number of BX
  Gaudi::Property<int>    m_forcebankversion{this, "ForceBankVersion",
                                          OTBankVersion::UNDEFINED}; ///< Overwrite bank version in bank header
  Gaudi::Property<bool>   m_vetoOutOfTimeHitPairs{this, "VetoOutOfTimeHitPairs", true}; ///< veto out of time hit pairs?
