...
private:
  ...
  public:
    ...
    const std::string& original() const { return m_file->original(); }
  ...
  typedef boost::multi_index_container<
      FileWrapper, boost::multi_index::indexed_by<
                       boost::multi_index::hashed_unique<
                           boost::multi_index::tag<originalTag>,
                           boost::multi_index::const_mem_fun<FileWrapper, const std::string&, &FileWrapper::original>>,
                       boost::multi_index::sequenced<boost::multi_index::tag<listTag>>>>
      fileContainer_t;
  ...
  // Properties
  Gaudi::Property<std::string> m_tmpdir{this, "Tempdir", "",
                                        "The base of the temporary directory "
                                        "where the files will be staged"};
  Gaudi::Property<size_t>      m_stageNFiles{this, "StageNFiles", 2, "The number of files to stage"};
  Gaudi::Property<size_t>      m_tries{this, "DiskspaceTries", 10,
                                  "The number of times to retry "
                                  "whether there is sufficient diskspace"};
  Gaudi::Property<size_t>      m_copyTries{this, "CopyTries", 5, "Retry copying if it fails."};
  boost::filesystem::path      m_tempdir;
  bool                         m_initialized = false;
  Gaudi::Property<bool>        m_retry{this, "RetryStaging", false, "Retry staging once it's failed."};
  Gaudi::Property<bool>        m_stageLocalFiles{this, "StageLocalFiles", false, "Stage files beginning with file:."};
  ...
  Gaudi::Property<std::string> m_garbageCommand{this, "GarbageCollectorCommand", "garbage.exe",
                                                "Command for the garbage collector."};
  Gaudi::Property<bool>        m_checkLocalGarbage{this, "CheckForLocalGarbageCollector", true,
                                            "Check if the garbage collector command is in the local directory."};
  Gaudi::Property<bool>        m_keepFiles{this, "KeepFiles", false, "Keep staged files"};
