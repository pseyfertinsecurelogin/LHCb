...
namespace
{
  ...
  {    
    ...
    {      
      ...
      switch(key)
      {
      case LHCb::GenCountersFSR::CounterKey::EvtGenerated: countEvtGen = counter.second.second;
        break;
      case LHCb::GenCountersFSR::CounterKey::IntGenerated: countIntGen = counter.second.second;
        break;
      case LHCb::GenCountersFSR::CounterKey::EvtAccepted:  countEvtAcc = counter.second.second;
        break;
      case LHCb::GenCountersFSR::CounterKey::IntAccepted:  countIntAcc = counter.second.second;
        break; 
      }      
    }
  ...
  void writeAccHadronCounters(LHCb::GenFSR& genFSR, int countAcc, std::ostream& htmlOutput)
  {
    ...
    for(auto const& counter : genFSR.genCounters())
    {
      ...
      if((key >= LHCb::GenCountersFSR::CounterKey::B0Acc &&
