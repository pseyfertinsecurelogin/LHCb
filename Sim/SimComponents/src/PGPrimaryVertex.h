...
private:
  ...
  Gaudi::Property<std::string> m_inputVerticesName{this, "InputVerticesName", LHCb::MCVertexLocation::Default,
                                                   "Input MC Vertices to use"};
  Gaudi::Property<std::string> m_outputVerticesName{this, "OutputVerticesName", LHCb::RecVertexLocation::Primary,
