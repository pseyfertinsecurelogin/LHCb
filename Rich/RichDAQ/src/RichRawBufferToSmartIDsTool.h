...
namespace Rich::DAQ {
  ...
  public: // Methods for Gaudi Framework
    ...
    RawBufferToSmartIDsTool( const std::string& type, const std::string& name, const IInterface* parent );
  ...
  public: // methods (and doxygen comments) inherited from interface
    ...
    allRichSmartIDs( const IRawBufferToSmartIDsTool::RawEventLocations& taeLocs ) const override;
  ...
  private: // private methods
    ...
    const LHCb::RichSmartID::Vector& richSmartIDs( const LHCb::RichSmartID pdID, const Rich::DAQ::L1Map& data,
    ...
    unsigned int countTotalHits( const Rich::DAQ::L1Map& data, const Rich::DetectorType rich ) const;
  ...
  inline void RawBufferToSmartIDsTool::InitNewEvent() { m_richDataTAE.clear(); }
