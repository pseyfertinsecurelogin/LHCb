...
namespace Rich::DAQ
{
  ...
  public: // methods (and doxygen comments) inherited from interface
    ...
    richSmartIDs( const LHCb::RichSmartID pdID, const bool createIfMissing = true ) const override;
    ...
    // Access the vector of RichSmartIDs for the given HPD identifier
    const LHCb::RichSmartID::Vector &
    richSmartIDs( const IRawBufferToSmartIDsTool::RawEventLocations &taeLocs,
