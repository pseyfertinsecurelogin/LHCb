...
void
HPDPixelClustersBuilder::initialise( const PDPixelCluster::SmartIDVector &smartIDs )
{
...
void
PMTPixelClustersBuilder::initialise( const PDPixelCluster::SmartIDVector &smartIDs )
{
  // reset the first cluster ID to 0
  m_lastID = 0;
  // clear the pixel data
                                       ...
                                       PDPixelClusters::Cluster *&clus2 )
{
  ...
  { setCluster( id, rowNumber( id ), colNumber( id ), clus1 ); } // delete clus2
  removeCluster( clus2 );
...
MsgStream &
PDPixelClustersBuilder::fillStream( MsgStream &os ) const
{
...
void
PDPixelClustersBuilder::splitClusters( const PDPixelClusters::Cluster::PtnVector &clusters )
{
...
void
PDPixelCluster::addChannel( const LHCb::RichSmartID id ) noexcept
{
  if ( empty() )
  {
...
MsgStream &
PDPixelClusters::fillStream( MsgStream &os ) const
{
