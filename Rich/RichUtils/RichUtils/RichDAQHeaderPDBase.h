...
namespace Rich::DAQ {
  ...
  public:
    ...
    explicit HeaderPDBase( const WordType primWord, const ExtendedHeaderWords& exWords )
  ...
  public: // methods
    ...
    inline const ExtendedHeaderWords& extendedHeaderWords() const& noexcept { return m_extendedWords; }

    /// Move access the extended header words
    inline ExtendedHeaderWords&& extendedHeaderWords() && noexcept { return std::move( m_extendedWords ); }
    ...
    inline ExtendedHeaderWords::size_type nExtendedHeaderWords() const noexcept { return m_extendedWords.size(); }
  ...
  protected: // methods
    ...
    inline ExtendedHeaderWords& extendedHeaderWords() & noexcept { return m_extendedWords; }

    /// Set the given header word
    inline void setHeaderWord( const unsigned short iW, const LongType word ) {
      if ( 0 == iW ) {
        m_primaryHeader = WordType( word );
      } else {
    ...
    inline bool set( const ShortType value, const ShortType shift, const LongType mask, const ShortType wordNumber ) {
    ...
    inline bool dataInRange( const ShortType value, const ShortType max ) const noexcept { return ( value <= max ); }
