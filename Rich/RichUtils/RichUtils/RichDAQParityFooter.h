...
namespace Rich::DAQ {
  ...
  public:
    ...
    inline WordType parityWord() const { return ( hasParityWord() ? footerWords()[0] : WordType( 0 ) ); }
    ...
    inline bool testParityWord( const WordType /* refWord */ ) const { return ( WordType( 0 ) == this->parityWord() ); }
