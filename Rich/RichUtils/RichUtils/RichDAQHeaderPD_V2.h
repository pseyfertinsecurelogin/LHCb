...
namespace Rich::DAQ {
    ...
    public:
      ...
      inline bool setNEightBitBlocksPlusOne( const ShortType value ) {
        return ( dataInRange( value, RichDAQHeaderPDCode::MaxNeightBitP1 )
                     ? set( value, RichDAQHeaderPDCode::ShiftNeightBitP1, RichDAQHeaderPDCode::MaskNeightBitP1 )
                     : false );
      }
  ...
  inline std::ostream& operator<<( std::ostream& os, const RichDAQHeaderV2::RichDAQHeaderPD& header ) {
