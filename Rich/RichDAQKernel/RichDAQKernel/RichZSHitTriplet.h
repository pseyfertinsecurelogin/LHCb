...
namespace Rich::DAQ
{
  ...
  public: // methods
    ...
    inline Rich::DAQ::ShortType row0() const { return ( ( data() & MaskRow0 ) >> ShiftRow0 ); }

    /// Retrieve the second hit row number
    inline Rich::DAQ::ShortType row1() const { return ( ( data() & MaskRow1 ) >> ShiftRow1 ); }

    /// Retrieve the third hit row number
    inline Rich::DAQ::ShortType row2() const { return ( ( data() & MaskRow2 ) >> ShiftRow2 ); }

    /// Retrieve the first hit column number
    inline Rich::DAQ::ShortType col0() const { return ( ( data() & MaskCol0 ) >> ShiftCol0 ); }

    /// Retrieve the second hit column number
    inline Rich::DAQ::ShortType col1() const { return ( ( data() & MaskCol1 ) >> ShiftCol1 ); }
