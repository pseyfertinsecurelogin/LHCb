...
std::ostream& Rich::Future::RecoPhoton::fillStream( std::ostream& s ) const {
  return s << "{"
           << " ckTheta:" << CherenkovTheta() << " ckPhi:" << CherenkovPhi() << " smartID:" << smartID()
...
std::ostream& Rich::Future::GeomPhoton::fillStream( std::ostream& s ) const {
  ...
  return s << "{"
           ...
           << " detectionPoint:" << detectionPoint() << " sphMirReflectionPoint:" << sphMirReflectionPoint()
           << " flatMirReflectionPoint:" << flatMirReflectionPoint() << " primaryMirror:" << (void*)primaryMirror()
