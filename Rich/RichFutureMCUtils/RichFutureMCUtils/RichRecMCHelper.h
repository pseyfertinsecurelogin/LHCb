    ...
    namespace Rec
    {
      namespace MC
      {
        ...
        public:
          ...
          /// Access the common MCParticle for the given track and RICH hit
          const LHCb::MCParticle * trueRecPhoton( const LHCb::Track & track,
          ...
          /// If a true Cherenkov photon, returns the parent MCParticle
          const LHCb::MCParticle * trueCherenkovPhoton( const LHCb::Track & track,
