...
const LHCb::MCParticle* TrackToMCParticle::mcParticle( const LHCb::Track& track, const double minWeight ) const {
...
LHCb::MCParticle::ConstVector TrackToMCParticle::mcParticles( const LHCb::Track& track, const bool includeNull,
...
Rich::ParticleIDType TrackToMCParticle::mcParticleType( const LHCb::Track& track, const double minWeight ) const {
  // get the MCParticle
...
Rich::ParticleIDType TrackToMCParticle::mcParticleType( const LHCb::MCParticle* mcP ) const {
