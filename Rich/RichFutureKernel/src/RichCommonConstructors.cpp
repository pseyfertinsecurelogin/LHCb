...
namespace Rich
{
  namespace Future
  {
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiAlgorithm> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiHistoAlg> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiTupleAlg> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiTool> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiHistoTool> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<GaudiTupleTool> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    ...
    {
      throw GaudiException( "Invalid CommonBase<Converter_Imp> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
    CommonBase< Converter_Imp >::CommonBase( const std::string& /* name */,
      ...
      : Converter_Imp ( 0, CLID_NULL, nullptr )
    {
      throw GaudiException( "Invalid CommonBase<Rich::Converter_Imp> constructor",
                            "CommonBase", StatusCode::FAILURE );
    }
    template <>
