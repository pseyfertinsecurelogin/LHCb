...
// local
#include "CaloFutureMergeTAE.h"

//-----------------------------------------------------------------------------
// Implementation file for class : CaloFutureMergeTAE
//
// 2008-10-24 : Olivier Deschamps
//-----------------------------------------------------------------------------

// Declaration of the Algorithm Factory
DECLARE_COMPONENT( CaloFutureMergeTAE )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
CaloFutureMergeTAE::CaloFutureMergeTAE( const std::string& name,
...
// Initialization
//=============================================================================
StatusCode CaloFutureMergeTAE::initialize() {
  ...
  auto loc = [&]() -> decltype(auto) {
    switch ( m_data.value() ) {
      case futuredetails::source_t::from_adc   : return m_outAdc;
      case futuredetails::source_t::from_digit : return m_outDigit;
...
// Main execution
//=============================================================================
StatusCode CaloFutureMergeTAE::execute() {

  if ( msgLevel(MSG::DEBUG) ) debug() << "==> Execute" << endmsg;

  switch ( m_data.value() ) {
      case futuredetails::source_t::from_adc   : mergeAdcs();   break;
      case futuredetails::source_t::from_digit : mergeDigits(); break;
  };
...
//=============================================================================
void CaloFutureMergeTAE::mergeDigits(){
...
void CaloFutureMergeTAE::mergeAdcs(){
