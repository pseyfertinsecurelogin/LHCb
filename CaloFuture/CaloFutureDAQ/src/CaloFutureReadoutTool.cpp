...
//-----------------------------------------------------------------------------
// Implementation file for class : CaloFutureReadoutTool
//
...
DECLARE_COMPONENT( CaloFutureReadoutTool )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
CaloFutureReadoutTool::CaloFutureReadoutTool( const std::string& type,
                  const std::string& name,
                  const IInterface* parent )
  : base_class( type, name , parent )
  , m_detectorName{  this, "DetectorName", futuredetails::alg_name_to_detector( name ) }
{
...
//=========================================================================
//  Get required CaloFutureBanks (short or packed format) - Fill m_banks
//=========================================================================
StatusCode CaloFutureReadoutTool::initialize(){
...
StatusCode CaloFutureReadoutTool::finalize() {
  IIncidentSvc* inc = incSvc() ;
  if ( inc ) { inc -> removeListener  ( this ) ; }
  return base_class::finalize();
}

bool CaloFutureReadoutTool::getCaloFutureBanksFromRaw( ) {
...
//========================
bool CaloFutureReadoutTool::checkCards(int nCards, const std::vector<int>& feCards ) const
{
  bool check = true;
...
//===========================
int CaloFutureReadoutTool::findCardbyCode(const std::vector<int>& feCards , int code) const {
...
void CaloFutureReadoutTool::putStatusOnTES(){
  // Readout Status
...
void CaloFutureReadoutTool::checkCtrl(int ctrl,int sourceID){
...
bool CaloFutureReadoutTool::checkSrc(int source) {
