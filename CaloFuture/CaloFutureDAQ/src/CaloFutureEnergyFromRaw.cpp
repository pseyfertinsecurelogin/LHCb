// Include files
// local
#include "CaloFutureEnergyFromRaw.h"

//-----------------------------------------------------------------------------
// Implementation file for class : CaloFutureEnergyFromRaw
//
// 2005-01-10 : Olivier Callot
//-----------------------------------------------------------------------------

DECLARE_COMPONENT( CaloFutureEnergyFromRaw )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
CaloFutureEnergyFromRaw::CaloFutureEnergyFromRaw( const std::string& type,
...
//=========================================================================
StatusCode CaloFutureEnergyFromRaw::initialize ( ) {
...
//-------------------------------------
void CaloFutureEnergyFromRaw::clear( ) {
  m_data.clear();
  m_digits.clear();
  m_pinData.clear();
  m_readSources.clear();
...
//-------------------------------------
void CaloFutureEnergyFromRaw::cleanData(int feb ) {
  if(feb<0)return;
...
//=========================================================================
const std::vector<LHCb::CaloAdc>& CaloFutureEnergyFromRaw::pinAdcs () {
  return m_pinData;
}
//=========================================================================
//  Decode the adcs for ALL banks of one event
//=========================================================================
const std::vector<LHCb::CaloAdc>& CaloFutureEnergyFromRaw::adcs () {
  return adcs(-1);
}
//=========================================================================
...
//=========================================================================
const std::vector<LHCb::CaloAdc>& CaloFutureEnergyFromRaw::adcs (int source) {
  clear();
  int sourceID   ;
  bool decoded = false;
  bool found   = false;
...
//=========================================================================
const std::vector<LHCb::CaloAdc>& CaloFutureEnergyFromRaw::adcs ( const LHCb::RawBank& bank ){
  clear();
...
//=========================================================================
const std::vector<LHCb::CaloDigit>&  CaloFutureEnergyFromRaw::digits ( int source ) {
  adcs( source );
...
//=========================================================================
const std::vector<LHCb::CaloDigit>&  CaloFutureEnergyFromRaw::digits ( const LHCb::RawBank& bank ) {
  adcs( bank );
  if( !getDigits() ) m_digits.clear();
  return m_digits ;
}
...
//=========================================================================
const std::vector<LHCb::CaloDigit>&  CaloFutureEnergyFromRaw::digits ( ) {
  adcs();
  if ( !getDigits() ) m_digits.clear();
  return m_digits;
}
...
//=============================================================================
bool CaloFutureEnergyFromRaw::getData ( const LHCb::RawBank& bank ){
...
//=========================================================================
bool CaloFutureEnergyFromRaw::getDigits ( ) {
  m_digits.clear();
