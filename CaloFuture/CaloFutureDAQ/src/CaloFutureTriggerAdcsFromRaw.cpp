...
#include "CaloFutureTriggerAdcsFromRaw.h"

//-----------------------------------------------------------------------------
// Implementation file for class : CaloFutureTriggerAdcsFromRaw
//
// 2005-01-05 : Olivier Callot
//-----------------------------------------------------------------------------

DECLARE_COMPONENT( CaloFutureTriggerAdcsFromRaw )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
CaloFutureTriggerAdcsFromRaw::CaloFutureTriggerAdcsFromRaw( const std::string& type,
...
//  Initialise
//=========================================================================
StatusCode CaloFutureTriggerAdcsFromRaw::initialize ( ) {
...
//-------------------------------------
void CaloFutureTriggerAdcsFromRaw::clear( ) {
  m_data.clear();
  m_pinData.clear();
  m_readSources.clear();
}
...
void CaloFutureTriggerAdcsFromRaw::cleanData(int feb ) {
  if(feb<0)return;
...
//=========================================================================
const std::vector<LHCb::L0CaloAdc>& CaloFutureTriggerAdcsFromRaw::pinAdcs () {
  return m_pinData;
}
//=========================================================================
//  Decode the adcs for ALL banks of one event
//=========================================================================
const std::vector<LHCb::L0CaloAdc>& CaloFutureTriggerAdcsFromRaw::adcs () {
  return adcs(-1);
}
//=========================================================================
...
//=========================================================================
const std::vector<LHCb::L0CaloAdc>& CaloFutureTriggerAdcsFromRaw::adcs (int source ) {
  clear();
  bool decoded = false;
  bool found   = false;
  int sourceID  ;
...
//=========================================================================
const std::vector<LHCb::L0CaloAdc>& CaloFutureTriggerAdcsFromRaw::adcs ( const LHCb::RawBank& bank ){
  clear();
...
bool CaloFutureTriggerAdcsFromRaw::getData ( const LHCb::RawBank& bank ){
