#ifndef ICALOFUTURECOSMICSTRACKTOOL_H 
#define ICALOFUTURECOSMICSTRACKTOOL_H 1
...
struct ICaloFutureCosmicsTool;


/** @class ICaloFutureCosmicsTrackTool ICaloFutureCosmicsTrackTool.h
 *  
 *
 *  @author Olivier Deschamps
 *  @date   2008-05-17
 */
struct ICaloFutureCosmicsTrackTool : public extend_interfaces<IAlgTool> {

  DeclareInterfaceID( ICaloFutureCosmicsTrackTool, 2, 0 );
  ...
  virtual ICaloFutureCosmicsTool* ecal()=0;
  virtual ICaloFutureCosmicsTool* hcal()=0;
...
#endif // ICALOFUTURECOSMICSTRACKTOOL_H
