...
###############################################################################
# =============================================================================
## @file CaloFutureUtils/CellID.py
...
_SET2 = std.set('const LHCb::CaloFutureDigit*')
_VCT2 = std.vector('const LHCb::CaloFutureDigit*')
...
def _set_at_(self, index):
    ...
    """
    return LHCb.CaloFutureHelpers._get_at_(self, index)


_set_at_.__doc__ += '\n' + LHCb.CaloFutureHelpers._get_at_.__doc__
...
def _set_insert_(self, obj):
    ...
    insert in set
    """
    return LHCb.CaloFutureHelpers._insert_(self, obj)
...
def _toVector_(self):
    ...
    Convert set to vector
    """
    return LHCb.CaloFutureHelpers.toVector(self)
...
def _toSet_(self):
    ...
    Convert vector to set
    """
    return LHCb.CaloFutureHelpers.toSet(self)
...
LHCb.CaloFutureDigit.Set = _SET2
LHCb.CaloFutureDigit.Vector = _VCT2
...
def __calovector_iter__(self):
    """
    Iterator over CaloFuture Vector
...
for t in ('CellParam', 'LHCb::CaloFutureDigit', 'LHCb::CaloFutureDigit*',
          'LHCb::CaloFutureAdc'):
