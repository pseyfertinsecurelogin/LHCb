...
\*****************************************************************************/
// ============================================================================
#ifndef CALOFUTUREUTILS_CELLMATRIX2X2_H
#define CALOFUTUREUTILS_CELLMATRIX2X2_H 1
// Include files
#include "CaloFutureUtils/CellMatrix.h"

/** @class CellMatrix2x2 CellMatrix2x2.h CaloFutureUtils/CellMatrix2x2.h
 *
 *
...
public:
  enum SubMatrixType { UpperLeft = 0, UpperRight = 1, LowerLeft = 2, LowerRight = 3, Max = 4 };
...
public:
   ...
   */
  inline void setType( const SubMatrixType& newT ) const { m_type = newT; }
...
// ============================================================================
#endif // CALOFUTUREUTILS_CELLMATRIX2X2_H
