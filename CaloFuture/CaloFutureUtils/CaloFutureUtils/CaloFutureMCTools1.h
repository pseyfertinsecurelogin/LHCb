...
{ 
  ...
  template<>
  inline StatusCode
  MCCaloFutureHistory<LHCb::MCCaloHit>::operator() 
  ...
  template<>
  inline StatusCode
  MCCaloFutureHistory<LHCb::MCCaloDigit>::operator() 
  ...
  template<>
  inline StatusCode
  MCCaloFutureHistory<LHCb::CaloDigit>::operator() 
  ...
  template<>
  inline StatusCode
  MCCaloFutureHistory<LHCb::CaloCluster>::operator() 
   ...
   *  @date   2003-04-01 
   */
  inline StatusCode updateCaloFutureMCMap
  ( const LHCb::MCParticle* mcp      , 
    const double      energy   , 
    CaloFutureMCMap&        mcmap    )
  {
