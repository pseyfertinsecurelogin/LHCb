...
public:
   ...
   */
  inline void setDet( const DeCalorimeter* Det ) { m_det = Det; }
...
protected:
   ...
   */
  CellMatrix( const DeCalorimeter* Det = nullptr ) : m_det( Det ){};
...
protected:
  ...
  inline double area( const Gaudi::XYZPoint& center1, const double halfsize1, const Gaudi::XYZPoint& center2,
    ...
    const double ySize = std::min( center1.y() + halfsize1, center2.y() + halfsize2 ) -
