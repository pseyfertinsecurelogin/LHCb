...
\*****************************************************************************/
// ============================================================================
#ifndef EVENT_CALOFUTUREMCTOOLS_H 
#define EVENT_CALOFUTUREMCTOOLS_H 1
// Include files
#include <numeric>
// Event 
...
#include "CaloFutureMCTools1.h"

/** @namespace CaloFutureMCTools CaloFutureMCTools.h Event/CaloFutureMCTools.h
 *  
 *  Collection of useful methods/utilities/functors 
 *  for fast(inline) extraction of MC truth information 
 *  for CaloFuture-object 
 * 
...
namespace CaloFutureMCTools
{
  ...
  // ==========================================================================
  /** @class EnergyFromMCParticle CaloFutureMCTools.h Event/CaloFutureMCTools.h 
   *  
  ...
  // ==========================================================================
  /** @class FromMCParticle CaloFutureMCTools.h Event/CaloFutureMCTools.h 
   * 
  ...
  // ==========================================================================
  /** @class LargestDeposition CaloFutureMCTools.h Event/CaloFutureMCTools.h
   *  
    ...
    ParticlePair operator() ( const LHCb::CaloCluster* cluster ) const 
    {
      ...
      return std::accumulate( auxMap.begin(), auxMap.end(), ParticlePair{},
                              ...
                              { return ( map.first && map.second>output.first ) ? 
                                        std::make_pair(map.second,map.first) : output ; 
                              } );
...
} // The end of namespace CaloFutureMCTools 

// ============================================================================
#endif // EVENT_CALOFUTUREMCTOOLS_H
