...
public:
  ...
  void fillCaloFuture2D( const HistoID& unit, const LHCb::CaloCellID& id, double value,
                         const std::string title = "" ) const;
  void fillCaloFuturePin2D( const HistoID& unit, const LHCb::CaloCellID& id, double value,
                            const std::string title = "" ) const;
