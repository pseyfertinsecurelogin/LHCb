...
void CaloFuture2Dview::bookCaloFuture2D( const HistoID& unit, const std::string title, CaloCellCode::CaloIndex calo,
                                         int area ) const {
...
void CaloFuture2Dview::fillCaloFuture2D( const HistoID& unit, LHCb::MCCaloDigit mcdigit,
...
void CaloFuture2Dview::fillCaloFuture2D( const HistoID& unit, LHCb::L0CaloCandidate l0calo,
                                         const std::string title ) const {
  setL0ClusterView( true );
  double weight = m_energyWeighted ? l0calo.et() : 1.;
  fillCaloFuture2D( unit, l0calo.id(), weight, title );
}
void CaloFuture2Dview::fillCaloFuture2D( const HistoID& unit, LHCb::CaloCluster cluster,
                                         const std::string title ) const {
  setL0ClusterView( true );
...
void CaloFuture2Dview::fillCaloFuture2D( const HistoID& unit, const LHCb::CaloCellID& id, double value,
                                         const std::string title ) const {
  // threshold
...
void CaloFuture2Dview::fillCaloFuturePin2D( const HistoID& unit, const LHCb::CaloCellID& id, double value,
                                            const std::string title ) const {
  // Validation
