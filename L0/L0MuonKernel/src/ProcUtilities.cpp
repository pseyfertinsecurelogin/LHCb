...
std::vector<LHCb::MuonTileID> L0Muon::add2pads( int quarter, int board, int pu, int colM3, int rowM3, int offM2,
                                                int offM1, int procVersion, bool debug ) {
  ...
  if ( debug )
    std::cout << "\t=> L0Muon::add2pads :"
              << " pu: " << pu << " (x: " << punx << " , y: " << puny << ")"
              << " => puID: " << puID.toString() << std::endl;
  ...
  if ( debug )
    std::cout << "\t=> L0Muon::add2pads : padM3ID: " << padM3ID.toString() << " (col: " << colM3 << " , row: " << rowM3
              << " )" << std::endl;
    ...
    if ( padM1ID.nX() >= 2 * padM1ID.layout().xGrid() ) {
      ...
      if ( lpads.size() == 0 ) {
        if ( debug ) {
          ...
          std::cout << "   * PB" << board << " PU" << pu << std::endl;
          std::cout << "   * col /row M3= " << colM3 << " / " << rowM3 << " offM2= " << offM2 << "offM1= " << offM1
                    << std::endl;
...
// Compute pt, theta and phi
std::vector<double> L0Muon::kine( LHCb::MuonTileID p1, LHCb::MuonTileID p2, int procVersion, bool debug, double x1,
  ...
  if ( fabs( x0 ) < 0.0001 ) {
    ...
    phi = atan( y0 / x0 );
    if ( phi > 0. && y0 < 0. ) { phi -= 3.14159; }
    if ( phi < 0. && y0 > 0. ) { phi += 3.14159; }
  }

  if ( debug )
    std::cout << "\t=> L0Muon::kine : "
              << " p1 = " << p1.toString() << " p2 = "
              << p2.toString()
              //                            << " d1 = " <<   d1
              //                            << " d2 = " <<   d2
              ...
              //                            << " xslope= " <<xslope
              //                            << " xin= " <<   xin
              << " pt= " << pt << " theta= " << theta << " phi= " << phi << std::endl;
...
std::vector<double> L0Muon::kineV0( LHCb::MuonTileID p1, LHCb::MuonTileID p2, bool debug ) {
  ...
  if ( debug )
    std::cout << "---  L0Muon::kineV0 : "
              << " p1 = " << p1.toString() << " p2 = " << p2.toString() << " d1 = " << d1 << " d2 = " << d2
              << " d3 = " << d3 << " alpha= " << alpha << " x1 = " << x1 << " y1 = " << y1 << " x2 = " << x2
              << " y2 = " << y2 << " sq= " << sq << " sr= " << sr << " sc= " << sc << " st= " << st << " ptm= " << ptm
              << " xslope= " << xslope << " xin= " << xin << " pt= " << pt << " theta= " << theta << " phi= " << phi
              << std::endl;
...
int L0Muon::encodePT( double pT, int procVersion, bool debug ) {
  ...
  if ( debug )
    std::cout << "L0Muon::ptEncoding parameters are: nbits= " << nbits << " ptMax= " << ptMax << " dpT= " << dpT
              << std::endl;
