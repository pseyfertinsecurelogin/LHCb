...
namespace L0Muon {
  ...
  */
  ...
  public:
    ...
    void clear() { m_candRegister->reset(); }

    /// Return true if the Register is not empty
    bool isValid() { return ( m_candRegister != 0 ); }
    ...
    */
    ...
    /** Set in the register the status bits
        ...
        @param icand : index of the candidate (0,1)
    */
    void setStatus( int status ) { m_candRegister->set( status, BitsStatus, ShiftStatus ); }
    ...
    */
    ...
    /** Get from the register the candidate's pt (absolute value)
        ...
        @param icand : index of the candidate (0,1)
    */
    int getCandPT( int icand ) { return m_candRegister->getulong( BitsCandPT, ShiftCandPT + icand * BitsCandTot ); }
    ...
    */
    ...
    /** Get from the register the candidate's PU index (0 to 3)
        ...
        @param icand : index of the candidate (0,1)
    */
    int getCandPU( int icand ) { return m_candRegister->getulong( BitsCandPU, ShiftCandPU + icand * BitsCandTot ); }
    ...
    */
    ...
    /** Get from the register the status bits
        ...
        @param icand : index of the candidate (0,1)
    */
    int getStatus() { return m_candRegister->getulong( BitsStatus, ShiftStatus ); }
