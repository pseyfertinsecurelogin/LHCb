...
public:
  ...
  L0DUFromRawTool( const std::string& type, const std::string& name, const IInterface* parent );
...
private:
  ...
  inline void encode( const std::string& name, unsigned int data,
                      const std::array<unsigned int, L0DUBase::Index::Size>& base, int bx = 0 );
...
inline void L0DUFromRawTool::encode( const std::string& name, unsigned int data,
                                     const std::array<unsigned int, L0DUBase::Index::Size>& base, int bx ) {
  ...
  word |=
      ( ( data & ( base[L0DUBase::Index::Mask] >> base[L0DUBase::Index::Shift] ) ) << base[L0DUBase::Index::Shift] );
