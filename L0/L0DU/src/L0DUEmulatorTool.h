...
public:
  ...
  L0DUEmulatorTool( const std::string& type, const std::string& name, const IInterface* parent );
...
private:
  ...
  void setDataValue( LHCb::L0DUElementaryData* data, const std::array<unsigned int, L0DUBase::Index::Size>& base );
