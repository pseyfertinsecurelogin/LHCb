...
private:
  Gaudi::Property<bool>        m_writeProcData{this, "WriteProcData",
                                        false}; ///< Flag to activate the writing of the processor data
  Gaudi::Property<bool>        m_writeOnTES{this, "WriteOnTES",
                                     true}; ///< Flag to activate the writing of the Candidates/Report on the TES
