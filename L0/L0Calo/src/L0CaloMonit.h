...
private:
   ...
   */
  void bookEtHist( const unsigned int i, std::vector<AIDA::IHistogram1D*>& hist, const std::string& suffix );

  /** Auxiliary function to book one frequency histogram
   *  @param[in]  i      type of candidate (L0DUBase::CaloType)
   *  @param[out] hist   vector of IHistogram1D to book
   */
  void bookFreqHist( const unsigned int i, std::vector<std::vector<AIDA::IHistogram1D*>>& hist );

  /** Auxiliary function to book one crate histogram
   *  @param[in]  i      type of candidate (L0DUBase::CaloType)
   *  @param[out] hist   vector of IHistogram1D to book
   */
  void bookCrateHist( const unsigned int i, std::vector<std::vector<AIDA::IHistogram1D*>>& hist );
