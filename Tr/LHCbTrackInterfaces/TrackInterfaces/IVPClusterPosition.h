...
struct IVPClusterPosition : extend_interfaces<IAlgTool> {
   ...
   */
  virtual LHCb::VPPositionInfo position( const LHCb::VPLightCluster& cluster ) const = 0;
   ...
   */
  virtual LHCb::VPPositionInfo position( const LHCb::VPLightCluster& cluster, const Gaudi::XYZPoint& point,
