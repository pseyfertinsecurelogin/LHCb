...
ODIN LHCb::ODINCodec::decode( const RawBank& bank, const bool ignoreBankVersion ) {
  ...
  odin.setDetectorStatus( (temp32 & LHCb::ODIN::Word7Masks::DetectorStatusMask) >> LHCb::ODIN::Word7Bits::DetectorStatusBits );
  ...
  if (version >= 5) {
    ...
    odin.setReadoutType( ((temp32 & LHCb::ODIN::Word8Masks::CalibrationTypeMask) >> LHCb::ODIN::Word8Bits::CalibrationTypeBits ) == 0 ?
                          LHCb::ODIN::ReadoutTypes::ZeroSuppressed : LHCb::ODIN::ReadoutTypes::NonZeroSuppressed );
  }

  if (version >= 4) {
    odin.setTimeAlignmentEventWindow( (temp32 & LHCb::ODIN::Word8Masks::TAEWindowMask) >> LHCb::ODIN::Word8Bits::TAEWindowBits );
  }
  ...
  odin.setBunchCurrent( (temp32 & LHCb::ODIN::Word8Masks::BunchCurrentMask) >> LHCb::ODIN::Word8Bits::BunchCurrentBits );
  ...
  if (version < 3) {
    ...
    odin.setEventType((temp32 & LHCb::ODIN::EventTypeMasks::EventTypeMask) >> LHCb::ODIN::EventTypeBitsEnum::EventTypeBits);
    odin.setCalibrationStep((temp32 & LHCb::ODIN::EventTypeMasks::CalibrationStepMask) >> LHCb::ODIN::EventTypeBitsEnum::CalibrationStepBits);
...
Bank::array LHCb::ODINCodec::encode( const LHCb::ODIN& odin ) {
  ...
  data[LHCb::ODIN::Data::EventType] = ((odin.eventType() << LHCb::ODIN::EventTypeBitsEnum::EventTypeBits) & LHCb::ODIN::EventTypeMasks::EventTypeMask) |
    ((odin.calibrationStep() << LHCb::ODIN::EventTypeBitsEnum::CalibrationStepBits) & LHCb::ODIN::EventTypeMasks::CalibrationStepMask);
  ...
  data[LHCb::ODIN::Data::Word7] = (unsigned int) ( ((odin.detectorStatus() << LHCb::ODIN::Word7Bits::DetectorStatusBits) & LHCb::ODIN::Word7Masks::DetectorStatusMask) |
                                             ((odin.errorBits() << LHCb::ODIN::Word7Bits::ErrorBits) & LHCb::ODIN::Word7Masks::ErrorMask) );
  ...
  data[LHCb::ODIN::Data::Word8] = ((odin.bunchId() << LHCb::ODIN::Word8Bits::BunchIDBits) & LHCb::ODIN::Word8Masks::BunchIDMask) |
    ((odin.timeAlignmentEventWindow() << LHCb::ODIN::Word8Bits::TAEWindowBits) & LHCb::ODIN::Word8Masks::TAEWindowMask) |
    ((triggerType << LHCb::ODIN::Word8Bits::TriggerTypeBits) & LHCb::ODIN::Word8Masks::TriggerTypeMask) |
    ((odin.calibrationType() << LHCb::ODIN::Word8Bits::CalibrationTypeBits) & LHCb::ODIN::Word8Masks::CalibrationTypeMask) |
