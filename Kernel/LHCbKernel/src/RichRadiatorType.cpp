...
std::string Rich::text( const Rich::RadiatorType radiator ) {
  ...
  case Rich::Rich2Gas:
    return "Rich2Gas";
  case Rich::GasQuartzWin:
    return "GasQuartzWin";
  case Rich::HPDQuartzWin:
    return "HPDQuartzWin";
  case Rich::Nitrogen:
    return "Nitrogen";
  case Rich::AerogelFilter:
    return "AerogelFilter";
  case Rich::CO2:
    return "Rich CO2";
  case Rich::PMTQuartzWin:
    return "PMTQuartzWin";
  case Rich::InvalidRadiator:
    return "Invalid Radiator";
  default:
