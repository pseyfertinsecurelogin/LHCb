...
Trajectory<double>::Vector ParabolaTraj::direction( double arclength ) const { return m_dir + arclength * m_curv; }

/// Second derivative of the trajectory at arclength from the starting point
Trajectory<double>::Vector ParabolaTraj::curvature( double /* arclength */ ) const { return m_curv; }

/// Create a parabolic approximation to the trajectory
/// at arclength from the starting point
void ParabolaTraj::expansion( double arclength, Point& p, Vector& dp, Vector& ddp ) const {
  ddp = m_curv;
...
double ParabolaTraj::distTo2ndError( double, double, int ) const { return 10 * Gaudi::Units::km; }
