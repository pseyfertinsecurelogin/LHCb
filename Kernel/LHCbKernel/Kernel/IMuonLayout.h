...
public:
  ...
  */
  virtual std::pair<unsigned int, unsigned int> grid( const LHCb::MuonTileID& id ) const = 0;
  ...
  */
  ...
  virtual std::vector<LHCb::MuonTileID> tiles( const LHCb::MuonTileID& pad ) const = 0;
  ...
  */
  virtual std::vector<LHCb::MuonTileID> tilesInArea( const LHCb::MuonTileID& pad, int areaX, int areaY ) const = 0;
  ...
  */
  ...
  virtual std::vector<LHCb::MuonTileID> tilesInRegion( const LHCb::MuonTileID& pad, int pregion ) const = 0;

  /// find all the MuonTileID's which are neighbours of the argument tile
  virtual std::vector<LHCb::MuonTileID> neighbours( const LHCb::MuonTileID& pad ) const = 0;
  ...
  */
  virtual std::vector<LHCb::MuonTileID> neighbours( const LHCb::MuonTileID& pad, int dirX, int dirY ) const = 0;
  ...
  */
  virtual std::vector<LHCb::MuonTileID> neighbours( const LHCb::MuonTileID& pad, int dirX, int dirY,
                                                    int depth ) const = 0;
