...
// IMPORTANT note: this file has temporarily been copied into LHCb from Gaudi!1026.
// This file should be removed once it is available in Gaudi.

namespace LHCb::Arena {
  namespace details {
  ...
  public:
    ...
    std::byte* allocate( std::size_t n ) {
      ...
      // the case.
      static_assert( ReqAlign <= alignment, "Requested alignment too large for this LHCb::Arena::Monotonic!" );
