...
namespace LHCb::Vector::Mem {
  ...
  struct Store {
    ...
    typename std::list<std::vector<PRECISION, aligned_allocator<PRECISION, VectorConfiguration::bytewidth()>>>::iterator
             currentBackend;
    ...
    inline PRECISION* getPointer(
        const typename std::list<
            std::vector<PRECISION, aligned_allocator<PRECISION, VectorConfiguration::bytewidth()>>>::iterator& backend,
