...
namespace LHCb {
  ...
  class Relation1D : public DataObject, public Relations::BaseTable, public IRelation<FROM, TO> {
  public:
    // ========================================================================
  ...
  public:
    ...
    Relation1D( const size_t reserve = 0 ) : DataObject(), Relations::BaseTable(), IBase(), m_base( reserve ) {
    ...
    Relation1D( const IDirect& copy ) : DataObject(), Relations::BaseTable(), IBase(), m_base( copy ) {
#ifdef COUNT_INSTANCES
      Relations::InstanceCounter::instance().increment( type() );
#endif // COUNT_INSTANCES
    }
     ...
     *  copy constructor
     */
    Relation1D( const IInverse& inv, const int flag )
  ...
  public: // merge
     ...
     *  @return self-reference
     */
    Relation1D& operator+=( const Range& range ) { return merge( range ); }
    // ========================================================================
