...
class Rel1D(Rel):
    ...
    def related(self):
        return []  ##  Rel1D( self.To , self.From ) ]
    ...
    def types(self):
        ...
        return (table, [ibase, base0, base1, entry, entries, range])

    def name(self):
        return self.types()[0]

    def Dict(self):
        return _fmt_type_("GaudiDict::Relation1DDict<%s,%s>",
                          (self.From, self.To))
...
class Rel2D(Rel):
    ...
    def related(self):
        return [Rel2D(self.To, self.From)]
    ...
    def types(self):
        ...
        range = _fmt_type_("Relations::Range_<%s>", entries)
        return (table,
                [ibas1, ibas2, base0, base1, base2, entry, entries, range])

    def name(self):
        return self.types()[0]

    def Dict(self):
        return _fmt_type_("GaudiDict::Relation2DDict<%s,%s>",
                          (self.From, self.To))
...
class RelW1D(Rel):
    ...
    def related(self):
        return []  ##  RelW1D( self.To , self.From , self.Weight ) ]
    ...
    def types(self):
        ...
        base0 = _fmt_type_("Relations::RelationWeightedBase<%s,%s,%s>",
                           triplet)
    ...
    def Dict(self):
        return _fmt_type_("GaudiDict::RelationWeighted1DDict<%s,%s,%s>",
...
class RelW2D(Rel):
    ...
    def Dict(self):
        return _fmt_type_("GaudiDict::RelationWeighted2DDict<%s,%s,%s>",
                          (self.From, self.To, self.Weight))
...
def _write_xml_(lines, lst):
    ...
    lines += ['     *']
    lines += [
        '     * The basic selection file to build the Reflex dictionaries'
    ]
