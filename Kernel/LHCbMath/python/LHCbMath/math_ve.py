...
__all__ = ('exp', 'expm1', 'log', 'log10', 'log1p', 'sqrt', 'cbrt', 'pow',
           ...
           'atan', 'asinh', 'acosh', 'atanh', 'erf', 'erfc', 'erfi', 'erfcx',
           'probit', 'gamma', 'tgamma', 'lgamma', 'igamma', 'exp2', 'log2',
           'hypot', 'fma')
# =============================================================================
import math
...
if '__main__' == __name__:
    ...
    funcs = [
        exp, expm1, log, log10, log1p, sqrt, cbrt, sin, cos, tan, sinh, cosh,
        tanh, sech, asin, acos, atan, asinh, acosh, atanh, erf, erfc, erfi,
        erfcx, probit, gamma, tgamma, lgamma, igamma
    ]

    ## use helper object:
    from LHCbMath.deriv import EvalVE
    funcs += [EvalVE(math.sin, math.cos), EvalVE(math.sin)]
