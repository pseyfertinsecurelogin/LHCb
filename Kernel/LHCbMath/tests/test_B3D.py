...
for i in range(b.npars()):
    b.setPar(i, random.uniform(-1, 1))

tiny = 1.e-7
i = b.integral()
ii = b.integral(b.xmin() + tiny,
                b.xmax() - tiny,
                b.ymin() + tiny,
                b.ymax() - tiny,
                b.zmin() + tiny,
...
f1 = ROOT.TF3('f1', _f1, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
...
f2 = ROOT.TF3('f2', _f2, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
...
f3 = ROOT.TF3('f3', _f3, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
...
f4 = ROOT.TF3('f4', _f4, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
...
f5 = ROOT.TF3('f5', _f5, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
...
f6 = ROOT.TF3('f6', _f6, b.xmin(), b.xmax(), b.ymin(), b.ymax(), b.zmin(),
              b.zmax())
