...
for i in range(100):
    ...
    if not ymin <= y <= ymax:
        raise ValueError(
            'Invalid polynom value y(%s)=%s (%s/%s)' % (x, y, ymin, ymax))
...
for i in range(500):
    ...
    if y1 > y2:
        raise ValueError(
            'Invalid Increasing y(%s)=%s>y(%s)=%s' % (x1, y1, x2, y1))
...
for i in range(500):
    ...
    if y1 < y2:
        raise ValueError(
            'Invalid Decreasing y(%s)=%s<y(%s)=%s' % (x1, y1, x2, y2))
...
for i in range(500):
    ...
    if y1 > y2:
        raise ValueError(
            'Invalid Convex(11)[0] y(%s)=%s>y(%s)=%s' % (x1, y1, x2, y2))
    ...
    if y1 < y2:
        raise ValueError(
            'Invalid Convex(01)[0] y(%s)=%s<y(%s)=%s' % (x1, y1, x2, y2))
    ...
    if y1 > y2:
        raise ValueError(
            'Invalid Convex(10)[0] y(%s)=%s>y(%s)=%s' % (x1, y1, x2, y2))
    ...
    if y1 < y2:
        raise ValueError(
            'Invalid Convex(00)[0] y(%s)=%s<y(%s)=%s' % (x1, y1, x2, y2))
