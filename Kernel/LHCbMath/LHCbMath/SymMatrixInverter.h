...
namespace Gaudi {
  namespace Math {
    ...
    namespace SymMatrixInverter {
        ...
        inline bool                    operator()( T& m, int N ) const {
          ...
          for ( int i = 0; i < N; base1 += ++i ) {
            ...
            for ( int j = 0; j < i; base2 += ++j ) {
              F tmp = m( i, j );
              for ( int k = j; k--; ) tmp -= base1[k] * base2[k] * o[k];
          ...
          for ( int i = 1; i < N; base1 += ++i ) {
            for ( int j = 0; j < i; ++j ) {
              F  tmp   = F( 0 );
              F* base2 = &l[( i * ( i - 1 ) ) / 2];
              for ( int k = i; k-- > j; base2 -= k ) tmp -= base1[k] * base2[j];
              base1[j] = tmp * base1[i];
            }
          }
          ...
          for ( int i = N; i--; ) {
            for ( int j = i + 1; j--; ) {
              F tmp = F( 0 );
              base1 = &l[( N * ( N - 1 ) ) / 2];
              for ( int k = N; k-- > i; base1 -= k ) tmp += base1[i] * base1[j] * o[k];
              m( i, j ) = tmp;
            }
          }
      ...
      struct inverter {
        inline bool operator()( T& m ) const { return inverterForAllN<T>()( m, T::kRows ); }
      };

      /// inverts a symmetric matrix (dimension 6)
      template <class T, class F>
      struct inverter<T, F, 6> {
        inline bool operator()( T& m ) const {
          ...
          const F li41 = ( -l21 * l32 * l43 * li22 * li33 + l21 * l42 * li22 + l31 * l43 * li33 - l41 ) * li11 * li44;
          const F li54 = -l54 * li55 * li44;
          const F li53 = ( l54 * l43 * li44 - l53 ) * li33 * li55;
          const F li52 = ( -l32 * l43 * l54 * li33 * li44 + l32 * l53 * li33 + l42 * l54 * li44 - l52 ) * li22 * li55;
          const F li51 = ( l21 * l32 * l43 * l54 * li22 * li33 * li44 - l54 * l43 * l31 * li44 * li33 -
                           l53 * l32 * l21 * li22 * li33 - l54 * l42 * l21 * li44 * li22 + l52 * l21 * li22 +
                           l53 * l31 * li33 + l54 * l41 * li44 - l51 ) *
                         li11 * li55;
          const F li65 = -l65 * li66 * li55;
          const F li64 = ( l65 * l54 * li55 - l64 ) * li44 * li66;
          const F li63 = ( -l43 * l54 * l65 * li44 * li55 + l43 * l64 * li44 + l53 * l65 * li55 - l63 ) * li33 * li66;
          const F li62 = ( l32 * l43 * l54 * l65 * li33 * li44 * li55 - l64 * l43 * l32 * li44 * li33 -
                           l65 * l53 * l32 * li55 * li33 - l65 * l54 * l42 * li55 * li44 + l63 * l32 * li33 +
                           l64 * l42 * li44 + l65 * l52 * li55 - l62 ) *
                         li22 * li66;
          const F li61 =
              ( -l65 * l54 * l43 * l32 * l21 * li22 * li33 * li44 * li55 + l64 * l43 * l32 * l21 * li22 * li33 * li44 +
                l65 * l53 * l32 * l21 * li22 * li33 * li55 + l65 * l54 * l42 * l21 * li22 * li44 * li55 +
                l65 * l54 * l43 * l31 * li33 * li44 * li55 - l63 * l32 * l21 * li22 * li33 -
                l64 * l42 * l21 * li22 * li44 - l65 * l52 * l21 * li22 * li55 - l64 * l43 * l31 * li33 * li44 -
                l65 * l53 * l31 * li33 * li55 - l65 * l54 * l41 * li44 * li55 + l62 * l21 * li22 + l63 * l31 * li33 +
                l64 * l41 * li44 + l65 * l51 * li55 - l61 ) *
              li11 * li66;
