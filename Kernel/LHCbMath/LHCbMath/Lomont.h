...
namespace LHCb
{
  ...
  namespace Math
  {
     ...
     *  const float b = ... ;
     *
     *  const bool equal = LHCb::Math::lomont_compare_float ( a , b ) ;
     *
     *  @endcode
     *
     ...
     *  const double b = ... ;
     *
     *  const bool equal = LHCb::Math::lomont_compare_double ( a , b ) ;
     *
     *  @endcode
     *
     *  @param  af the first number
     ...
     *  @code
     *
     *  LHCb::Math::Lomont<float> compare ( 100 ) ;
     *
     *  const float a = ... ;
     *  const float b = ... ;
     *
     ...
     *  @code
     *
     *  LHCb::Math::Lomont<double> compare ( 500 ) ;
     *
     *  const double a = ... ;
     *  const double b = ... ;
     *
     ...
     *
     *  This routine is very convenient to test the parameter maxULPS for
     *  the routine LHCb::Math::lomont_compare_double
     *
