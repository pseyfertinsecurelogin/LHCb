...
namespace Gaudi {
  ...
  namespace Math {
    ...
    public: // conversion to the counter with longer history: N<= n < 2*N
      ...
      inline const StatEntity& counter() const { return m_cnt1.nEntries() > m_cnt2.nEntries() ? m_cnt1 : m_cnt2; }
    ...
    public:
       ...
       */
      std::ostream& fillStream( std::ostream& o ) const { return counter().fillStream( o ); }
      // =====================================================================
    ...
    inline std::ostream& operator<<( std::ostream& stream, const NStatEntity& entity ) {
      return entity.fillStream( stream );
    }
    // ========================================================================
    /// operator for addition of NStatEntity and a number
    inline NStatEntity operator+( const NStatEntity& entity, const double value ) {
      NStatEntity n( entity );
      n.addFlag( value );
      return n;
    }
    /// operator for addition of NStatEntity and a number
    inline NStatEntity operator+( const double value, const NStatEntity& entity ) { return entity + value; }
    /// operator for addition of NStatEntity and a number
    inline NStatEntity operator-( const NStatEntity& entity, const double value ) { return entity + ( -1 * value ); }
    // ========================================================================
  } // namespace Math
  // ==========================================================================
