...
namespace Gaudi {
  ...
  namespace Math {
    ...
    public:
      ...
      public:
        // ====================================================================
        explicit Basic( const unsigned short k = 0, const unsigned short N = 0 ) : m_k( k ), m_N( N ) {}
        // ====================================================================
      public:
        // ====================================================================
    ...
    public:
      ...
      Bernstein( const unsigned short N = 0, const double xmin = 0, const double xmax = 1 );
      // ======================================================================
      /// constructor from N+1 coefficients
      Bernstein( const std::vector<double>& pars, const double xmin = 0, const double xmax = 1 );
      // ======================================================================
      /// construct the basic bernstein polinomial  B(k,N)
      Bernstein( const Basic& basic, const double xmin = 0, const double xmax = 1 );
      // ======================================================================
      /// template constructor from sequence of parameters
      template <class ITERATOR>
      Bernstein( ITERATOR first, ITERATOR last, const double xmin, const double xmax )
      ...
      Bernstein( const Bernstein& poly, const double xmin, const double xmax );
      // ======================================================================
       ...
       */
      Bernstein( const std::vector<double>& x, const std::vector<double>& y, const double xmin = 0,
                 const double xmax = 1 );
      // ======================================================================
      /** construct Bernstein interpolant
       *  @param x    vector of abscissas
      ...
      Bernstein( XITERATOR xbegin, XITERATOR xend, YITERATOR ybegin, YITERATOR yend, const double xmin,
                 const double xmax );
      // ======================================================================
       ...
       */
      Bernstein( const double xmin, const double xmax, const std::vector<double>& r = std::vector<double>(),
                 const std::vector<std::complex<double>>& c = std::vector<std::complex<double>>() );
      // ======================================================================
      /** construct Bernstein polynomial from its roots
       *
       *  Polinomial has a form
       ...
       *  @param r  the list of real  roots of the polinomial
       */
      Bernstein( const double xmin, const double xmax, const std::vector<std::complex<double>>& c,
    ...
    public: // convert from local to global variables
      // ======================================================================
      double x( const double t ) const { return m_xmin + ( m_xmax - m_xmin ) * t; }
      double t( const double x ) const { return ( x - m_xmin ) / ( m_xmax - m_xmin ); }
      // ======================================================================
    public:
      // ======================================================================
    ...
    public:
       ...
       */
      unsigned short remove_noise( const double epsilon = 0, const double scale = 0 );
      // ======================================================================
    ...
    public:
       ...
       */
      Bernstein multiply( const unsigned short i, const unsigned short j ) const;
      /// power function
     ...
     */
    template <class XITERATOR, class YITERATOR>
    Bernstein::Bernstein( XITERATOR xbegin, XITERATOR xend, YITERATOR ybegin, YITERATOR yend, const double xmin,
                          const double xmax )
      ...
      //
      std::transform( xbegin, xend, _t.begin(), [this]( const double v ) { return this->t( v ); } );
      //
     ...
     *  @param b
     */
    inline std::pair<Bernstein, Bernstein> divmod( const Bernstein& a, const Bernstein& b ) { return a.divmod( b ); }
    // ========================================================================
    ...
    public:
      // ======================================================================
      /// constructor from the order
      BernsteinDualBasis( const unsigned short N = 0, const unsigned short k = 0 );
      /// copy constructor
    ...
    public:
      ...
      double operator()( const double x ) const { return m_k <= N() ? m_bernstein( x ) : 0.0; }
      // ======================================================================
    public:
      // ======================================================================
      ///  get the parameters
...
namespace LHCb {
  ...
  namespace Math {
    ...
    public:
      ...
      inline bool operator()( const Gaudi::Math::Bernstein& b ) const { return m_zero( b.pars() ); }
    ...
    public:
      ...
      inline bool operator()( const Gaudi::Math::Bernstein& b ) const { return m_tiny( b.norm() ); }
      // ======================================================================
    private:
      // ======================================================================
      Tiny<double> m_tiny;
     ...
     */
    inline Gaudi::Math::Bernstein ldexp( const Gaudi::Math::Bernstein& b, const short i ) { return b.ldexp( i ); }
    // ========================================================================
  } // namespace Math
  // ==========================================================================
} // namespace LHCb
...
namespace Gaudi {
  ...
  namespace Math {
     ...
     */
    GAUDI_API
    double integrate( const Gaudi::Math::Bernstein::Basic& b, const double tau );
    // =======================================================================
     ...
     */
    GAUDI_API
    double integrate( const Gaudi::Math::Bernstein& poly, const double tau );
    // ========================================================================
    /** get the integral between 0 and 1 for a product of basic  Bernstein
     ...
     */
    GAUDI_API
    double integrate_poly( const Gaudi::Math::Bernstein::Basic& b, const unsigned short m );
    // =======================================================================
     ...
     */
    GAUDI_API
    double integrate_poly( const Gaudi::Math::Bernstein& b, const unsigned short m );
    // ========================================================================
    /** get the integral between xmin and xmax Bernstein
     *  polynom and monomial or degree m
     ...
     */
    GAUDI_API
    double integrate_poly( const Gaudi::Math::Bernstein& b, const unsigned short m, const double low,
                           const double high );
    // =======================================================================
     ...
     *  @date 2015-02-10
     */
    GAUDI_API double casteljau( const std::vector<double>& pars, const double x );
    // ========================================================================
     ...
     */
    Gaudi::Math::Bernstein deflate_left( const Gaudi::Math::Bernstein& b );
    // ========================================================================
     ...
     *  @return deflated polinomial "d"
     */
    Gaudi::Math::Bernstein deflate_right( const Gaudi::Math::Bernstein& b );
    // ========================================================================
     ...
     *  @return deflated polinomial "d"
     */
    Gaudi::Math::Bernstein deflate( const Gaudi::Math::Bernstein& b, const double x0 );
    // ========================================================================
     ...
     */
    std::vector<double> crossing_points( const Gaudi::Math::Bernstein& b );
    // ========================================================================
     ...
     */
    unsigned short sign_changes( const Gaudi::Math::Bernstein& b );
    // ========================================================================
...
namespace Gaudi {
  ...
  namespace Math {
    ...
    namespace Interpolation {
       ...
       */
      template <class XITERATOR, class YITERATOR>
      inline Gaudi::Math::Bernstein bernstein( XITERATOR xbegin, XITERATOR xend, YITERATOR ybegin, YITERATOR yend,
                                               const double xmin, const double xmax ) {
        return Gaudi::Math::Bernstein( xbegin, xend, ybegin, yend, xmin, xmax );
      }
      // ======================================================================
      /** construct interpolation polynomial (in Bernstein form)
      ...
      inline Gaudi::Math::Bernstein bernstein( FUNCTION func, XITERATOR xbegin, XITERATOR xend, const double xmin,
                                               const double xmax ) {
        const unsigned int  N = std::distance( xbegin, xend );
        std::vector<double> f( N );
        std::transform( xbegin, xend, f.begin(), func );
        return Gaudi::Math::Bernstein( xbegin, xend, f.begin(), f.end(), xmin, xmax );
      }
      // ================================================================================
      ...
      inline Gaudi::Math::Bernstein lobatto( FUNCTION func, const unsigned short N, const double xmin,
                                             const double xmax ) {
        // trivial case:
        if ( 0 == N ) {
          //  trivial grid
          ...
          return Gaudi::Math::Bernstein( &x, &x + 1, &y, &y + 1, xmin, xmax );
        }
        //
        ...
        auto _xi_ = [xhs, xhd, pi_N1]( const unsigned short k ) { return xhs - std::cos( pi_N1 * k ) * xhd; };
        x.front() = x_min;
        x.back()  = x_max;
      ...
      inline Gaudi::Math::Bernstein lobatto( FUNCTION func, const double xmin, const double xmax ) {
        // trivial case:
        if ( 0 == N ) {
          //  trivial grid
          const double x = 0.5 * ( xmin + xmax );
       ...
       */
      GAUDI_API
      Gaudi::Math::Bernstein bernstein( std::function<double( double )> func, const std::vector<double>& x,
                                        const double xmin, const double xmax );
      // ======================================================================
      /** construct interpolation polynomial (in Bernstein form) using Gauss-Lobatto grid,
       *  that minimises Runge's effect.
       ...
       */
      GAUDI_API
      Gaudi::Math::Bernstein bernstein( std::function<double( double )> func, const unsigned short N, const double xmin,
                                        const double xmax );
      // ======================================================================
    } // namespace Interpolation
    // ========================================================================
