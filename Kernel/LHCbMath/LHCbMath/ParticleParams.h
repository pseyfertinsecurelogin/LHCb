...
namespace Gaudi {
  ...
  namespace Math {
    ...
    public:
      ...
      ParticleParams( const Gaudi::XYZPoint& position, const Gaudi::LorentzVector& momentum, const double length,
                      const Gaudi::SymMatrix8x8& cov8 );
      /// constructor from a full parameter set
      ParticleParams( const Gaudi::XYZPoint& position, const Gaudi::LorentzVector& momentum,
                      const Gaudi::SymMatrix7x7& cov7 );
      /// constructor from a full parameter set
      ParticleParams( const Gaudi::Math::Point3DWithError&       position,
                      const Gaudi::Math::LorentzVectorWithError& momentum, const Gaudi::Math::ValueWithError& length,
                      const Gaudi::Matrix4x3& posmom, const Gaudi::Vector3& lenpos, const Gaudi::Vector4& lenmom );
      /// constructor from a full parameter set
      ParticleParams( const Gaudi::XYZPoint& position, const Gaudi::LorentzVector& momentum, const double length,
                      const Gaudi::SymMatrix3x3& poscov, const Gaudi::SymMatrix4x4& momcov, const double lencov,
                      const Gaudi::Matrix4x3& posmom, const Gaudi::Vector3& lenpos, const Gaudi::Vector4& lenmom );
      ///
      /// constructor from a full parameter set
      ParticleParams( const Gaudi::Math::SVectorWithError<8, double>& params );
      /// constructor from a full parameter set
      ParticleParams( const Gaudi::Vector8& params, const Gaudi::SymMatrix8x8& cov8 );
      /// default constructor
      ParticleParams();
      /// virtual destructor
    ...
    public: // basic accessors  / diagonals
      ...
      const Gaudi::Math::Point3DWithError& position() const { return m_position; }
      const Gaudi::SymMatrix3x3&           posCovMatrix() const { return m_position; }
      // access to 4-momentum+covariance
      const Gaudi::Math::LorentzVectorWithError& momentum() const { return m_momentum; }
      const Gaudi::SymMatrix4x4&                 momCovMatrix() const { return m_momentum; }
      // access to decay length
      const Gaudi::Math::ValueWithError& decayLength() const { return m_length; }
      // ======================================================================
    ...
    public:
       ...
       *  @date   2010-05-20
       */
      static double fit( const Gaudi::Math::ParticleParams& input, const double mass,
       ...
       *  @date   2010-05-20
       */
      static Gaudi::Math::ParticleParams fit( const Gaudi::Math::ParticleParams& input, const double mass,
                                              double& chi2 );
      // ======================================================================
      /** apply mass-constrained fit to the particle
       *
       ...
       *  @date   2010-05-20
       */
      static double fit( const double mass, Gaudi::Math::ParticleParams& output );
      // ======================================================================
    };
    // ========================================================================
  } // namespace Math
