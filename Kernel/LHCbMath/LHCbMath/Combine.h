...
namespace Gaudi {
  ...
  namespace Math {
    ...
    public:
      ...
      Combine( const Data& data, const Covariance& cov2 ) : m_data( data ), m_cov2( cov2 ), m_w() {
        m_w = this->getWeights();
      }
      // ======================================================================
      // constructor from the vector of data and cov matrices
      Combine( const Data& data, const Covariance& cov1, const Covariance& cov2 )
          : m_data( data ), m_cov2( cov1 + cov2 ), m_w() {
        m_w = this->getWeights();
      }
      // ======================================================================
      // constructor from the vector of data and cov matrices
      Combine( const Data& data, const Covariance& cov1, const Covariance& cov2, const Covariance& cov3 )
          : m_data( data ), m_cov2( cov1 + cov2 + cov3 ), m_w() {
        m_w = this->getWeights();
      }
      // ======================================================================
      // constructor from the vector of data and cov matrix
      Combine( const Covariance& cov2, const Data& data ) : m_data( data ), m_cov2( cov2 ), m_w() {
        m_w = this->getWeights();
      }
      // ======================================================================
      // constructor from the data
      Combine( const DataWithError& data ) : m_data( data.value() ), m_cov2( data.cov2() ), m_w() {
        m_w = this->getWeights();
      }
      // ======================================================================
    public:
...
namespace Gaudi {
  namespace Math {
     ...
     */
    GAUDI_API
    Gaudi::Math::ValueWithError combine( const double x, const double y, const Gaudi::SymMatrix2x2& cov );
    // ========================================================================
     ...
     */
    GAUDI_API
    Gaudi::Math::ValueWithError combine( const Gaudi::Math::ValueWithError& x1, const Gaudi::Math::ValueWithError& x2,
                                         const double rho );
    // =========================================================================
    /** combine two measurements <code>x1</code> and <code>x2</code>
