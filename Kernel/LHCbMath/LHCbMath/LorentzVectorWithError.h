...
namespace Gaudi {
  ...
  namespace Math {
    ...
    public:
      ...
      LorentzVectorWithError( const Vector4D& value = Vector4D(), const Covariance& cov2 = Covariance() );
      // ======================================================================
      /// constructor from lorentz vector and covariance
      LorentzVectorWithError( const Covariance& cov2, const Vector4D& value = Vector4D() );
      /// constructor from generic vector and covariance
      LorentzVectorWithError( const Vector& value, const Covariance& cov2 = Covariance() );
      /// constructor from generic vector and covariance
      LorentzVectorWithError( const VectorE& value );
      // ======================================================================
    ...
    public: // useful accessors to covarinace matrix
      ...
      double cov2( unsigned int i, unsigned int j ) const { return m_cov2( i, j ); }
      // ======================================================================
    public: // operators
      // ======================================================================
    ...
    public: // useful accessors
      // ======================================================================
      /// get the mass with error
      inline Gaudi::Math::ValueWithError mass() const { return invariantMass(); }
      /// get the mass with error
      inline Gaudi::Math::ValueWithError m() const { return invariantMass(); }
      /// get the scalar momentum with error
      inline Gaudi::Math::ValueWithError p() const { return scalarMomentum(); }
      /// get the transverse momentum with error
      inline Gaudi::Math::ValueWithError pt() const { return transverseMomentum(); }
      /// get the transverse momentum with error
      inline Gaudi::Math::ValueWithError pT() const { return transverseMomentum(); }
      /// get the transverse energy with error
      inline Gaudi::Math::ValueWithError et() const { return transverseEnergy(); }
      /// get the transverse energy  with error
      inline Gaudi::Math::ValueWithError eT() const { return transverseEnergy(); }
      /// get the transverse mass with error
      inline Gaudi::Math::ValueWithError mt() const { return transverseMass(); }
      /// get the transverse mass  with error
      inline Gaudi::Math::ValueWithError mT() const { return transverseMass(); }
      /// get the kinetic energy with error
      inline Gaudi::Math::ValueWithError eK() const { return kineticEnergy(); }
      /// get the transverse kinetic energy with error
      inline Gaudi::Math::ValueWithError eTk() const { return transverseKineticEnergy(); }
      // ======================================================================
    public:
      // ======================================================================
    ...
    public: // helper operators for Python
      ...
      // ======================================================================
      LorentzVectorWithError __radd__( const Vector4D& right ) const { return __add__( right ); }
    ...
    // ========================================================================
    inline LorentzVectorWithError operator+( const LorentzVectorWithError& a, const LorentzVectorWithError& b ) {
      return a.__add__( b );
    }
    inline LorentzVectorWithError operator-( const LorentzVectorWithError& a, const LorentzVectorWithError& b ) {
      return a.__sub__( b );
    }
    inline LorentzVectorWithError operator+( const LorentzVectorWithError& a, const Gaudi::LorentzVector& b ) {
      return a.__add__( b );
    }
    inline LorentzVectorWithError operator-( const LorentzVectorWithError& a, const Gaudi::LorentzVector& b ) {
      return a.__sub__( b );
    }
    inline LorentzVectorWithError operator+( const Gaudi::LorentzVector& b, const LorentzVectorWithError& a ) {
      return a + b;
    }
    inline LorentzVectorWithError operator-( const Gaudi::LorentzVector& b, const LorentzVectorWithError& a ) {
      return a.__rsub__( b );
    ...
    // ========================================================================
    inline LorentzVectorWithError operator*( const LorentzVectorWithError& a, const double b ) {
      return a.__mul__( b );
    }
    inline LorentzVectorWithError operator/( const LorentzVectorWithError& a, const double b ) {
      return a.__div__( b );
    }
    inline LorentzVectorWithError operator*( const double b, const LorentzVectorWithError& a ) {
      return a.__mul__( b );
    }
    // ========================================================================
    inline double chi2( const LorentzVectorWithError& a, const LorentzVectorWithError& b ) { return a.chi2( b ); }
    inline double chi2( const LorentzVectorWithError& a, const Gaudi::LorentzVector& b ) { return a.chi2( b ); }
    inline double chi2( const Gaudi::LorentzVector& b, const LorentzVectorWithError& a ) { return a.chi2( b ); }
    inline double chi2( const LorentzVectorWithError& a, const LorentzVectorWithError::VectorE& b ) {
      return a.chi2( b );
    }
    inline double chi2( const LorentzVectorWithError::VectorE& b, const LorentzVectorWithError& a ) {
      return a.chi2( b );
    }
    inline double chi2( const LorentzVectorWithError& a, const LorentzVectorWithError::Vector& b ) {
      return a.chi2( b );
    }
    inline double chi2( const LorentzVectorWithError::Vector& b, const LorentzVectorWithError& a ) {
      return a.chi2( b );
    }
    // ========================================================================
    namespace Kinematics {
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError mass( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // =====================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError momentum( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // =====================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError rapidity( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError pseudorapidity( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError phi( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError theta( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseMomentum( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseMass2( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseMass( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseEnergy2( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseEnergy( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError kineticEnergy( const Gaudi::LorentzVector& mom, const Gaudi::SymMatrix4x4& cov );
      // ======================================================================
       ...
       */
      GAUDI_API
      Gaudi::Math::ValueWithError transverseKineticEnergy( const Gaudi::LorentzVector& mom,
    ...
    // get the mass with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::invariantMass() const {
      return Gaudi::Math::Kinematics::mass( *this, cov2() );
    }
    // ========================================================================
    // get the scalar momentum with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::scalarMomentum() const {
      return Gaudi::Math::Kinematics::momentum( *this, cov2() );
    }
    // ========================================================================
    // get the transverse momentum with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::transverseMomentum() const {
      return Gaudi::Math::Kinematics::transverseMomentum( *this, cov2() );
    }
    // ========================================================================
    // get the transverse mass with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::transverseMass() const {
      return Gaudi::Math::Kinematics::transverseMass( *this, cov2() );
    }
    // ========================================================================
    // get the transverse energy with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::transverseEnergy() const {
      return Gaudi::Math::Kinematics::transverseEnergy( *this, cov2() );
    }
    // ========================================================================
    // get the kinetic energy with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::kineticEnergy() const {
      return Gaudi::Math::Kinematics::kineticEnergy( *this, cov2() );
    }
    // ========================================================================
    // get the transverse kinetic energy with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::transverseKineticEnergy() const {
      return Gaudi::Math::Kinematics::transverseKineticEnergy( *this, cov2() );
    }
    // ========================================================================
    // get the rapidity with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::rapidity() const {
      return Gaudi::Math::Kinematics::rapidity( *this, cov2() );
    }
    // ========================================================================
    // get the pseudorapidity with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::pseudorapidity() const {
      return Gaudi::Math::Kinematics::pseudorapidity( *this, cov2() );
    }
    // ========================================================================
    // get the phi-angle with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::phi() const {
      return Gaudi::Math::Kinematics::phi( *this, cov2() );
    }
    // ========================================================================
    // get the theta-angle with error
    // ========================================================================
    inline Gaudi::Math::ValueWithError Gaudi::Math::LorentzVectorWithError::theta() const {
      return Gaudi::Math::Kinematics::theta( *this, cov2() );
    }
    // ========================================================================
    inline Gaudi::Math::LorentzVectorWithError mean( const Gaudi::Math::LorentzVectorWithError& v1,
                                                     const Gaudi::Math::LorentzVectorWithError& v2 ) {
      return v1.mean( v2 );
    }
    // ========================================================================
  } // namespace Math
