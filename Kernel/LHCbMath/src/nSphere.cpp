...
namespace {
  ...
  // ==========================================================================
  inline std::pair<double, double> _sincos_( const double phase ) {
    if ( 0 == phase || s_zero( phase ) ) { return {0, 1}; }
    //
    ...
    if ( 0 == sinv || 1 == acosv ) { return {0, 0 < cosv ? 1 : -1}; }
    //
    const double asinv = std::abs( sinv );
    if ( 0 == cosv || 1 == asinv ) { return {0 < sinv ? 1 : -1, 0}; }
    //
    if ( s_zero( sinv ) || s_equal( acosv, 1 ) ) { return {0, 0 < cosv ? 1 : -1}; }
    //
    if ( s_zero( cosv ) || s_equal( asinv, 1 ) ) { return {0 < sinv ? 1 : -1, 0}; }
    //
    return {sinv, cosv};
  }
  // ==========================================================================
 ...
 */
// ============================================================================
Gaudi::Math::NSphere::NSphere( const unsigned short N ) : Gaudi::Math::NSphere::NSphere( N, N + 1 ) {}
// ============================================================================
 ...
 */
// ============================================================================
Gaudi::Math::NSphere::NSphere( const unsigned short N, const unsigned short rotated )
    : Gaudi::Math::NSphere::NSphere( std::vector<double>( N, 0 ), rotated < N + 1 ? rotated : N + 1 ) {}
// ============================================================================
/*  Standard constructor
 *  @param nPhases  dimensionality of N-sphere
 *  @param bias     use the rotated sphere?
 */
Gaudi::Math::NSphere::NSphere( const std::vector<double>& phases )
    : Gaudi::Math::NSphere::NSphere( phases, phases.size() + 1 ) {}
// ============================================================================
Gaudi::Math::NSphere::NSphere( const std::vector<double>& phases, const unsigned short rotated )
...
// copy
// ============================================================================
Gaudi::Math::NSphere::NSphere( const Gaudi::Math::NSphere& right )
...
// move
// ============================================================================
Gaudi::Math::NSphere::NSphere( Gaudi::Math::NSphere&& right )
    : m_rotated( right.m_rotated )
...
// ============================================================================
bool Gaudi::Math::NSphere::setPhase( const unsigned short index, const double value ) {
  //
...
// copy assignement
// ============================================================================
Gaudi::Math::NSphere& Gaudi::Math::NSphere::operator=( const Gaudi::Math::NSphere& right ) {
...
// move assignement
// ============================================================================
Gaudi::Math::NSphere& Gaudi::Math::NSphere::operator=( Gaudi::Math::NSphere&& right ) {
  if ( &right == this ) { return *this; }
  //
  m_rotated = right.m_rotated;
  m_delta   = std::move( right.m_delta );
