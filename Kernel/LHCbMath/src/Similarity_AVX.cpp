    ...
    namespace detail {
      namespace avx {
        ...
        void similarity_5_5( span<const double, 15> Ci, span<const double, 25> Fi, span<double, 15> Ti ) {
          ...
          const auto r2 =
              Vec4d{dots2_5_avx( Fi.subspan<10, 10>(), _20, _24 ), dots2_5_avx( Fi.subspan<15, 10>(), _30, _34 )};
          const auto r3 = Vec4d{dot5_avx( Fi.subspan<20, 5>(), _20, _24 ), 0.,
                                dot5_avx( Fi.subspan<20, 5>(), _40, _44 ), dot5_avx( Fi.subspan<20, 5>(), _00, _04 )};
        ...
        void similarity_5_7( span<const double, 15> Ci, span<const double, 35> Fi, span<double, 28> Ti ) {
          ...
          const auto r4 =
              Vec4d{dots2_5_avx( Fi.subspan<20, 10>(), _40, _44 ), dots2_5_avx( Fi.subspan<20, 10>(), _00, _04 )};
          const auto r5 =
              Vec4d{dots2_5_avx( Fi.subspan<25, 10>(), _50, _54 ), dots2_5_avx( Fi.subspan<25, 10>(), _10, _14 )};
        ...
        double filter( span<double, 5> X, span<double, 15> C, span<const double, 5> Xref, span<const double, 5> H,
          ...
          const auto _1 = blend4d<4, 1, 2, 3>( c.c1, permute4d<1, 0, 2, 2>( c.c4 ) ) -
                          Vec4d{cht4, cht0[1], cht0[2], cht0[3]} * chtw0[1];
          const auto _2 =
              blend4d<2, 3, 6, 4>( c.c2, c.c4 ) - Vec4d{cht0[2], cht0[3], cht4, cht4} * permute4d<2, 2, 2, 0>( chtw0 );
          const auto _3 = Vec4d{c.c3[3], c.c4[3], c.c44, 0.} -
                          Vec4d{cht0[3], cht4, cht4, 0.} * Vec4d{chtw0[3], chtw0[3], chtw4, 0.};
