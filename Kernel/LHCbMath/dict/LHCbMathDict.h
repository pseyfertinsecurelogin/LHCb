...
namespace Gaudi {
  ...
  namespace Math {
    ...
    struct GF {
      static bool intersection( const aLine& line, const aPlane& plane, aPoint& intersect, double& mu ) {
        return Gaudi::Math::intersection<aLine, aPlane, aPoint>( line, plane, intersect, mu );
      }

      static bool intersection( const aPlane& plane0, const aPlane& plane1, aLine& intersect ) {
        return Gaudi::Math::intersection<aLine, aPlane>( plane0, plane1, intersect );
      }

      static bool intersection( const aPlane& plane0, const aPlane& plane1, const aPlane& plane2, aPoint& intersect ) {
        return Gaudi::Math::intersection<aPoint, aPlane>( plane0, plane1, plane2, intersect );
      }

      static double impactParameter( const aPoint& point, const aLine& line ) {
        return Gaudi::Math::impactParameter<aPoint, aLine>( point, line );
      }

      static double distance( const aLine& line0, const aLine& line1 ) {
        return Gaudi::Math::distance<aLine, aLine>( line0, line1 );
      }

      static bool closestPoints( const aLine& line0, const aLine& line1, aPoint& p0, aPoint& p1 ) {
        return Gaudi::Math::closestPoints<aLine, aLine, aPoint>( line0, line1, p0, p1 );
      }

      static double closestPointParam( const aPoint& point, const aLine& line ) {
        return Gaudi::Math::closestPointParam<aLine, aPoint>( point, line );
      }

      static aPoint closestPoint( const aPoint& point, const aLine& line ) {
        return Gaudi::Math::closestPoint<aLine, aPoint>( point, line );
      }

      static bool closestPointParams( const aLine& line0, const aLine& line1, double& mu0, double& mu1 ) {
        return Gaudi::Math::closestPointParams<aLine, aLine>( line0, line1, mu0, mu1 );
      }

      static bool parallel( const aLine& line0, const aLine& line1 ) {
    ...
    public:
      ...
      static ValueWithError mean( const ValueWithError& a, const ValueWithError& b ) { return a.mean( b ); }
      // =====================================================================-
      /// evaluate chi2
      static double chi2( const ValueWithError& a, const ValueWithError& b ) { return a.chi2( b ); }
      /// evaluate chi2
      static double chi2( const ValueWithError& a, const double b ) { return a.chi2( b ); }
      /// evaluate chi2
      static double chi2( const double b, const ValueWithError& a ) { return a.chi2( b ); }
      // ======================================================================
      /// evaluate the "fraction"  a/(a+b)
      static ValueWithError frac( const ValueWithError& a, const ValueWithError& b ) { return a.frac( b ); }
      /// evaluate the "fraction"  a/(a+b)
      static ValueWithError frac( const ValueWithError& a, const double b ) { return a.frac( b ); }
      /// evaluate the "fraction"  a/(a+b)
      static ValueWithError frac( const double a, const ValueWithError& b ) { return frac( ValueWithError( a ), b ); }
      /// evaluate the "fraction"  a/(a+b)
      static ValueWithError frac( const double a, const double b ) { return frac( ValueWithError( a ), b ); }
      // ======================================================================
      /// evaluate the "asymmetry"  (a-b)/(a+b)
      static ValueWithError asym( const ValueWithError& a, const ValueWithError& b ) { return a.asym( b ); }
      /// evaluate the "asymmetry"  (a-b)/(a+b)
      static ValueWithError asym( const ValueWithError& a, const double b ) { return a.asym( b ); }
      /// evaluate the "asymmetry"  (a-b)/(a+b)
      static ValueWithError asym( const double a, const ValueWithError& b ) { return asym( ValueWithError( a ), b ); }
      /// evaluate the "asymmetry"  (a-b)/(a+b)
      static ValueWithError asym( const double a, const double b ) { return asym( ValueWithError( a ), b ); }
      // ======================================================================
       ...
       */
      static ValueWithError binomEff( const size_t n, const size_t N ) { return Gaudi::Math::binomEff( n, N ); }
      // ======================================================================
    };
    // ========================================================================
    class EigenSystems {
    ...
    public: // eigen values
      // ======================================================================
      // 2x2
      static Gaudi::Vector2 eigenValues( const Gaudi::SymMatrix2x2& mtrx, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenValues( mtrx, sorted );
      }
      // 3x3
      static Gaudi::Vector3 eigenValues( const Gaudi::SymMatrix3x3& mtrx, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenValues( mtrx, sorted );
      }
      // 4x4
      static Gaudi::Vector4 eigenValues( const Gaudi::SymMatrix4x4& mtrx, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenValues( mtrx, sorted );
      }
      // ======================================================================
    public: // eigen vectors
      // ======================================================================
      // 2x2
      static StatusCode eigenVectors( const Gaudi::SymMatrix2x2& mtrx, Gaudi::Vector2& vals,
                                      std::vector<Gaudi::Vector2>& vecs, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenVectors( mtrx, vals, vecs, sorted );
      }
      // 3x3
      static StatusCode eigenVectors( const Gaudi::SymMatrix3x3& mtrx, Gaudi::Vector3& vals,
                                      std::vector<Gaudi::Vector3>& vecs, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenVectors( mtrx, vals, vecs, sorted );
      }
      // 4x4
      static StatusCode eigenVectors( const Gaudi::SymMatrix4x4& mtrx, Gaudi::Vector4& vals,
                                      std::vector<Gaudi::Vector4>& vecs, const bool sorted = true ) {
        Gaudi::Math::GSL::EigenSystem system;
        return system.eigenVectors( mtrx, vals, vecs, sorted );
      }
      // ======================================================================
