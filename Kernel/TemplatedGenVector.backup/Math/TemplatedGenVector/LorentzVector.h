...
// #endif
       ...
       */
       ::LHCbROOT::Math::DisplacementVector3D<Cartesian3D<Scalar> > Vect() const {
          return ::LHCbROOT::Math::DisplacementVector3D<Cartesian3D<Scalar> >( X(), Y(), Z() );
       }
...
//#include "Math/TemplatedGenVector/LorentzVectorOperations.h"
