...
// ============================================================================
bool LHCb::ParticleID::isNucleus() const { return 100 <= extraBits() && Z() <= A(); }
// ============================================================================
// Return if the PID is for a bare quark.
// ============================================================================
bool LHCb::ParticleID::isQuark() const {
  const unsigned int apid = abspid();
  return LHCb::ParticleID::Quark::first <= apid && apid <= LHCb::ParticleID::Quark::last;
}
// ============================================================================
// Return if the PID is a particle with quarks, but not a nucleus.
// ============================================================================
bool LHCb::ParticleID::hasQuarks() const { return !extraBits() && !fundamentalID(); }
// ============================================================================
...
// ============================================================================
std::ostream& LHCb::ParticleID::fillStream( std::ostream& s ) const { return s << "LHCb.ParticleID(" << m_pid << ")"; }
// ============================================================================
...
std::ostream& LHCb::ParticleID::printLocation( const long l, std::ostream& s ) {
  switch ( l ) {
  case LHCb::ParticleID::nj:
    return s << "LHCb.ParticleID.nj";
  case LHCb::ParticleID::nq3:
    return s << "LHCb.ParticleID.nq3";
  case LHCb::ParticleID::nq2:
    return s << "LHCb.ParticleID.nq2";
  case LHCb::ParticleID::nq1:
    return s << "LHCb.ParticleID.nq1";
  case LHCb::ParticleID::nl:
    return s << "LHCb.ParticleID.nl";
  case LHCb::ParticleID::nr:
    return s << "LHCb.ParticleID.nr";
  case LHCb::ParticleID::n:
    return s << "LHCb.ParticleID.n";
  case LHCb::ParticleID::n8:
    return s << "LHCb.ParticleID.n8";
  case LHCb::ParticleID::n9:
    return s << "LHCb.ParticleID.n9";
  case LHCb::ParticleID::n10:
    return s << "LHCb.ParticleID.n10";
  default:;
  }
