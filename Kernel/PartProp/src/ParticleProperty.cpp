 ...
 */
// ============================================================================
LHCb::ParticleProperty::ParticleProperty( const std::string& name, const LHCb::ParticleID& pid, const double charge,
 ...
 */
// ============================================================================
void LHCb::ParticleProperty::setAntiParticle( const ParticleProperty* p ) { m_anti = p; }
// ============================================================================
 ...
 */
// ============================================================================
std::ostream& LHCb::ParticleProperties::printAsTable_( const std::vector<const LHCb::ParticleProperty*>& particles,
                                                       std::ostream&                                     stream,
 ...
 */
// ========================================================================
std::string LHCb::ParticleProperties::printAsTable( const std::vector<const LHCb::ParticleProperty*>& particles,
                                                    const LHCb::IParticlePropertySvc*                 service ) {
  std::ostringstream s;
 ...
 */
// ========================================================================
MsgStream& LHCb::ParticleProperties::printAsTable( const std::vector<const LHCb::ParticleProperty*>& particles,
                                                   MsgStream& stream, const LHCb::IParticlePropertySvc* service ) {
 ...
 */
// ============================================================================
std::ostream& Gaudi::Utils::toStream( const std::vector<const LHCb::ParticleProperty*>& particles,
                                      std::ostream&                                     stream ) {
 ...
 */
// ============================================================================
std::ostream& LHCb::ParticleProperties::printAsTable_( const std::vector<LHCb::ParticleID>& particles,
                                                       std::ostream&                        stream,
                                                       const LHCb::IParticlePropertySvc*    service ) {
  //
  ...
  for ( std::vector<LHCb::ParticleID>::const_iterator ipid = particles.begin(); particles.end() != ipid; ++ipid ) {
 ...
 */
// ============================================================================
MsgStream& LHCb::ParticleProperties::printAsTable( const std::vector<LHCb::ParticleID>& particles, MsgStream& stream,
                                                   const LHCb::IParticlePropertySvc* service ) {
  if ( stream.isActive() ) { printAsTable_( particles, stream.stream(), service ); }
  return stream;
}
 ...
 */
// ============================================================================
std::string LHCb::ParticleProperties::printAsTable( const std::vector<LHCb::ParticleID>& particles,
                                                    const LHCb::IParticlePropertySvc*    service ) {
  std::ostringstream s;
  printAsTable_( particles, s, service );
  return s.str();
...
// ============================================================================
const LHCb::ParticleProperty* std::abs( const LHCb::ParticleProperty* p ) {
  if ( 0 == p ) { return 0; }
  //
