...
namespace LHCb 
{
  ...
  public:
    ...
    enum Quark 
    { 
      down=1 , up, strange, charm, bottom, top, 
      bottom_prime      ,
      top_prime         , 
      first = down      , 
      last  = top_prime
  ...
  inline std::ostream& operator<< ( std::ostream &s , const LHCb::ParticleID&    o ) 
...
namespace GaudiUtils  
{
  ...
  // ==========================================================================
} //                                            The end of namespace GaudiUtils 
// ============================================================================
namespace std 
{
  // ==========================================================================
