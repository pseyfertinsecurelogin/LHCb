...
namespace Decays {
  ...
  public:
     ...
     */
    Decay( const LHCb::ParticleProperty* mother, const std::vector<const LHCb::ParticleProperty*>& daughters );
    /** the constructor from mother and daughters
     *  @param mother the mother
     *  @param daughters the daughters
     */
     ...
     *  @param daughters the daughters
     */
    Decay( const LHCb::ParticleID&              mother,      //    the mother
  ...
  public:
    ...
    /// set the daughters
    void setDaughters( const std::vector<const LHCb::ParticleProperty*>& daugs );
    /// set the daughters
    ...
    /// set the daughters
    void setChildren( const std::vector<const LHCb::ParticleProperty*>& daugs ) { setDaughters( daugs ); }
    /// set the daughters
    void setChildren( const std::vector<std::string>& daugs ) { setDaughters( daugs ); }
    /// set the daughters
    void setChidlren( const std::vector<LHCb::ParticleID>& daugs ) { setDaughters( daugs ); }
    // ========================================================================
  public:
    // ========================================================================
    /// add the child
