...
namespace Decays {
  ...
  namespace Dict {
    ...
    public:
      // ======================================================================
      // __call__
      static bool __call__( const iNode& node, const LHCb::ParticleID& pid ) { return node( pid ); }
      // __call__
      static bool __call__( const iNode& node, const LHCb::ParticleProperty* pp ) { return node( pp->particleID() ); }
      // __call__
      static bool __call__( const iNode& node, const int pid ) { return node( LHCb::ParticleID( pid ) ); }
      // =====================================================================
    public:
      // =====================================================================
      // __rrshift__
      static bool __rrshift__( const iNode& node, const LHCb::ParticleID& pid ) { return node( pid ); }
      // __rrshift__
      static bool __rrshift__( const iNode& node, const LHCb::ParticleProperty* pp ) {
        return node( pp->particleID() );
      }
      // __rrshift__
      static bool __rrshift__( const iNode& node, const int pid ) { return node( LHCb::ParticleID( pid ) ); }
      // =====================================================================
    public:
      // =====================================================================
      // __or__
      ...
      // __or__
      static Node __or__( const iNode& n1, const LHCb::ParticleID& n2 ) { return n1 || n2; }
      // __or__
      static Node __or__( const iNode& n1, const LHCb::ParticleProperty* n2 ) { return n1 || n2; }
      // __or__
    ...
    public:
      ...
      // __ror__
      static Node __ror__( const iNode& n1, const LHCb::ParticleID& n2 ) { return n1 || n2; }
      // __ror__
      static Node __ror__( const iNode& n1, const LHCb::ParticleProperty* n2 ) { return n1 || n2; }
      // __ror__
    ...
    public:
      ...
      // __and__
      static Node __and__( const iNode& n1, const LHCb::ParticleID& n2 ) { return n1 && n2; }
      // __and__
      static Node __and__( const iNode& n1, const LHCb::ParticleProperty* n2 ) { return n1 && n2; }
      // __and__
    ...
    public:
      ...
      // __rand__
      static Node __rand__( const iNode& n1, const LHCb::ParticleID& n2 ) { return n1 && n2; }
      // __rand__
      static Node __rand__( const iNode& n1, const LHCb::ParticleProperty* n2 ) { return n1 && n2; }
      // __rand__
