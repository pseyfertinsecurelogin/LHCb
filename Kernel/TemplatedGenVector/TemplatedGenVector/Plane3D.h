   ...
   public:
      ...
      */
      ...
      /**
       ...
       \param n normal expressed as a LHCbROOT::Math::DisplacementVector3D<Cartesian3D<T> >
       \param p point  expressed as a  LHCbROOT::Math::PositionVector3D<Cartesian3D<T> >
      */
      ...
      */
      ...
      /**
       ...
       \param p1 point1 expressed as  LHCbROOT::Math::DisplacementVector3D<Cartesian3D<T> >
       \param p2 point2 expressed as  LHCbROOT::Math::DisplacementVector3D<Cartesian3D<T> >
       \param p3 point3 expressed as  LHCbROOT::Math::DisplacementVector3D<Cartesian3D<T> >
      */
