...
struct ILinePersistenceSvc : extend_interfaces<INamedInterface> {
  ...
  virtual Locations locationsToPersist( const LHCb::HltDecReports& hdr, const LineDecNames& lines ) const        = 0;
  virtual Locations turboPPLocationsToPersist( const LHCb::HltDecReports& hdr, const LineDecNames& lines ) const = 0;
  virtual RawBanks  rawBanksToPersist( const LHCb::HltDecReports& hdr, const LineDecNames& lines ) const         = 0;
};
