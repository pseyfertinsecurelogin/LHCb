...
protected:
  ...
  Gaudi::Property<std::vector<std::string>> m_acceptNames{
      this, "AcceptAlgs", {}, [=]( auto& ) {
        if ( auto sc = decodeAlgorithms( m_acceptNames, &m_acceptAlgs ); sc.isFailure() ) {
          throw GaudiException( "Failure in LHCbOutputStream::decodeAlgorithms", "LHCbOutputStream::acceptAlgsHandler",
                                sc );
        };
      }};
  ...
  Gaudi::Property<std::vector<std::string>> m_requireNames{
      this, "RequireAlgs", {}, [=]( auto& ) {
        if ( auto sc = decodeAlgorithms( m_requireNames, &m_requireAlgs ); sc.isFailure() ) {
          throw GaudiException( "Failure in LHCbOutputStream::decodeAlgorithms", "LHCbOutputStream::requireAlgsHandler",
                                sc );
        };
      }};
  ...
  Gaudi::Property<std::vector<std::string>> m_vetoNames{
      this, "VetoAlgs", {}, [=]( auto& ) {
        if ( auto sc = decodeAlgorithms( m_vetoNames, &m_vetoAlgs ); sc.isFailure() ) {
          throw GaudiException( "Failure in LHCbOutputStream::decodeAlgorithms", "LHCbOutputStream::vetoAlgsHandler",
                                sc );
        };
      }};
