...
struct IL0Calo2Calo : extend_interfaces<IAlgTool> {
   ...
   */
  virtual StatusCode clusterize( std::vector<LHCb::CaloCluster*>& clusters, const LHCb::L0CaloCandidate* candidate,
   ...
   * @param candidate(INPUT)  pointer to L0CaloCandidate
   */
  virtual StatusCode clusterize( std::vector<LHCb::CaloCluster*>& clusters,
   ...
   * @param level     (INPUT)  number of neigbour levels around the cell for the ICaloClusterization tool
   */
  virtual StatusCode clusterize( std::vector<LHCb::CaloCluster*>& clusters, const LHCb::L0CaloCandidates* candidate,
                                 const unsigned int level ) const = 0;
  // ==========================================================================
   ...
   * @param level    (INPUT)  number of neigbour levels around the cell for the ICaloClusterization tool
   */
  virtual StatusCode clusterize( std::vector<LHCb::CaloCluster*>& clusters, const LHCb::CaloCellID& cellID,
                                 const unsigned int level ) const = 0;
  // ==========================================================================
  /** obtain CaloClusters around a CaloCellID
   *
   ...
   * @param cellID   (INPUT)  pointer to CaloCellID
   */
  virtual StatusCode clusterize( std::vector<LHCb::CaloCluster*>& clusters, const LHCb::CaloCellID& cellID ) const = 0;
  // ==========================================================================
