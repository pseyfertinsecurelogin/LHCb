...
struct GAUDI_API ICaloDigits4Track : extend_interfaces<IAlgTool> {
   ...
   *  @return status code
   */
  virtual StatusCode collect( const Line& line, LHCb::CaloCellID::Vector& cells ) const = 0;
  // ==========================================================================
  /** collect the cellID-s along the line
   *  @param line   (INPUT)  the line
   *  @param cells  (OUTPUT) the container of cells
   *  @return status code
   */
  virtual StatusCode collect( const Line& line, LHCb::CaloCellID::Set& cells ) const = 0;
  // ==========================================================================
   ...
   *  @return status code
   */
  virtual StatusCode collect( const LHCb::Track* track, LHCb::CaloCellID::Vector& cells ) const = 0;
  // ==========================================================================
  /** collect the cellID-s along the path of the tracks
   *  @param track  (INPUT)  the track
   *  @param cells  (OUTPUT) the container of cells
   *  @return status code
   */
  virtual StatusCode collect( const LHCb::Track* track, LHCb::CaloCellID::Set& cells ) const = 0;
  // ==========================================================================
   ...
   *  @return status code
   */
  virtual StatusCode collect( const Line& line, LHCb::CaloDigit::Vector& digits ) const = 0;
  // ==========================================================================
   ...
   *  @return status code
   */
  virtual StatusCode collect( const Line& line, LHCb::CaloDigit::Set& digits ) const = 0;
  // ==========================================================================
  /** collect the fired digits along the path of the tracks
   *  @param track  (INPUT)  the track
   *  @param digits (OUTPUT) the container of digits
   *  @return status code
   */
  virtual StatusCode collect( const LHCb::Track* track, LHCb::CaloDigit::Vector& digits ) const = 0;
  // ==========================================================================
  /** collect the fired digits along the path of the tracks
   *  @param track  (INPUT)  the track
   *  @param digits (OUTPUT) the container of digits
   *  @return status code
   */
  virtual StatusCode collect( const LHCb::Track* track, LHCb::CaloDigit::Set& digits ) const = 0;
  // ==========================================================================
