...
class CaloDigitConf(LHCbConfigurableUser):
    ...
    __slots__ = {
        ...
        ,
        'Sequence':
        None  # The sequencer to add the CALO reconstruction algorithms to
        ,
    ...
    _propertyDocDct = {
        ...
        """ Create ADCs ? """,
        'Sequence':
        """ The sequencer to add the CALO Digit algorithms to """,
        'EnableDigitsOnDemand':
    ...
    def applyConf(self):
        ...
        if self.getProp('EnableDigitsOnDemand'):
            _log.info(' creation-on-demand of CaloDigits is enabled for %s',
