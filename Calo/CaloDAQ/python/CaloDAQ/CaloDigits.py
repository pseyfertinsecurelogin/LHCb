...
def caloDigits(context,
    ...
    from Configurables import (CaloZSupAlg, CaloDigitsFromRaw,
    ...
    if 'Spd' in detectors:
        ...
        spd = getAlgo(CaloDigitsFromRaw, "SpdFromRaw", _cntx, "Raw/Spd/Digits",
                      enableOnDemand)
        conflist.append(spd)
        alglist.append(spd)
    ...
    if 'Prs' in detectors:
        ...
        prs = getAlgo(CaloDigitsFromRaw, "PrsFromRaw", _cntx, "Raw/Prs/Digits",
                      enableOnDemand)
        conflist.append(prs)
        if ReadoutStatusConvert:
            prsCnv = getAlgo(RawBankReadoutStatusConverter, "PrsProcStatus",
                             _cntx)
            prsCnv.System = 'Prs'
    ...
    if 'Ecal' in detectors:
        ...
        ecal = getAlgo(CaloZSupAlg, "EcalZSup", _cntx, "Raw/Ecal/Digits",
                       enableOnDemand)
    ...
    if 'Hcal' in detectors:
        ...
        hcal = getAlgo(CaloZSupAlg, "HcalZSup", _cntx, "Raw/Hcal/Digits",
                       enableOnDemand)
