...
public:
  ...
  CaloTriggerBitsFromRaw( const std::string& type, const std::string& name, const IInterface* parent );
  ...
  const LHCb::Calo::PrsSpdFiredCells& prsSpdCells( const LHCb::RawBank& bank ) override; // get FiredCells for a single
                                                                                         // bank
  void clear() override;
