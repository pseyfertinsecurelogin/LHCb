...
namespace CaloMCTools {
   ...
   */
  template <>
  inline StatusCode MCCaloHistory<LHCb::MCCaloHit>::operator()( const LHCb::MCCaloHit* hit ) const {
   ...
   */
  template <>
  inline StatusCode MCCaloHistory<LHCb::MCCaloDigit>::operator()( const LHCb::MCCaloDigit* digit ) const {
    if ( !mcmap() ) { return StatusCode( 901 ); } // RETURN
   ...
   */
  template <>
  inline StatusCode MCCaloHistory<LHCb::CaloDigit>::operator()( const LHCb::CaloDigit* digit ) const {
    if ( !mcmap() ) { return StatusCode( 901 ); } // RETURN
   ...
   */
  template <>
  inline StatusCode MCCaloHistory<LHCb::CaloCluster>::operator()( const LHCb::CaloCluster* cluster ) const {
    if ( !mcmap() ) { return StatusCode( 901 ); } // RETURN
   ...
   *  @date   2003-04-01
   */
  inline StatusCode updateCaloMCMap( const LHCb::MCParticle* mcp, const double energy, CaloMCMap& mcmap ) {
