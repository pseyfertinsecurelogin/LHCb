...
// ============================================================================
LHCb::CaloParticle::CaloParticle( LHCb::Particle* part ) : m_isCalo( bool( part ) ) { addCaloPosition( part ); }
// ============================================================================
// constructor from particle & origin point
// ============================================================================
LHCb::CaloParticle::CaloParticle( LHCb::Particle* part, const LHCb::CaloMomentum::Point& point )
    : m_isCalo( bool( part ) ) {
  ...
  for ( LHCb::Particle* part : m_parts ) {
    if ( !part->isBasicParticle() && LHCb::CaloMomentum::OK == status() ) {
      for ( const auto& daughter : part->daughters() ) {
        LHCb::CaloParticle caloDau( const_cast<LHCb::Particle*>( daughter.target() ), referencePoint(),
                                    pointCovMatrix() );
        caloDau.updateTree();
      }
...
// get the particle
// ============================================================================
LHCb::Particle* LHCb::CaloParticle::particle() const { return !m_parts.empty() ? m_parts.front() : nullptr; }
