...
namespace {
   ...
   *  @date 2010-08--29
   */
  Gaudi::LorentzVector _jacobians_( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
    ...
    // 4-momentum:
    return Gaudi::LorentzVector( e * gamma * sx, e * gamma * sy, e * gamma * sz, e );
  }
  // ==========================================================================
 ...
 */
// ============================================================================
Gaudi::LorentzVector Calo::Kinematics::momentum( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin ) {
 ...
 */
// ============================================================================
void Calo::Kinematics::momentum( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
...
void Calo::Kinematics::momentum( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
  ...
  momentum( calo, origin, output, output );
}
// ============================================================================
 ...
 */
// ============================================================================
void Calo::Kinematics::add2momentum( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
                                     Gaudi::LorentzVector& output, Gaudi::SymMatrix4x4& matrix ) {
  //
  // covariance matrix for (xc,yx,E):
  //
...
void Calo::Kinematics::add2momentum( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
                                     Gaudi::Math::LorentzVectorWithError& output ) {
  add2momentum( calo, origin, output, output );
}
// ============================================================================
 ...
 */
// ============================================================================
Gaudi::LorentzVector Calo::Kinematics::jacobian1( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
                                                  Gaudi::Matrix4x3& F11 ) {
 ...
 */
// ============================================================================
Gaudi::LorentzVector Calo::Kinematics::jacobian2( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
                                                  Gaudi::Matrix4x3& F12 ) {
 ...
 */
// ============================================================================
Gaudi::LorentzVector Calo::Kinematics::jacobians( const LHCb::CaloPosition& calo, const Gaudi::XYZPoint& origin,
                                                  Gaudi::Matrix4x3& F11, Gaudi::Matrix4x3& F12 ) {
