...
void Calo2Dview::fillCalo2D(const HistoID& unit, const LHCb::CaloCellID& id, double value, const std::string title) const {
  // threshold
...
void Calo2Dview::fillCaloPin2D(const HistoID& unit, const LHCb::CaloCellID& id, double value, const std::string title) const{
  // Validation
