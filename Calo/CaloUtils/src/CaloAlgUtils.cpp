...
namespace {
  std::string pathFromContext( const std::initializer_list<std::pair<boost::string_ref, boost::string_ref>>& table,
    ...
    return i != std::end( table ) ? LHCb::CaloAlgUtils::PathFromContext( context, i->second ) : std::string{};
  }
} // namespace
...
std::string LHCb::CaloAlgUtils::CaloSplitClusterLocation( const std::string& context ) {
  return PathFromContext( context, LHCb::CaloClusterLocation::EcalSplit );
}

std::string LHCb::CaloAlgUtils::CaloClusterLocation( const std::string& name, const std::string& context ) {
  //##  splitClusters
  if ( contains_ci( name, "SPLITCLUSTER" ) ) return CaloSplitClusterLocation( context );
  ...
  return PathFromContext( contains_ci( context, "HLT" ) ? "Hlt" : "",
                          det == "Hcal" ? Hcal : Ecal // default is Ecal
  );
}

// Hypo location from type/context
std::string LHCb::CaloAlgUtils::CaloHypoLocation( const std::string& type, const std::string& context ) {
...
std::string LHCb::CaloAlgUtils::CaloIdLocation( const std::string& type, const std::string& context ) {
...
std::vector<std::string> LHCb::CaloAlgUtils::TrackLocations( const std::string& context ) {
...
bool LHCb::CaloAlgUtils::StringMatcher( const std::vector<std::string>& refs, const std::string& name ) {
...
bool LHCb::CaloAlgUtils::StringMatcher( const std::string& ref, const std::string& name ) {
