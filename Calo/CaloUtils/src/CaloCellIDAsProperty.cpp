 ...
 */
// ============================================================================
StatusCode CaloCellCode::Cell2String::cellFromString( LHCb::CaloCellID& cell, const std::string& input ) {
 ...
 */
// ============================================================================
StatusCode CaloCellCode::Cell2String::cellFromString( LHCb::CaloCellID::Set& cell, const std::string& input ) {
  StatusCode sc = Gaudi::Parsers::parse( cell, input );
 ...
 */
// ============================================================================
StatusCode CaloCellCode::Cell2String::cellFromString( LHCb::CaloCellID::Vector& cell, const std::string& input ) {
  StatusCode sc = Gaudi::Parsers::parse( cell, input );
  if ( sc.isFailure() ) { cell.clear(); }
  return sc;
}
 ...
 */
// ============================================================================
std::string CaloCellCode::Cell2String::cellToString( const LHCb::CaloCellID::Set& cell ) {
  return Gaudi::Utils::toString( cell );
}
// ============================================================================
/* convert cellIDs into string
 ...
 */
// ============================================================================
std::string CaloCellCode::Cell2String::cellToString( const LHCb::CaloCellID::Vector& cell ) {
  return Gaudi::Utils::toString( cell );
}
// ============================================================================
