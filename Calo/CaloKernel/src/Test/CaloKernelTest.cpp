...
int main() {
  ...
  ///
  std::cout << " \tCellID " << cell1 << " \tCalo=  " << cell1.calo() << " \tArea=  " << cell1.area() << std::endl
            << " \t\t"
            << " \tRow=   " << cell1.row() << " \tCol=   " << cell1.col() << " \tRaw=   " << cell1.raw()
            << " \tBits=  " << cell1.bits() << " \tSize of all/raw = " << sizeof( cell1 ) << "/"
            << sizeof( cell1.raw() ) << std::endl;

  std::cout << " \tCellID " << cell2 << " \tCalo=  " << cell2.calo() << " \tArea=  " << cell2.area() << std::endl
            << " \t\t"
            << " \tRow=   " << cell2.row() << " \tCol=   " << cell2.col() << " \tRaw=   " << cell2.raw()
            << " \tBits=  " << cell2.bits() << " \tSize of all/raw = " << sizeof( cell2 ) << "/"
            << sizeof( cell2.raw() ) << std::endl;

  std::cout << " \tCellID " << cell3 << " \tCalo=  " << cell3.calo() << " \tArea=  " << cell3.area() << std::endl
            << " \t\t"
            << " \tRow=   " << cell3.row() << " \tCol=   " << cell3.col() << " \tRaw=   " << cell3.raw()
            << " \tBits=  " << cell3.bits() << " \tSize of all/raw = " << sizeof( cell3 ) << "/"
            << sizeof( cell3.raw() ) << std::endl;
...

  {
    ...
    std::copy( vint.begin(), vint.end(), OS_iterator<double, std::ostream>( std::cout ) );
    ...
    std::copy( vint.begin(), vint.end(), OS_iterator<double, std::ostream>( std::cerr, std::endl ) );
    ...
    std::copy( vint.begin(), vint.end(), OS_iterator<double, std::ostream>( std::cout, " ljshfdalf", std::endl ) );
