...
private:
  ...
  Gaudi::Property<std::vector<std::string>> m_topConfig{this, "ConfigTop", {"Hlt"s}}; ///< where to start when
                                                                                      ///< configuring
  Gaudi::Property<std::vector<std::string>> m_svcConfig{
      this, "ConfigSvc", {"ToolSvc"s, "HltANNSvc"s, "Hlt::Service"s}}; ///< Which services to configure
  ...
  Gaudi::Property<std::vector<std::string>>                        m_envVars{
      this, "EnvironmentVariables"s, {"PARAMFILESROOT"s}}; ///< Which environment variables do we put back in.
