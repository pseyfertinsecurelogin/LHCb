...
private:
  ...
  Gaudi::Property<std::vector<std::string>> m_outputContainerName{
      this,
      "HltDecReportsLocations",
      {"/Event/Hlt1/DecReports", "/Event/Hlt2/DecReports"}}; ///< location of HltDecReports in which to record
                                                             ///< configured TCK
