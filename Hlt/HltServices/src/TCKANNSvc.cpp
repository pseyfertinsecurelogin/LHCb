...
public:
  ...
  GaudiUtils::VectorMap<unsigned int, Gaudi::StringKey> i2s( unsigned int            index,
                                                             const Gaudi::StringKey& major ) const override;
...
StatusCode TCKANNSvc::initialize() {
...
StatusCode TCKANNSvc::finalize() {
  m_propertyConfigSvc.reset();
  return Service::finalize();
}

GaudiUtils::VectorMap<unsigned int, Gaudi::StringKey> TCKANNSvc::i2s( unsigned int            tck,
