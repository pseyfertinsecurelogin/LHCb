...
for d in ["Spd", "Prs", "Ecal", "Hcal"]:
    for b in bunch:
        ...
        dondem.AlgMap['/Event/' + b + '/Raw/' + d +
                      '/Digits'] = calo_conf[d + b].getFullName()
...
for b in bunch:
    ...
    ot_conf['oTTimeCreator' + b].addTool(
        OTRawBankDecoder, name='OTRawBankDecoder')
    ot_conf['oTTimeCreator' +
            b].OTRawBankDecoder.RawEventLocation = b + '/DAQ/RawEvent'
...
for b in bunch:
    ...
    dondem.AlgMap['/Event/' + b + '/Raw/Velo/Clusters'] = velo_conf[
        'createVeloClusters' + b].getFullName()

from Configurables import RawBankToSTClusterAlg, RawBankToSTLiteClusterAlg
st_conf = {}
for d in ['IT', 'TT']:
    for b in bunch:
        st_conf['create' + d + 'Clusters' +
                b] = RawBankToSTClusterAlg('Create' + d + 'Clusters' + b)
        st_conf['create' + d + 'Clusters' +
                b].rawEventLocation = b + '/DAQ/RawEvent'
        st_conf['create' + d + 'Clusters' +
                b].clusterLocation = b + '/Raw/' + d + '/Clusters'
        st_conf['create' + d + 'Clusters' +
                b].summaryLocation = b + '/Rec/' + d + '/Summary'
        st_conf['create' + d + 'Clusters' + b].detType = d
        st_conf['create' + d + 'LiteClusters' + b] = RawBankToSTLiteClusterAlg(
            'Create' + d + 'LiteClusters' + b)
        st_conf['create' + d + 'LiteClusters' +
                b].rawEventLocation = b + '/DAQ/RawEvent'
        st_conf['create' + d + 'LiteClusters' +
                b].clusterLocation = b + '/Raw/' + d + '/LiteClusters'
        st_conf['create' + d + 'LiteClusters' + b].detType = d
        dondem.AlgMap['/Event/' + b + '/Raw/' + d + '/Clusters'] = st_conf[
            'create' + d + 'Clusters' + b].getFullName()
        dondem.AlgMap['/Event/' + b + '/Raw/' + d + '/LiteClusters'] = st_conf[
            'create' + d + 'LiteClusters' + b].getFullName()
