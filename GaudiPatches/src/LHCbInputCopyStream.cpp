// $Id: LHCbInputCopyStream.cpp,v 1.1 2009-02-16 13:16:36 pkoppenb Exp $
...
#include "LHCbInputCopyStream.h"

// Define the algorithm factory for the standard output data writer
DECLARE_ALGORITHM_FACTORY(LHCbInputCopyStream)

// Standard Constructor
LHCbInputCopyStream::LHCbInputCopyStream(const std::string& name, ISvcLocator* pSvcLocator)
...
// Standard Destructor
LHCbInputCopyStream::~LHCbInputCopyStream()   {
}

// Place holder to create configurable data store agent
StatusCode LHCbInputCopyStream::collectLeaves(IRegistry* dir, int level)    {
...
StatusCode LHCbInputCopyStream::collectObjects()   {
  MsgStream log(msgSvc(), name());
