...
namespace Gaudi {
  namespace Functional {
    ...
    template <class Out, template <typename, typename...> class SourceContainer, typename Source,
              typename... SourceContainerArgs, typename... ExtraIn, typename Traits_>
    class Linker<Out( const SourceContainer<Source, SourceContainerArgs...>&, const ExtraIn&... ), Traits_>
        : public Detail::LinkerMixin<Source>,
          public Transformer<Out( const SourceContainer<Source, SourceContainerArgs...>&, const ExtraIn&... ),
                             Traits_> {
    public:
    ...
    // not contain the same public typedefs, so some specialization tricks
    // are needed to get access to the target and source types.
    template <typename... Out, template <typename, typename...> class SourceContainer, typename Source,
              typename... SourceContainerArgs, typename... ExtraIn, typename Traits_>
    class MultiLinker<std::tuple<Out...>( const SourceContainer<Source, SourceContainerArgs...>&, const ExtraIn&... ),
                      Traits_>
        : public Detail::LinkerMixin<Source>,
          public MultiTransformer<std::tuple<Out...>( const SourceContainer<Source, SourceContainerArgs...>&,
                                                      const ExtraIn&... ),
                                  Traits_> {
    public:
      // Forwarding contructor saves a lot of hassle
      using MultiTransformer<std::tuple<Out...>( const SourceContainer<Source, SourceContainerArgs...>&,
                                                 const ExtraIn&... ),
