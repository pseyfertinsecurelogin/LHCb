...
public:
  ...
  Object2MCLinker( const Algorithm* myMother, const int method, std::vector<std::string> containerList )
  ...
  Object2MCLinker( const Algorithm* myMother, const int method, const std::string& container )
      : m_parent( dynamic_cast<const GaudiAlgorithm*>( myMother ) )
      , m_extension( Particle2MCMethod::extension[method] )
      , m_linkerAlgType( Particle2MCMethod::algType[method] )
  ...
  Object2MCLinker( const Algorithm* myMother, const std::string& algType, const std::string& extension,
  ...
  Object2MCLinker( const GaudiTool* myMother, const int method, std::vector<std::string> containerList )
      : m_parent( myMother )
      , m_extension( Particle2MCMethod::extension[method] )
      , m_linkerAlgType( Particle2MCMethod::algType[method] )
      , m_containerList( std::move( containerList ) )
  ...
  Object2MCLinker( const GaudiTool* myMother, const int method, const std::string& container )
      : m_parent( myMother )
      , m_extension( Particle2MCMethod::extension[method] )
      , m_linkerAlgType( Particle2MCMethod::algType[method] )
      , m_containerList( std::vector<std::string>( 1, container ) )
  ...
  Object2MCLinker( const GaudiTool* myMother, const std::string& algType, const std::string& extension,
                   std::vector<std::string> containerList )
      : m_parent( myMother )
      , m_extension( extension )
      , m_linkerAlgType( algType )
...
public:
  ...
  Object2FromMC( const Algorithm* myMother )
      : Object2MCLinker<OBJ2MCP>( myMother ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const Algorithm* myMother, const int method, std::vector<std::string> containerList )
      : Object2MCLinker<OBJ2MCP>( myMother, method, std::move( containerList ) ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const Algorithm* myMother, const int method, const std::string& container )
      : Object2MCLinker<OBJ2MCP>( myMother, method, container ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const Algorithm* myMother, const std::string& algType, const std::string& extension,
                 std::vector<std::string> containerList )
  ...
  Object2FromMC( const Algorithm* myMother, const std::string& algType, const std::string& extension,
                 const std::string& container )
      : Object2MCLinker<OBJ2MCP>( myMother, algType, extension, container ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const GaudiTool* myMother )
      : Object2MCLinker<OBJ2MCP>( myMother ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const GaudiTool* myMother, const int method, std::vector<std::string> containerList )
      : Object2MCLinker<OBJ2MCP>( myMother, method, std::move( containerList ) ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const GaudiTool* myMother, const int method, const std::string& container )
      : Object2MCLinker<OBJ2MCP>( myMother, method, container ), m_linkFrom( m_linkFromList.end() ) {}

  Object2FromMC( const GaudiTool* myMother, const std::string& algType, const std::string& extension,
                 std::vector<std::string> containerList )
      : Object2MCLinker<OBJ2MCP>( myMother, algType, extension, std::move( containerList ) )
      , m_linkFrom( m_linkFromList.end() ) {}
