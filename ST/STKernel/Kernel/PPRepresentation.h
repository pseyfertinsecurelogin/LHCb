...
namespace STDAQ {
  ...
  public:
     ...
     **/
    PPRepresentation( unsigned int pp, unsigned int beetle = 0, unsigned int port = 0, unsigned int strip = 0 );
    ...
    friend std::ostream& operator<<( std::ostream& s, const STDAQ::PPRepresentation& obj ) {
...
inline STDAQ::PPRepresentation::PPRepresentation( unsigned int pp, unsigned int beetle, unsigned int port,
                                                  unsigned int strip ) {
...
inline STDAQ::PPRepresentation::operator int() const { return m_value; }

inline unsigned int STDAQ::PPRepresentation::value() const { return m_value; }

inline void STDAQ::PPRepresentation::decompose( unsigned int& pp, unsigned int& beetle, unsigned int& port,
