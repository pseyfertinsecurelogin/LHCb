...
namespace STDAQ {
  ...
  public:
     ...
     **/
    BeetleRepresentation( unsigned int beetle, unsigned int port = 0, unsigned int strip = 0 );
    ...
    friend std::ostream& operator<<( std::ostream& s, const STDAQ::BeetleRepresentation& obj ) {
...
inline STDAQ::BeetleRepresentation::BeetleRepresentation( unsigned int beetle, unsigned int port, unsigned int strip ) {
  m_value = ( LHCbConstants::nStripsInBeetle * beetle ) + ( LHCbConstants::nStripsInPort * port ) + strip;
}

inline STDAQ::BeetleRepresentation::BeetleRepresentation( const STDAQ::StripRepresentation& strip )
    : m_value( strip.value() ) {
  // constructor
}

inline STDAQ::BeetleRepresentation::operator int() const { return m_value; }

inline unsigned int STDAQ::BeetleRepresentation::value() const { return m_value; }
...
inline void STDAQ::BeetleRepresentation::decompose( unsigned int& beetle, unsigned int& port,
...
inline void STDAQ::BeetleRepresentation::decompose( unsigned int& beetle, unsigned int& strip ) const {
