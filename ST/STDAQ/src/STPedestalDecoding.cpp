...
//=============================================================================
STPedestalDecoding::STPedestalDecoding( const std::string& name, ISvcLocator* pSvcLocator )
    : ST::AlgBase( name, pSvcLocator ) {
  declareSTConfigProperty( "InputLocation", m_inputLocation, RawEventLocation::Default );
  declareSTConfigProperty( "OutputLocation", m_outputLocation, STTELL1DataLocation::TTPedestal );
}
