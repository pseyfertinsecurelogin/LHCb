...
bool LHCb::STTELL1Error::badLink( const unsigned int beetle, const unsigned int port,
                                  const unsigned int testpcn ) const {

  return ( linkInfo( beetle, port, testpcn ) == STTELL1Error::FailureMode::kNone ? false : true );
}

bool LHCb::STTELL1Error::addLinkInfo( const unsigned int key, const LHCb::STTELL1Error::FailureMode& mode ) {
...
LHCb::STTELL1Error::FailureMode LHCb::STTELL1Error::linkInfo( const unsigned int beetle, const unsigned int port,
                                                              const unsigned int testpcn ) const {
