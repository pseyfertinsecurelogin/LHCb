...
bool LHCb::STTELL1EventInfo::linkEnabled( const unsigned int iLink ) const { return !( OptLnkDisable() >> iLink & 1 ); }
...
bool LHCb::STTELL1EventInfo::noEvent( const unsigned int iLink ) const { return ( OptLnkNoEvt() >> iLink & 1 ); }

bool LHCb::STTELL1EventInfo::noClock( const unsigned int iLink ) const { return ( OptLnkNoClock() >> iLink & 1 ); }

bool LHCb::STTELL1EventInfo::TLKLinkLoss( const unsigned int iLink ) const { return ( tlkLnkLoss() >> iLink & 1 ); }

bool LHCb::STTELL1EventInfo::syncRAMFull( const unsigned int iLink ) const { return ( SyncRAMFull() >> iLink & 1 ); }
