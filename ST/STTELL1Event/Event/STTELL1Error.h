...
namespace LHCb {
  ...
  // Class ID definition
  static const CLID CLID_STTELL1Error = 9012;

  // Namespace for locations in TDS
  namespace STTELL1ErrorLocation {
    inline const std::string TTError = "Raw/TT/Error";
    inline const std::string ITError = "Raw/IT/Error";
  } // namespace STTELL1ErrorLocation

  /** @class STTELL1Error STTELL1Error.h
   *
  ...
  class STTELL1Error : public KeyedObject<int> {
  public:
    /// typedef for KeyedContainer of STTELL1Error
    typedef KeyedContainer<STTELL1Error, Containers::HashMap> Container;
    ...
    STTELL1Error( const unsigned int word0, const unsigned int word1, const unsigned int word2,
    ...
    static LHCb::STTELL1Error::FailureMode FailureModeToType( const std::string& aName );
    ...
    bool addLinkInfo( const unsigned int key, const LHCb::STTELL1Error::FailureMode& mode );

    /// Extract the information associated with the specified key
    STTELL1Error::FailureMode linkInfo( const unsigned int beetle, const unsigned int port,
    ...
    friend std::ostream& operator<<( std::ostream& str, const STTELL1Error& obj ) { return obj.fillStream( str ); }

  protected:
  private:
    /// Vector of arx [ each 32 channels] with failure
    typedef GaudiUtils::VectorMap<unsigned int, LHCb::STTELL1Error::FailureMode> FailureInfo;
    ...
    /// flag bad links
    void flagBadLinks( const unsigned int link, const LHCb::STTELL1Error::FailureMode& mode );
  ...
  /// Definition of Keyed Container for STTELL1Error
  typedef KeyedContainer<STTELL1Error, Containers::HashMap> STTELL1Errors;

  inline std::ostream& operator<<( std::ostream& s, LHCb::STTELL1Error::FailureMode e ) {
    switch ( e ) {
    case LHCb::STTELL1Error::kNone:
      return s << "kNone";
    case LHCb::STTELL1Error::kCorruptedBank:
      return s << "kCorruptedBank";
    case LHCb::STTELL1Error::kOptLinkDisabled:
      return s << "kOptLinkDisabled";
    case LHCb::STTELL1Error::kTlkLinkLoss:
      return s << "kTlkLinkLoss";
    case LHCb::STTELL1Error::kOptLinkNoClock:
      return s << "kOptLinkNoClock";
    case LHCb::STTELL1Error::kSyncRAMFull:
      return s << "kSyncRAMFull";
    case LHCb::STTELL1Error::kSyncEvtSize:
      return s << "kSyncEvtSize";
    case LHCb::STTELL1Error::kOptLinkNoEvent:
      return s << "kOptLinkNoEvent";
    case LHCb::STTELL1Error::kPseudoHeader:
      return s << "kPseudoHeader";
    case LHCb::STTELL1Error::kWrongPCN:
      return s << "kWrongPCN";
    default:
      return s << "ERROR wrong value " << int( e ) << " for enum LHCb::STTELL1Error::FailureMode";
    }
  }
...
inline const CLID& LHCb::STTELL1Error::clID() const { return LHCb::STTELL1Error::classID(); }

inline const CLID& LHCb::STTELL1Error::classID() { return CLID_STTELL1Error; }

inline const GaudiUtils::VectorMap<std::string, LHCb::STTELL1Error::FailureMode>&
LHCb::STTELL1Error::s_FailureModeTypMap() {
...
inline LHCb::STTELL1Error::FailureMode LHCb::STTELL1Error::FailureModeToType( const std::string& aName ) {
  auto iter = s_FailureModeTypMap().find( aName );
  return iter != s_FailureModeTypMap().end() ? iter->second : kNone;
}

inline const std::string& LHCb::STTELL1Error::FailureModeToString( int aEnum ) {
...
inline unsigned int LHCb::STTELL1Error::word0() const { return m_word0; }

inline unsigned int LHCb::STTELL1Error::bCnt() const { return (unsigned int)( ( m_word0 & BCntMask ) >> BCntBits ); }

inline unsigned int LHCb::STTELL1Error::DetectorID() const {
  return (unsigned int)( ( m_word0 & DetectorIDMask ) >> DetectorIDBits );
}

inline unsigned int LHCb::STTELL1Error::BankList() const {
  return (unsigned int)( ( m_word0 & BankListMask ) >> BankListBits );
}

inline unsigned int LHCb::STTELL1Error::EventInformation() const {
  return (unsigned int)( ( m_word0 & EventInformationMask ) >> EventInformationBits );
}

inline unsigned int LHCb::STTELL1Error::word1() const { return m_word1; }

inline int LHCb::STTELL1Error::L0EvtID() const { return (int)( ( m_word1 & L0EvtIDMask ) >> L0EvtIDBits ); }

inline unsigned int LHCb::STTELL1Error::word2() const { return m_word2; }

inline unsigned int LHCb::STTELL1Error::adC1() const { return (unsigned int)( ( m_word2 & ADC1Mask ) >> ADC1Bits ); }

inline unsigned int LHCb::STTELL1Error::Clust1() const {
  return (unsigned int)( ( m_word2 & Clust1Mask ) >> Clust1Bits );
}

inline unsigned int LHCb::STTELL1Error::word3() const { return m_word3; }

inline unsigned int LHCb::STTELL1Error::NumClusters() const {
  return (unsigned int)( ( m_word3 & NumClustersMask ) >> NumClustersBits );
}

inline unsigned int LHCb::STTELL1Error::pcn() const { return (unsigned int)( ( m_word3 & PCNMask ) >> PCNBits ); }

inline unsigned int LHCb::STTELL1Error::ProcessInfo() const {
  return (unsigned int)( ( m_word3 & ProcessInfoMask ) >> ProcessInfoBits );
}

inline unsigned int LHCb::STTELL1Error::word4() const { return m_word4; }

inline unsigned int LHCb::STTELL1Error::EmptyVal0() const {
  return (unsigned int)( ( m_word4 & EmptyVal0Mask ) >> EmptyVal0Bits );
}

inline unsigned int LHCb::STTELL1Error::EmptyVal1() const {
  return (unsigned int)( ( m_word4 & EmptyVal1Mask ) >> EmptyVal1Bits );
}

inline unsigned int LHCb::STTELL1Error::ErrorBankLength() const {
  return (unsigned int)( ( m_word4 & ErrorBankLengthMask ) >> ErrorBankLengthBits );
}

inline unsigned int LHCb::STTELL1Error::word5() const { return m_word5; }

inline unsigned int LHCb::STTELL1Error::OptLnkNoEvt() const {
  return (unsigned int)( ( m_word5 & OptLnkNoEvtMask ) >> OptLnkNoEvtBits );
}

inline unsigned int LHCb::STTELL1Error::OptLnkDisable() const {
  return (unsigned int)( ( m_word5 & OptLnkDisableMask ) >> OptLnkDisableBits );
}

inline unsigned int LHCb::STTELL1Error::SyncEvtSizeError() const {
  return (unsigned int)( ( m_word5 & SyncEvtSizeErrorMask ) >> SyncEvtSizeErrorBits );
}

inline unsigned int LHCb::STTELL1Error::tlkLnkLoss() const {
  return (unsigned int)( ( m_word5 & TLKLnkLossMask ) >> TLKLnkLossBits );
}

inline unsigned int LHCb::STTELL1Error::SyncRAMFull() const {
  return (unsigned int)( ( m_word5 & SyncRAMFullMask ) >> SyncRAMFullBits );
}

inline unsigned int LHCb::STTELL1Error::ChipAddr() const {
  return (unsigned int)( ( m_word5 & ChipAddrMask ) >> ChipAddrBits );
}

inline unsigned int LHCb::STTELL1Error::word6() const { return m_word6; }

inline int LHCb::STTELL1Error::HeaderPseudoError() const {
  return (int)( ( m_word6 & HeaderPseudoErrorMask ) >> HeaderPseudoErrorBits );
}

inline unsigned int LHCb::STTELL1Error::OptLnkNoClock() const {
  return (unsigned int)( ( m_word6 & OptLnkNoClockMask ) >> OptLnkNoClockBits );
}

inline unsigned int LHCb::STTELL1Error::pcnError() const {
  return (unsigned int)( ( m_word6 & PCNErrorMask ) >> PCNErrorBits );
}

inline unsigned int LHCb::STTELL1Error::R2() const { return (unsigned int)( ( m_word6 & R2Mask ) >> R2Bits ); }

inline unsigned int LHCb::STTELL1Error::word7() const { return m_word7; }

inline unsigned int LHCb::STTELL1Error::pcnBeetle0() const {
  return (unsigned int)( ( m_word7 & PCNBeetle0Mask ) >> PCNBeetle0Bits );
}

inline unsigned int LHCb::STTELL1Error::pcnBeetle1() const {
  return (unsigned int)( ( m_word7 & PCNBeetle1Mask ) >> PCNBeetle1Bits );
}

inline unsigned int LHCb::STTELL1Error::pcnBeetle2() const {
  return (unsigned int)( ( m_word7 & PCNBeetle2Mask ) >> PCNBeetle2Bits );
}

inline unsigned int LHCb::STTELL1Error::pcnBeetle3() const {
  return (unsigned int)( ( m_word7 & PCNBeetle3Mask ) >> PCNBeetle3Bits );
}

inline unsigned int LHCb::STTELL1Error::word8() const { return m_word8; }

inline unsigned int LHCb::STTELL1Error::pcnBeetle4() const {
  return (unsigned int)( ( m_word8 & PCNBeetle4Mask ) >> PCNBeetle4Bits );
}

inline unsigned int LHCb::STTELL1Error::pcnBeetle5() const {
  return (unsigned int)( ( m_word8 & PCNBeetle5Mask ) >> PCNBeetle5Bits );
}

inline unsigned int LHCb::STTELL1Error::R3() const { return (unsigned int)( ( m_word8 & R3Mask ) >> R3Bits ); }

inline unsigned int LHCb::STTELL1Error::word9() const { return m_word9; }

inline void LHCb::STTELL1Error::setWord9( unsigned int value ) { m_word9 = value; }

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle0() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle0Mask ) >> IHeaderBeetle0Bits );
}

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle1() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle1Mask ) >> IHeaderBeetle1Bits );
}

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle2() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle2Mask ) >> IHeaderBeetle2Bits );
}

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle3() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle3Mask ) >> IHeaderBeetle3Bits );
}

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle4() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle4Mask ) >> IHeaderBeetle4Bits );
}

inline unsigned int LHCb::STTELL1Error::iHeaderBeetle5() const {
  return (unsigned int)( ( m_word9 & IHeaderBeetle5Mask ) >> IHeaderBeetle5Bits );
}

inline unsigned int LHCb::STTELL1Error::R4() const { return (unsigned int)( ( m_word9 & R4Mask ) >> R4Bits ); }

inline unsigned int LHCb::STTELL1Error::word10() const { return m_word10; }

inline void LHCb::STTELL1Error::setWord10( unsigned int value ) { m_word10 = value; }

inline unsigned int LHCb::STTELL1Error::EmptyVal2() const {
  return (unsigned int)( ( m_word10 & EmptyVal2Mask ) >> EmptyVal2Bits );
}

inline unsigned int LHCb::STTELL1Error::EmptyVal3() const {
  return (unsigned int)( ( m_word10 & EmptyVal3Mask ) >> EmptyVal3Bits );
}

inline unsigned int LHCb::STTELL1Error::Clust2() const {
  return (unsigned int)( ( m_word10 & Clust2Mask ) >> Clust2Bits );
}

inline unsigned int LHCb::STTELL1Error::word11() const { return m_word11; }

inline void LHCb::STTELL1Error::setWord11( unsigned int value ) { m_word11 = value; }

inline unsigned int LHCb::STTELL1Error::EmptyVal4() const {
  return (unsigned int)( ( m_word11 & EmptyVal4Mask ) >> EmptyVal4Bits );
}

inline unsigned int LHCb::STTELL1Error::EmptyVal5() const {
  return (unsigned int)( ( m_word11 & EmptyVal5Mask ) >> EmptyVal5Bits );
}

inline unsigned int LHCb::STTELL1Error::adC2() const { return (unsigned int)( ( m_word11 & ADC2Mask ) >> ADC2Bits ); }

inline unsigned int LHCb::STTELL1Error::word12() const { return m_word12; }

inline void LHCb::STTELL1Error::setWord12( unsigned int value ) { m_word12 = value; }

inline unsigned int LHCb::STTELL1Error::EmptyVal6() const {
  return (unsigned int)( ( m_word12 & EmptyVal6Mask ) >> EmptyVal6Bits );
}

inline unsigned int LHCb::STTELL1Error::EmptyVal7() const {
  return (unsigned int)( ( m_word12 & EmptyVal7Mask ) >> EmptyVal7Bits );
}

inline unsigned int LHCb::STTELL1Error::nzsBankLength() const {
  return (unsigned int)( ( m_word12 & NZSBankLengthMask ) >> NZSBankLengthBits );
}

inline unsigned int LHCb::STTELL1Error::word13() const { return m_word13; }

inline void LHCb::STTELL1Error::setWord13( unsigned int value ) { m_word13 = value; }

inline unsigned int LHCb::STTELL1Error::EmptyVal8() const {
  return (unsigned int)( ( m_word13 & EmptyVal8Mask ) >> EmptyVal8Bits );
}

inline unsigned int LHCb::STTELL1Error::EmptyVal9() const {
  return (unsigned int)( ( m_word13 & EmptyVal9Mask ) >> EmptyVal9Bits );
}

inline unsigned int LHCb::STTELL1Error::PedBankLength() const {
  return (unsigned int)( ( m_word13 & PedBankLengthMask ) >> PedBankLengthBits );
}

inline bool LHCb::STTELL1Error::hasErrorInfo() const { return ErrorBankLength() == 0x14; }

inline bool LHCb::STTELL1Error::hasNZS() const { return ( BankList() & 0x8 ) != 0; }

inline bool LHCb::STTELL1Error::hasPed() const { return ( BankList() & 0x10 ) != 0; }

inline unsigned int LHCb::STTELL1Error::nOptionalWords() const {
...
inline unsigned int LHCb::STTELL1Error::sentWords() const {

  unsigned int wCount = 7 + nOptionalWords();
  return wCount;
}

inline void LHCb::STTELL1Error::setOptionalErrorWords( const unsigned int w1, const unsigned int w2,
...
inline unsigned int LHCb::STTELL1Error::linkID( const unsigned int beetle, const unsigned int port ) const {
  return ( 4 * beetle + port );
}

inline void LHCb::STTELL1Error::flagBadLinks( const unsigned int link, const LHCb::STTELL1Error::FailureMode& mode ) {
