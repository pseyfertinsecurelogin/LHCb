...
namespace LoKi {
   ...
   */
  class ODINFilter
      : public Gaudi::Functional::FilterPredicate<bool( const LHCb::ODIN& ),
  ...
  public:
     ...
     */
    ODINFilter( const std::string& name, // the algorithm instance name
                ISvcLocator*       pSvc )      // pointer to the service locator
        : FilterPredicate( name, pSvc, KeyValue{"Location", LHCb::ODINLocation::Default} ) {
  ...
  private:
    // ========================================================================
    /// the functor itself
    LoKi::Types::ODIN_Cut m_cut = {LoKi::BasicFunctors<const LHCb::ODIN*>::BooleanConstant( false )}; // the functor
                                                                                                      // itself
