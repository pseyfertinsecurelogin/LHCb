...
namespace LoKi {
  ...
  namespace Hybrid {
     ...
     *  @date 2008-09-18
     */
    class HltFactory : public LoKi::Hybrid::Base,
    ...
    public: // L0-functors
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::L0_Cut& cuts, const std::string& context ) override {
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::L0_Fun& cuts, const std::string& context ) override {
    ...
    public: // ODIN-functors
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::ODIN_Cut& cuts, const std::string& context ) override {
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::ODIN_Fun& cuts, const std::string& context ) override {
    ...
    public: // HLT-functors
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::HLT_Cut& cuts, const std::string& context ) override {
       ...
       *  @return StatusCode
       */
      StatusCode get( const std::string& pycode, LoKi::Types::HLT_Fun& cuts, const std::string& context ) override {
    ...
    public: // L0-functors
      // ======================================================================
      /// set the C++ predicate
      void set( const LoKi::Types::L0_Cuts& cut ) override { LoKi::Hybrid::Base::_set( m_l0_cuts, cut ); }
      /// set the C++ function
      void set( const LoKi::Types::L0_Func& cut ) override { LoKi::Hybrid::Base::_set( m_l0_func, cut ); }
      // ======================================================================
    public: // O1-functors
      // ======================================================================
      /// set the C++ predicate
      void set( const LoKi::Types::ODIN_Cuts& cut ) override { LoKi::Hybrid::Base::_set( m_o1_cuts, cut ); }
      /// set the C++ function
      void set( const LoKi::Types::ODIN_Func& cut ) override { LoKi::Hybrid::Base::_set( m_o1_func, cut ); }
      // ======================================================================
    public: // HLT-functors
      // ======================================================================
      /// set the C++ predicate
      void set( const LoKi::Types::HLT_Cuts& cut ) override { LoKi::Hybrid::Base::_set( m_hlt_cuts, cut ); }
      /// set the C++ function
      void set( const LoKi::Types::HLT_Func& cut ) override { LoKi::Hybrid::Base::_set( m_hlt_func, cut ); }
      /// constrcutor
      HltFactory( const std::string& type, const std::string& name, const IInterface* parent );
      // ======================================================================
    private:
      // ======================================================================
...
template <class TYPE1, class TYPE2>
inline StatusCode
LoKi::Hybrid::HltFactory::_get( const std::string& pycode, std::unique_ptr<LoKi::Functor<TYPE1, TYPE2>>& local,
                                LoKi::Assignable_t<LoKi::Functor<TYPE1, TYPE2>>& output, const std::string& context ) {
...
// ============================================================================
LoKi::Hybrid::HltFactory::HltFactory( const std::string& type, const std::string& name, const IInterface* parent )
