...
namespace LoKi {
  ...
  public:
     ...
     */
    L0Filter( const std::string& name, // the algorithm instance name
              ISvcLocator*       pSvc )      // pointer to the service locator
        : FilterPredicate( name, pSvc, {KeyValue{"Location", LHCb::L0DUReportLocation::Default}} ) {
      //
      declareProperty( "CheckValidity", m_check, "Check validity of LHCb::L0DUReport object before using the functor" );
      //
  ...
  private:
    // ========================================================================
    /// the functor itself
    LoKi::Types::L0_Cut m_cut = {LoKi::BasicFunctors<const LHCb::L0DUReport*>::BooleanConstant( false )}; // the functor
                                                                                                          // itself
