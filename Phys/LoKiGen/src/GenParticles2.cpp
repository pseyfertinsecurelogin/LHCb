...
namespace LoKi {
  namespace GenParticles {
    ...
    // ==========================================================================
    StatusCode PolarizationAngle::getComponents12( const HepMC::GenParticle*             p,
    ...
    // get the proper decay components
    // ==========================================================================
    StatusCode SinChi::getComponents( const HepMC::GenParticle* p, Decays::IGenDecay::iTree::Collection& vct ) const {
      vct.clear();
