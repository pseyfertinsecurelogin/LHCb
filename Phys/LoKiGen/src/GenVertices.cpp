...
// ============================================================================
double
LoKi::GenVertices::BarCode::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
...
//  MANDATORY: clone method ("virtual" constructor")
// ============================================================================
LoKi::GenVertices::PositionX* LoKi::GenVertices::PositionX:: clone() const
{ return new PositionX(*this); }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::PositionX::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
...
//  MANDATORY: clone method ("virtual" constructor")
// ============================================================================
LoKi::GenVertices::PositionY* LoKi::GenVertices::PositionY:: clone() const
{ return new PositionY(*this); }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::PositionY::operator()( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
    Error ( "HepMC::GenVertex* points to NULL; return 'InvalidDistance'" ) ;
...
//  MANDATORY: clone method ("virtual" constructor")
// ============================================================================
LoKi::GenVertices::PositionZ* LoKi::GenVertices::PositionZ:: clone() const
{ return new PositionZ(*this); }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::PositionZ::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
    Error ( "HepMC::GenVertex* points to NULL; return 'InvalidDistance'" ) ;
...
//  MANDATORY: clone method ("virtual" constructor")
// ============================================================================
LoKi::GenVertices::PositionT* LoKi::GenVertices::PositionT:: clone() const
{ return new PositionT(*this); }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::PositionT::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
...
//  MANDATORY: clone method ("virtual" constructor")
// ============================================================================
LoKi::GenVertices::Rho* LoKi::GenVertices::Rho:: clone() const
{ return new Rho ( *this ) ; }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::Rho::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
    Error ( "HepMC::GenVertex* points to NULL; return 'InvalidDistance'" ) ;
 ...
 */
// ============================================================================
LoKi::GenVertices::CountIF::CountIF( const LoKi::Types::GCuts& cut   ,
 ...
 */
// ============================================================================
LoKi::GenVertices::CountIF::CountIF( HepMC::IteratorRange      range ,
...
// ============================================================================
LoKi::GenVertices::CountIF* LoKi::GenVertices::CountIF::clone() const
{ return new CountIF( *this ) ; }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::CountIF::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) ) { return 0 ; }
  HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( v ) ;
  return std::count_if( _v->particles_begin ( m_range ) ,
...
// ============================================================================
std::ostream&
LoKi::GenVertices::CountIF::fillStream( std::ostream& stream ) const
{
 ...
 */
// ============================================================================
LoKi::GenVertices::SumIF::SumIF( const LoKi::Types::GFunc& fun   ,
                                 HepMC::IteratorRange      range )
: m_fun   ( fun   )
 ...
 */
// ============================================================================
LoKi::GenVertices::SumIF::SumIF ( HepMC::IteratorRange      range ,
 ...
 */
// ============================================================================
LoKi::GenVertices::SumIF::SumIF( const LoKi::Types::GCuts& cut   ,
                                 const LoKi::Types::GFunc& fun   ,
                                 HepMC::IteratorRange      range )
: m_fun   ( fun   )
, m_cut   ( cut   )
...
//  MANDATORY: clone method ("virtual contructor")
// ============================================================================
LoKi::GenVertices::SumIF* LoKi::GenVertices::SumIF::clone() const
{ return new SumIF( *this ) ; }
// ============================================================================
//  MANDATORY: the only one essential method
// ============================================================================
double
LoKi::GenVertices::SumIF::operator() ( const HepMC::GenVertex* v ) const
{
  if ( UNLIKELY(!v) )
  {
  ...
  return std::accumulate( _v->particles_begin( m_range ),
                          _v->particles_end( m_range ),
                          0.,
...
// ============================================================================
std::ostream&
LoKi::GenVertices::SumIF::fillStream( std::ostream& stream ) const
{
  stream << "GVSUM(" << m_fun << ",";
  switch ( m_range )
  {
