...
namespace LoKi {
  ...
  namespace GenAlgs {
    ...
    inline size_t count_if( const HepMC::GenEvent* event, const PREDICATE& cut ) {
      return ( 0 == event ) ? 0 : LoKi::Algs::count_if( event->particles_begin(), event->particles_end(), cut );
    }
    // ========================================================================
    /** useful helper function (a'la STL) to count a number of
     *  (HepMC) particles, which satisfies the certain criteria,
     ...
     */
    template <class PREDICATE>
    inline size_t count_if( const LHCb::HepMCEvent* event, const PREDICATE& cut ) {
      return ( 0 == event ) ? 0 : LoKi::GenAlgs::count_if( event->pGenEvt(), cut );
    }
    // ========================================================================
    /** useful helper function (a'la STL) to count a number of
     ...
     */
    template <class PREDICATE>
    inline size_t count_if( const LHCb::HepMCEvent::Container* events, const PREDICATE& cut ) {
      return ( 0 == events ) ? 0 : LoKi::GenAlgs::count_if( events->begin(), events->end(), cut );
    }
    // ========================================================================
     ...
     */
    template <class PREDICATE>
    inline size_t count_if( const HepMC::GenVertex* vertex, const PREDICATE& cut, HepMC::IteratorRange range ) {
      if ( 0 == vertex ) { return 0; } // RETURN
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      return LoKi::Algs::count_if( _v->particles_begin( range ), _v->particles_end( range ), cut ); // RETURN
    }
    // ========================================================================
     ...
     */
    template <class PREDICATE>
    inline size_t count_if( const HepMC::GenParticle* particle, const PREDICATE& cut ) {
      size_t result = 0;
      if ( 0 != particle ) { result = LoKi::GenAlgs::count_if( particle->end_vertex(), cut, HepMC::descendants ); }
     ...
     */
    template <class PREDICATE>
    inline bool found( const HepMC::GenEvent* event, const PREDICATE& cut ) {
      return event &&
             ( event->particles_end() != LoKi::Algs::find_if( event->particles_begin(), event->particles_end(), cut ) );
    }
    // ========================================================================
     ...
     */
    template <class PREDICATE>
    inline bool found( const LHCb::HepMCEvent* event, const PREDICATE& cut ) {
     ...
     */
    template <class PREDICATE>
    inline bool found( const LHCb::HepMCEvents* events, const PREDICATE& cut ) {
      return events && std::any_of( events->begin(), events->end(), [&]( LHCb::HepMCEvents::const_reference ev ) {
     ...
     */
    template <class PREDICATE>
    inline bool found( const HepMC::GenVertex* vertex, const PREDICATE& cut, HepMC::IteratorRange range ) {
      auto v = const_cast<HepMC::GenVertex*>( vertex );
      return v && LoKi::Algs::found( v->particles_begin( range ), v->particles_end( range ), cut );
    }
    // ========================================================================
     ...
     */
    template <class PREDICATE>
    inline bool found( const HepMC::GenParticle* particle, const PREDICATE& cut ) {
      return cut( particle ) || ( particle && LoKi::GenAlgs::found( particle->end_vertex(), cut, HepMC::descendants ) );
    }
    // =====================================================================
    template <class PREDICATE>
    inline const HepMC::GenParticle* foundFirst( const HepMC::GenVertex* vertex, const PREDICATE& cut );
    // ======================================================================
    template <class PREDICATE>
    inline const HepMC::GenParticle* foundFirst( const HepMC::GenParticle* particle, const PREDICATE& cut );
    // ======================================================================
    template <class PARTICLE, class PREDICATE>
    inline const HepMC::GenParticle* foundFirst( PARTICLE begin, PARTICLE end, const PREDICATE& cut ) {
      //
    ...
    inline const HepMC::GenParticle* foundFirst( const HepMC::GenVertex* vertex, const PREDICATE& cut ) {
      ...
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      //
      return foundFirst( _v->particles_begin( HepMC::children ), _v->particles_end( HepMC::children ), cut );
    }
    // ========================================================================
    /** useful helper function (a'la STL) to efficiently check the
     *  presence of at least one (HepMC) particle, which satisfies the
    ...
    inline RESULT accumulate( const HepMC::GenEvent* event, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, OPERATION binop ) {
      return event ? LoKi::Algs::accumulate( event->particles_begin(), event->particles_end(), functor, predicate,
                                             result, binop )
                   : result;
    }
    // ========================================================================
     ...
     */
    template <class RESULT, class FUNCTOR, class PREDICATE, class OPERATION>
    inline RESULT accumulate( const LHCb::HepMCEvent* event, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, OPERATION binop ) {
      return event ? LoKi::GenAlgs::accumulate( event->pGenEvt(), functor, predicate, result, binop ) : result;
    }
    // ========================================================================
    template <class RESULT, class FUNCTOR, class PREDICATE>
    inline RESULT accumulate( const LHCb::HepMCEvent* event, const FUNCTOR& functor, const PREDICATE& predicate,
     ...
     */
    template <class RESULT, class FUNCTOR, class PREDICATE, class OPERATION>
    inline RESULT accumulate( const LHCb::HepMCEvents* events, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, OPERATION binop ) {
      if ( !events ) { return result; }
      return std::accumulate( events->begin(), events->end(), result, [&]( RESULT r, const LHCb::HepMCEvent* ievent ) {
    ...
    inline RESULT accumulate( const LHCb::HepMCEvents* events, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result ) {
      return accumulate( events, functor, predicate, result, std::plus<RESULT>() );
    }
    // ========================================================================
     ...
     */
    template <class RESULT, class FUNCTOR, class PREDICATE, class OPERATION>
    inline RESULT accumulate( const HepMC::GenVertex* vertex, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, HepMC::IteratorRange range, OPERATION binop ) {
      if ( !vertex ) { return result; }
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      return LoKi::Algs::accumulate( _v->particles_begin( range ), _v->particles_end( range ), functor, predicate,
                                     result, binop );
    }
    // ========================================================================
    template <class RESULT, class FUNCTOR, class PREDICATE>
    inline RESULT accumulate( const HepMC::GenVertex* vertex, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, HepMC::IteratorRange range ) {
     ...
     */
    template <class RESULT, class FUNCTOR, class PREDICATE, class OPERATION>
    inline RESULT accumulate( const HepMC::GenParticle* particle, const FUNCTOR& functor, const PREDICATE& predicate,
                              RESULT result, OPERATION binop ) {
      if ( particle ) {
        result =
            LoKi::GenAlgs::accumulate( particle->end_vertex(), functor, predicate, result, HepMC::descendants, binop );
      }
    ...
    inline RESULT min_value( const HepMC::GenVertex* vertex, const FUNCTION& fun, const PREDICATE& cut,
                             HepMC::IteratorRange range, RESULT minval ) {
      if ( !vertex ) { return minval; } // RETURN
      // investigate the vertex
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      auto ifound = LoKi::Algs::select_min( _v->particles_begin( range ), _v->particles_end( range ), fun, cut );
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT min_value( const HepMC::GenParticle* particle, const FUNCTION& fun, const PREDICATE& cut,
                             RESULT minval ) {
      // (1) traverse the tree if possible
      if ( particle ) {
        // check all end-vertices :
        minval = LoKi::GenAlgs::min_value( particle->end_vertex(), fun, cut, HepMC::descendants, minval ); // RECURSION!
      }
      // (2) check itself
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( const HepMC::GenVertex* vertex, const FUNCTION& fun, const PREDICATE& cut,
                             HepMC::IteratorRange range, RESULT maxval ) {
      if ( !vertex ) { return maxval; } // RETURN
      // investigate the vertex
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      auto ifound = LoKi::Algs::select_max( _v->particles_begin( range ), _v->particles_end( range ), fun, cut );
      // check the maximum
      return ( _v->particles_end( range ) != ifound ) ? std::max( maxval, fun( *ifound ) ) : maxval;
    }
    // ========================================================================
    /** The trivial algorithm which scans the decay
     *  tree of the particle and searches for the the
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( const HepMC::GenParticle* particle, const FUNCTION& fun, const PREDICATE& cut,
                             RESULT maxval ) {
      // (1) traverse the tree if possible
      if ( particle ) {
        // check for endvertices
        maxval = LoKi::GenAlgs::max_value( particle->end_vertex(), fun, cut, HepMC::descendants, maxval ); // RECURSION!
      }
      // (2) check itself
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT min_value( const HepMC::GenEvent* event, const FUNCTION& fun, const PREDICATE& cut, RESULT minval ) {
      if ( !event ) { return minval; } // RETURN
      //
      auto ifound = LoKi::Algs::select_min( event->particles_begin(), event->particles_end(), fun, cut );
      return ifound != event->particles_end() ? std::min( minval, fun( *ifound ) ) : minval;
    }
    // ========================================================================
    /** simple function to extract the mminimul value of certain function
     *  for whole HepMC-event
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT min_value( const LHCb::HepMCEvent* event, const FUNCTION& fun, const PREDICATE& cut, RESULT minval ) {
      return event ? LoKi::GenAlgs::min_value( event->pGenEvt(), fun, cut, minval ) : minval;
    }
    // ========================================================================
    /** simple function to extract the mminimul value of certain function
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT min_value( const LHCb::HepMCEvent::Container* events, const FUNCTION& fun, const PREDICATE& cut,
                             RESULT minval ) {
      if ( !events ) { return minval; } // RETURN
      return std::accumulate( events->begin(), events->end(), minval, [&]( RESULT m, const LHCb::HepMCEvent* iev ) {
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( const HepMC::GenEvent* event, const FUNCTION& fun, const PREDICATE& cut, RESULT maxval ) {
      if ( event ) { return maxval; } // RETURN
      //
      auto ifound = LoKi::Algs::select_max( event->particles_begin(), event->particles_end(), fun, cut );
      return ifound != event->particles_end() ? std::max( maxval, fun( *ifound ) ) : maxval;
    }
    // ========================================================================
    /** simple function to extract the maximum value of certain function
     *  for whole HepMC event
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( const LHCb::HepMCEvent* event, const FUNCTION& fun, const PREDICATE& cut, RESULT maxval ) {
      return event ? LoKi::GenAlgs::max_value( event->pGenEvt(), fun, cut, maxval ) : maxval;
    }
    // ========================================================================
    /** simple function to extract the maximum value of certain function
     *  for whole HepMC super-event
     ...
     */
    template <class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( const LHCb::HepMCEvent::Container* events, const FUNCTION& fun, const PREDICATE& cut,
                             RESULT maxval ) {
      if ( !events ) { return maxval; } // RETURN
      return std::accumulate( events->begin(), events->end(), maxval, [&]( RESULT m, const LHCb::HepMCEvent* iev ) {
    ...
    inline const HepMC::GenParticle* min_element( const HepMC::GenEvent* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* min_element( const LHCb::HepMCEvent* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( !event ) { return nullptr; } // RETURN
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* min_element( const LHCb::HepMCEvent::Container* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( !event ) { return nullptr; } // RETURN
      const HepMC::GenParticle* result = nullptr;
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* min_element( const HepMC::GenVertex* vertex, const FUNCTION& fun,
                                                  const PREDICATE& cut, HepMC::IteratorRange range ) {
      if ( !vertex ) { return nullptr; } // RETURN
      HepMC::GenVertex* _v = const_cast<HepMC::GenVertex*>( vertex );
      auto ifound = LoKi::Algs::select_min( _v->particles_begin( range ), _v->particles_end( range ), fun, cut );
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* min_element( const HepMC::GenParticle* particle, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( !particle ) { return nullptr; } // RETURN
      const HepMC::GenParticle* tmp =
          LoKi::GenAlgs::min_element( particle->end_vertex(), fun, cut, HepMC::descendants );
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* max_element( const HepMC::GenEvent* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( !event ) { return nullptr; } // RETURN
      auto ifound = LoKi::Algs::select_max( event->particles_begin(), event->particles_end(), fun, cut );
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* max_element( const LHCb::HepMCEvent* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      return event ? LoKi::GenAlgs::max_element( event->pGenEvt(), fun, cut ) : nullptr;
    }
    // ========================================================================
    /** simple function to extract the particle, which maximizes a
     *  certain function
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* max_element( const LHCb::HepMCEvent::Container* event, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( !event ) { return nullptr; } // RETURN
      HepMC::GenParticle* result = nullptr;
      for ( auto iev = event->begin(); event->end() != iev; ++iev ) {
        const HepMC::GenParticle* tmp  = LoKi::GenAlgs::max_element( *iev, fun, cut ); // RECURSION
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* max_element( const HepMC::GenVertex* vertex, const FUNCTION& fun,
                                                  const PREDICATE& cut, HepMC::IteratorRange range ) {
      if ( 0 == vertex ) { return 0; } // RETURN
      HepMC::GenVertex*                   _v = const_cast<HepMC::GenVertex*>( vertex );
      HepMC::GenVertex::particle_iterator ifound =
          LoKi::Algs::select_max( _v->particles_begin( range ), _v->particles_end( range ), fun, cut );
     ...
     */
    template <class FUNCTION, class PREDICATE>
    inline const HepMC::GenParticle* max_element( const HepMC::GenParticle* particle, const FUNCTION& fun,
                                                  const PREDICATE& cut ) {
      if ( 0 == particle ) { return 0; } // RETURN
      const HepMC::GenParticle* tmp =
          LoKi::GenAlgs::max_element( particle->end_vertex(), fun, cut, HepMC::descendants );
