...
if not hasattr(LHCb.MCParticle, '__mother__'):
    LHCb.MCParticle.__mother__ = mother
...
for _t in (LHCb.MCParticle, LHCb.MCVertex):
...
for r in (LHCb.MCParticle.Range, LHCb.MCVertex.Range,
...
LHCb.MCParticle.Container = cpp.KeyedContainer(
    LHCb.MCParticle, 'Containers::KeyedObjectManager<Containers::hashmap>')
...
def _print_(self,
    ...
    """
    _printer = LoKi.MCDecayChain(maxDepth, vertex, mode, fg, bg, vertexe,
                                 vertexd)
...
for t in (LHCb.MCParticle, LHCb.MCParticle.Range, LHCb.MCParticle.ConstVector,
