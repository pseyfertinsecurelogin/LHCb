...
_decorated = _LoKiCore.decorateTrees(
    (Decays.iTree_(_MCP), Decays.Tree_(_MCP), Decays.Trees.Any_(_MCP),
     Decays.Trees.None_(_MCP), Decays.Trees.Stable_(_MCP),
     Decays.Trees.MCExclusive, Decays.Trees.MCInclusive,
     Decays.Trees.MCOptional, Decays.Trees.Photos,
...
MCFinder = _LoKiCore.decorateFinder(IMCDecay.Finder,
