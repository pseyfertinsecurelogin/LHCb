...
namespace LoKi {
  ...
  namespace MCTrees {
    ...
    inline OUTPUT buildTrees( MCPARTICLE first, MCPARTICLE last, OUTPUT output ) {
    ...
    inline MCPARTICLE buildTrees( MCPARTICLE first, MCPARTICLE last ) {
     ...
     */
    LHCb::MCParticle::Vector buildTrees( const LHCb::MCParticle::Vector& input );
    // ========================================================================
    /** Simple function which 'builds' the trees
     *
     *  @code
     ...
     *  @return container of MCtrees
     */
    LHCb::MCParticle::ConstVector buildTrees( const LHCb::MCParticle::ConstVector& input );
    // ========================================================================
    /** Simple function which 'builds' the trees
     *
     *  @code
     ...
     *  @return container of MCtrees
     */
    LHCb::MCParticle::ConstVector buildTrees( const LHCb::MCParticle::Container& input );
    // ========================================================================
    /** Simple function which 'builds' the trees
     *
     *  @code
     ...
     *  @return container of MCtrees
     */
    LHCb::MCParticle::ConstVector buildTrees( const LoKi::Types::MCRange& input );
    // ========================================================================
    /** Simple function which 'builds' the trees
     *
     *  @code
     ...
     *  @return container of MCtrees
     */
    LoKi::Keeper<LHCb::MCParticle> buildTrees( const LoKi::Keeper<LHCb::MCParticle>& input );
    // ========================================================================
    /** Simple function which 'builds' the trees
     *
     *  @code
     ...
     *  @return container of MCtrees
     */
    LoKi::UniqueKeeper<LHCb::MCParticle> buildTrees( const LoKi::UniqueKeeper<LHCb::MCParticle>& input );
    // ========================================================================
  } // namespace MCTrees
