...
namespace LoKi {
  namespace MCParticles {
    ...
    // ============================================================================
    std::ostream& Momentum::fillStream( std::ostream& s ) const { return s << "MCP"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Energy::fillStream( std::ostream& s ) const { return s << "MCE"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Oscillated::fillStream( std::ostream& s ) const { return s << "MCOSCILLATED"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& TransverseMomentum::fillStream( std::ostream& s ) const { return s << "MCPT"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& MomentumX::fillStream( std::ostream& s ) const { return s << "MCPX"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& MomentumY::fillStream( std::ostream& s ) const { return s << "MCPY"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& MomentumZ::fillStream( std::ostream& s ) const { return s << "MCPZ"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& PseudoRapidity::fillStream( std::ostream& s ) const { return s << "MCETA"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Rapidity::fillStream( std::ostream& s ) const { return s << "MCY"; }
    // ============================================================================
    std::ostream& Rapidity0::fillStream( std::ostream& s ) const { return s << "MCY0"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Theta::fillStream( std::ostream& s ) const { return s << "MCTHETA"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Phi::fillStream( std::ostream& s ) const { return s << "MCPHI"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Mass::fillStream( std::ostream& s ) const { return s << "MCMASS"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& Identifier::fillStream( std::ostream& s ) const { return s << "MCID"; }
    // ============================================================================
    ...
    // ============================================================================
    IsID* IsID::clone() const { return new LoKi::MCParticles::IsID( *this ); }
    // ============================================================================
    ...
    // IsNotID
    // ============================================================================
    IsNotID::IsNotID( const long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const unsigned long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const LHCb::ParticleID& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::string& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<unsigned int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<long>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<unsigned long>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<LHCb::ParticleID>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsNotID::IsNotID( const std::vector<std::string>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    ...
    // IsAbsID
    // ============================================================================
    IsAbsID::IsAbsID( const long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const unsigned long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const LHCb::ParticleID& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::string& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<unsigned int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<long>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<unsigned long>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<LHCb::ParticleID>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const std::vector<std::string>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    IsAbsID::IsAbsID( const LoKi::Pids::GetPids& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsID( id ) {}
    // ============================================================================
    ...
    // IsNotAbsID
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const unsigned long id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const LHCb::ParticleID& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::string& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<unsigned int>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<long>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<unsigned long>& id )
        : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<LHCb::ParticleID>& id )
        : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const std::vector<std::string>& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    IsNotAbsID::IsNotAbsID( const LoKi::Pids::GetPids& id ) : LoKi::AuxFunBase( std::tie( id ) ), IsAbsID( id ) {}
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& AbsIdentifier::fillStream( std::ostream& s ) const { return s << "MCABSID"; }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& ThreeCharge::fillStream( std::ostream& s ) const { return s << "MC3Q"; }
    // ============================================================================
    double ProperLifeTime::operator()( const LHCb::MCParticle* p ) const {
      ...
      //
      if ( p->endVertices().empty() ) { return LoKi::Constants::InfiniteTime; } // RETURN}
      //
      ...
      if ( !endVertex || ( LHCb::MCVertex::MCVertexType::DecayVertex != endVertex->type() &&
        ...
        for ( const LHCb::MCVertex* ev : p->endVertices() ) {
          ...
          else if ( LHCb::MCVertex::MCVertexType::DecayVertex == ev->type() ) {
            endVertex = ev;
            break;
          } // BREAK
          else if ( LHCb::MCVertex::MCVertexType::OscillatedAndDecay == ev->type() ) {
            endVertex = ev;
            break;
          } // BREAK
          else if ( LHCb::MCVertex::MCVertexType::HadronicInteraction == ev->type() ) {
            endVertex = ev;
          } // ???
        }
      }
      ...
      const double dist = ( endVertex->position() - originVertex->position() ).R();
    ...
    // ============================================================================
    std::ostream& ProperLifeTime::fillStream( std::ostream& s ) const { return s << "MCCTAU"; }
    // ============================================================================
    //  constructor from Quark
    // ============================================================================
    HasQuark::HasQuark( const LHCb::ParticleID::Quark quark ) : m_quark( quark ) {}
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsCharged::fillStream( std::ostream& s ) const { return s << "CHARGED"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsNeutral::fillStream( std::ostream& s ) const { return s << "NEUTRAL"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsLepton::fillStream( std::ostream& s ) const { return s << "LEPTON"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsMeson::fillStream( std::ostream& s ) const { return s << "MESON"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsBaryon::fillStream( std::ostream& s ) const { return s << "BARYON"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsHadron::fillStream( std::ostream& s ) const { return s << "HADRON"; }
    // ============================================================================
    // the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsNucleus::fillStream( std::ostream& s ) const { return s << "NUCLEUS"; }
    // ============================================================================
    FromMCDecayTree::FromMCDecayTree( const LHCb::MCParticle* mcp ) : m_cont( 1, mcp ) {}
    // ============================================================================
    FromMCDecayTree::FromMCDecayTree( const LoKi::MCTypes::MCRange& cnt ) : m_cont( cnt.begin(), cnt.end() ) {}
    // ============================================================================
    FromMCDecayTree::FromMCDecayTree( const LoKi::MCTypes::MCContainer& cnt ) : m_cont( cnt.begin(), cnt.end() ) {}
    // ============================================================================
    ...
    // ============================================================================
    FromMCDecayTree* FromMCDecayTree::clone() const { return new FromMCDecayTree( *this ); }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& FromMCDecayTree::fillStream( std::ostream& s ) const { return s << "FROMMCTREE"; }
    // ============================================================================
    NinMCdownTree::NinMCdownTree( const LoKi::BasicFunctors<const LHCb::MCParticle*>::Predicate& cut )
        : LoKi::AuxFunBase( std::tie( cut ) ), m_cut( cut ) {}
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& NinMCdownTree::fillStream( std::ostream& s ) const { return s << "NINMCDOWN(" << m_cut << ")"; }
    // ============================================================================
    MCMotherFunction::MCMotherFunction( const LoKi::BasicFunctors<const LHCb::MCParticle*>::Function& fun,
                                        const double                                                  val )
        : LoKi::AuxFunBase( std::tie( fun, val ) ), m_val( val ), m_fun( fun ) {}
    // ============================================================================
    MCMotherFunction* MCMotherFunction::clone() const { return new MCMotherFunction( *this ); }
    // ============================================================================
    ...
    // ============================================================================
    MCMotherPredicate::MCMotherPredicate( const LoKi::BasicFunctors<const LHCb::MCParticle*>::Predicate& cut,
                                          const bool                                                     val )
        : LoKi::AuxFunBase( std::tie( cut, val ) ), m_val( val ), m_cut( cut ) {}
    // ============================================================================
    MCMotherPredicate* MCMotherPredicate::clone() const { return new MCMotherPredicate( *this ); }
    // ============================================================================
     ...
     */
    // ============================================================================
    IsParticle::IsParticle( const LHCb::MCParticle* object ) : m_objects( 1, object ) {}
    // ============================================================================
    /*  constructor from range of particles
     *  @param range range of object to be compared
     */
    // ============================================================================
    IsParticle::IsParticle( const LoKi::MCTypes::MCRange& range ) : m_objects( range.begin(), range.end() ) {}
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsParticle::fillStream( std::ostream& s ) const { return s << "ISMCPART"; }
    // ============================================================================
    /*  constructor from contained object
     *  @param object object to be compared
     */
    // ============================================================================
    IsContainedObject::IsContainedObject( const ContainedObject* object ) : m_objects( 1, object ) {}
    // ============================================================================
    //  MANDATORY: clone method ('virtual constructor')
    // ============================================================================
    IsContainedObject* IsContainedObject::clone() const { return new IsContainedObject( *this ); }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& IsContainedObject::fillStream( std::ostream& s ) const { return s << "ISMCCO"; }
    // ============================================================================
    //  constructor
    // ============================================================================
    ...
    // ============================================================================
    MomentumDistance* MomentumDistance::clone() const { return new MomentumDistance( *this ); }
    // ============================================================================
    //  MANDATORY: the only one essential method
    // ============================================================================
    ...
    std::ostream& MomentumDistance::fillStream( std::ostream& s ) const {
      return s << "MCMOMDIST*" << m_vct.Px() << "," << m_vct.Py() << "," << m_vct.Pz() << "," << m_vct.E() << ")";
    }
    // ============================================================================
    ...
    //  MANDATORY: clone function ("virtual constructor")
    // ============================================================================
    TransverseMomentumRel* TransverseMomentumRel::clone() const { return new TransverseMomentumRel( *this ); }
    // ============================================================================
    //  MANDATORY: the only one essential method
    // ============================================================================
    ...
    std::ostream& TransverseMomentumRel::fillStream( std::ostream& s ) const {
      return s << "MCPTDIR(" << m_vct.Theta() << "," << m_vct.Phi() << ")";
    }
    // ============================================================================
    //  MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    ...
    //  "SHORT" representation, @see LoKi::AuxFunBase
    // ============================================================================
    std::ostream& ValidOrigin::fillStream( std::ostream& s ) const { return s << "MCOVALID"; }
    // ============================================================================
     ...
     */
    // ============================================================================
    MCVertexFunAdapter::MCVertexFunAdapter( const LoKi::MCTypes::MCVFunc& vfunc, const double err )
        : LoKi::AuxFunBase( std::tie( vfunc, err ) ), m_fun( vfunc ), m_err( err ) {}
    // ============================================================================
    //  MANDATORY : clone method ("virtual constructor")
    // ============================================================================
    MCVertexFunAdapter* MCVertexFunAdapter::clone() const { return new MCVertexFunAdapter( *this ); }
    // ============================================================================
    //  MANDATORY: the only one essential method
    // ============================================================================
    ...
    //  "SHORT" representation, @see LoKi::AuxFunBase
    // ============================================================================
    std::ostream& MCVertexFunAdapter::fillStream( std::ostream& s ) const { return s << "MCVFASPF(" << m_fun << ")"; }
    // ============================================================================
    /*  constructor
     ...
     */
    // ============================================================================
    MCDecayPattern::MCDecayPattern( const std::string& decay, IMCDecayFinder* finder )
        : m_finder( finder ), m_decay( decay ) {}
    // ============================================================================
    /*  constructor
     *  @param decay  decay descriptor
     *  @param finder decay finder tool
     ...
     */
    // ============================================================================
    MCDecayPattern::MCDecayPattern( const std::string& decay, const LoKi::Interface<IMCDecayFinder>& finder )
        : m_finder( finder ), m_decay( decay ) {}
    // ============================================================================
    //  MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    MCDecayPattern* MCDecayPattern::clone() const { return new MCDecayPattern( *this ); }
    // ============================================================================
    //  MANDATORY: the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    MCFilter::MCFilter( const IMCParticleSelector* selector ) : m_selector( selector ) {}
    // ============================================================================
    MCFilter::MCFilter( const LoKi::Interface<IMCParticleSelector>& selector ) : m_selector( selector ) {}
    // ============================================================================
    ...
    std::ostream& MCFilter::fillStream( std::ostream& s ) const {
      s << "MCFILTER('";
      if ( m_selector.validPointer() ) { s << m_selector->type() << "'/'" << m_selector->name(); }
      return s << "')";
    }
    // ============================================================================
    //  constructor from the phi
    // ============================================================================
    DeltaPhi::DeltaPhi( const double phi ) : LoKi::AuxFunBase( std::tie( phi ) ), m_phi( phi ) {
      m_phi = adjust( m_phi );
    }
    // ============================================================================
    //  constructor from the vector
    // ============================================================================
    DeltaPhi::DeltaPhi( const LoKi::ThreeVector& v ) : LoKi::AuxFunBase( std::tie( v ) ), m_phi( v.Phi() ) {
      m_phi = adjust( m_phi );
    }
    // ============================================================================
    //  constructor from the vector
    // ============================================================================
    DeltaPhi::DeltaPhi( const LoKi::LorentzVector& v ) : LoKi::AuxFunBase( std::tie( v ) ), m_phi( v.Phi() ) {
      m_phi = adjust( m_phi );
    }
    // ============================================================================
    ...
    // ============================================================================
    std::ostream& DeltaPhi::fillStream( std::ostream& s ) const { return s << "MCDPHI(" << m_phi << ")"; }
    // ============================================================================
    //  constructor from the eta
    // ============================================================================
    DeltaEta::DeltaEta( const double eta ) : LoKi::AuxFunBase( std::tie( eta ) ), PseudoRapidity(), m_eta( eta ) {}
    // ============================================================================
    //  constructor from the vector
    // ============================================================================
    DeltaEta::DeltaEta( const LoKi::ThreeVector& v )
        : LoKi::AuxFunBase( std::tie( v ) ), PseudoRapidity(), m_eta( v.Eta() ) {}
    // ============================================================================
    ...
    //  OPTIONAL: "SHORT" representation
    // ============================================================================
    std::ostream& DeltaEta::fillStream( std::ostream& s ) const { return s << "MCDETA(" << m_eta << ")"; }
    // ============================================================================
    //  constructor from the eta and  phi
    // ============================================================================
    DeltaR2::DeltaR2( const double eta, const double phi )
        : LoKi::AuxFunBase( std::tie( eta, phi ) ), DeltaPhi( phi ), m_deta( eta ) {}
    // ============================================================================
    //  constructor from the vector
    // ============================================================================
    DeltaR2::DeltaR2( const LoKi::ThreeVector& v ) : LoKi::AuxFunBase( std::tie( v ) ), DeltaPhi( v ), m_deta( v ) {}
    // ============================================================================
    //  constructor from the vector
    // ============================================================================
    DeltaR2::DeltaR2( const LoKi::LorentzVector& v ) : LoKi::AuxFunBase( std::tie( v ) ), DeltaPhi( v ), m_deta( v ) {}
    // ============================================================================
    //  constructor from the particle
    // ============================================================================
    DeltaR2::DeltaR2( const LHCb::MCParticle* v ) : DeltaPhi( v ), m_deta( v ) {}
    // ============================================================================
    //  MANDATORY: the only essential method
    // ============================================================================
    ...
    // ============================================================================
    MCReconstructible::MCReconstructible( const IMCReconstructible* tool ) : m_eval( tool ) {}
    // ============================================================================
    // constructor form the tool
    // ============================================================================
    MCReconstructible::MCReconstructible( const LoKi::Interface<IMCReconstructible>& tool ) : m_eval( tool ) {}
    // ============================================================================
    // MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    MCReconstructible* MCReconstructible::clone() const { return new MCReconstructible( *this ); }
    // ============================================================================
    // MANDATORY: the only one essential method
    // ============================================================================
    ...
    // ============================================================================
    MCReconstructibleAs::MCReconstructibleAs( const IMCReconstructible*             tool,
                                              const IMCReconstructible::RecCategory cat )
        : m_eval( tool ), m_cat( cat ) {}
    // ============================================================================
    // constructor from the tool and category
    // ============================================================================
    MCReconstructibleAs::MCReconstructibleAs( const IMCReconstructible::RecCategory cat,
                                              const IMCReconstructible*             tool )
        : m_eval( tool ), m_cat( cat ) {}
    // ============================================================================
    // constructor from the holder and category
    // ============================================================================
    MCReconstructibleAs::MCReconstructibleAs( const LoKi::Interface<IMCReconstructible>& tool,
                                              const IMCReconstructible::RecCategory      cat )
        : m_eval( tool ), m_cat( cat ) {}
    // ============================================================================
    // constructor from the holder and category
    ...
    // MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    MCReconstructibleAs* MCReconstructibleAs::clone() const { return new MCReconstructibleAs( *this ); }
    // ============================================================================
    // MANDATORY: the only one essential method
    // ============================================================================
     ...
     */
    // ============================================================================
    ChildFunction::ChildFunction( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCChild::Selector& child,
                                  const double bad )
        : LoKi::AuxFunBase( std::tie( fun, child, bad ) ), m_fun( fun ), m_child( child ), m_bad( bad ) {
     ...
     */
    // ============================================================================
    ChildFunction::ChildFunction( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCTypes::MCCuts& child,
                                  const double bad )
        : LoKi::AuxFunBase( std::tie( fun, child, bad ) ), m_fun( fun ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
     ...
     */
    // ============================================================================
    ChildFunction::ChildFunction( const LoKi::MCTypes::MCFunc& fun, const std::string& child, const double bad )
        : LoKi::AuxFunBase( std::tie( fun, child, bad ) ), m_fun( fun ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
    // ============================================================================
     ...
     */
    // ============================================================================
    ChildFunction::ChildFunction( const LoKi::MCTypes::MCFunc& fun, const Decays::IMCDecay::iTree& child,
                                  const double bad )
     ...
     */
    // ============================================================================
    ChildFunction::ChildFunction( const LoKi::MCTypes::MCFunc& fun, const Decays::iNode& child, const double bad )
        : LoKi::AuxFunBase( std::tie( fun, child, bad ) ), m_fun( fun ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
    // ============================================================================
    //  MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    ChildFunction* ChildFunction::clone() const { return new ChildFunction( *this ); }
    // ============================================================================
    //  MANDATORY: the only one essential method
    // ============================================================================
     ...
     */
    // ============================================================================
    ChildPredicate::ChildPredicate( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCChild::Selector& child,
                                    const bool bad )
        : LoKi::AuxFunBase( std::tie( cut, child, bad ) ), m_cut( cut ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
    // ============================================================================
    /*  constructor from the function and child selector
     ...
     */
    // ============================================================================
    ChildPredicate::ChildPredicate( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCTypes::MCCuts& child,
                                    const bool bad )
        : LoKi::AuxFunBase( std::tie( cut, child, bad ) ), m_cut( cut ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
     ...
     */
    // ============================================================================
    ChildPredicate::ChildPredicate( const LoKi::MCTypes::MCCuts& cut, const std::string& child, const bool bad )
        : LoKi::AuxFunBase( std::tie( cut, child, bad ) ), m_cut( cut ), m_child( child ), m_bad( bad ) {
      Assert( m_child.valid(), "Child selector is invalid!" );
    }
    // ============================================================================
     ...
     */
    // ============================================================================
    ChildPredicate::ChildPredicate( const LoKi::MCTypes::MCCuts& cut, const Decays::IMCDecay::iTree& child,
                                    const bool bad )
     ...
     */
    // ============================================================================
    ChildPredicate::ChildPredicate( const LoKi::MCTypes::MCCuts& cut, const Decays::iNode& child,
                                    const bool bad )
        : LoKi::AuxFunBase() // can't be reconstructed from C++
        , m_cut( cut )
        , m_child( child )
    ...
    //  MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    ChildPredicate* ChildPredicate::clone() const { return new ChildPredicate( *this ); }
    // ============================================================================
    // MANDATORY: the only one essential method
    // ============================================================================
     ...
     */
    // ============================================================================
    InTree::InTree( const LoKi::MCTypes::MCCuts& cut, const bool decayOnly )
        : LoKi::AuxFunBase( std::tie( cut, decayOnly ) ), m_cut( cut ), m_decayOnly( decayOnly ) {}
    // ============================================================================
    // MANDATORY: clone function ("virtual constructor")
    // ============================================================================
    ...
    std::ostream& InTree::fillStream( std::ostream& s ) const {
      return s << "MCINTREE(" << LoKi::Print::print( m_cut ) << "," << LoKi::Print::print( m_decayOnly ) << ")";
    }
    // ============================================================================
    /*  standard constructor
     *  @param cut cut to be checked
     ...
     */
    // ============================================================================
    NinTree::NinTree( const LoKi::MCTypes::MCCuts& cut, const bool decayOnly )
        : LoKi::AuxFunBase( std::tie( cut, decayOnly ) ), m_cut( cut ), m_decayOnly( decayOnly ) {}
    // ============================================================================
    // MANDATORY: clone function ("virtual constructor")
    // ============================================================================
    ...
    std::ostream& NinTree::fillStream( std::ostream& s ) const {
      return s << "MCNINTREE(" << LoKi::Print::print( m_cut ) << "," << LoKi::Print::print( m_decayOnly ) << ")";
    }
    // ============================================================================
    /*  standard constructor
     ...
     */
    // ============================================================================
    SumTree::SumTree( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCTypes::MCCuts& cut, const bool decayOnly,
                      const double result )
     ...
     */
    // ============================================================================
    SumTree::SumTree( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCTypes::MCFunc& fun, const bool decayOnly,
                      const double result )
    ...
    std::ostream& SumTree::fillStream( std::ostream& s ) const {
      s << "MCSUMTREE(" << m_fun << "," << m_cut << "," << LoKi::Print::print( m_decayOnly );
      if ( 0 != m_res ) { s << "," << LoKi::Print::print( m_res ); }
      return s << ")";
    }
    // ============================================================================
    /*  standard constructor
     ...
     */
    // ============================================================================
    MultTree::MultTree( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCTypes::MCCuts& cut, const bool decayOnly,
                        const double result )
        : LoKi::AuxFunBase( std::tie( fun, cut, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
     ...
     */
    // ============================================================================
    MultTree::MultTree( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCTypes::MCFunc& fun, const bool decayOnly,
                        const double result )
        : LoKi::AuxFunBase( std::tie( cut, fun, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
    ...
    std::ostream& MultTree::fillStream( std::ostream& s ) const {
      s << "MCMULTTREE(" << m_fun << "," << m_cut << "," << LoKi::Print::print( m_decayOnly );
      if ( 1 != m_res ) { s << "," << LoKi::Print::print( m_res ); }
      return s << ")";
    }
    // ============================================================================
    /*  standard constructor
     ...
     */
    // ============================================================================
    MinTree::MinTree( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCTypes::MCCuts& cut, const bool decayOnly,
                      const double result )
        : LoKi::AuxFunBase( std::tie( fun, cut, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
     ...
     */
    // ============================================================================
    MinTree::MinTree( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCTypes::MCFunc& fun, const bool decayOnly,
                      const double result )
        : LoKi::AuxFunBase( std::tie( cut, fun, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
    ...
    std::ostream& MinTree::fillStream( std::ostream& s ) const {
      s << "MCMINTREE(" << m_fun << "," << m_cut << "," << LoKi::Print::print( m_decayOnly );
      if ( LoKi::Constants::PositiveInfinity != m_res ) { s << "," << LoKi::Print::print( m_res ); }
      return s << ")";
    }
    // ============================================================================
    /*  standard constructor
     ...
     */
    // ============================================================================
    MaxTree::MaxTree( const LoKi::MCTypes::MCFunc& fun, const LoKi::MCTypes::MCCuts& cut, const bool decayOnly,
                      const double result )
        : LoKi::AuxFunBase( std::tie( fun, cut, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
     ...
     */
    // ============================================================================
    MaxTree::MaxTree( const LoKi::MCTypes::MCCuts& cut, const LoKi::MCTypes::MCFunc& fun, const bool decayOnly,
                      const double result )
        : LoKi::AuxFunBase( std::tie( cut, fun, decayOnly, result ) )
        , m_fun( fun )
        , m_cut( cut )
    ...
    std::ostream& MaxTree::fillStream( std::ostream& s ) const {
      s << "MCMAXTREE(" << m_fun << "," << m_cut << "," << LoKi::Print::print( m_decayOnly );
      if ( LoKi::Constants::NegativeInfinity != m_res ) { s << "," << LoKi::Print::print( m_res ); }
      return s << ")";
    }
    ...
    // ============================================================================
    NinAncestors::NinAncestors( const LoKi::MCTypes::MCCuts& cuts, const bool decayOnly )
        : LoKi::AuxFunBase( std::tie( cuts, decayOnly ) ), m_cut( cuts ), m_decayOnly( decayOnly ) {}
    // ============================================================================
    // MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    ...
    // ============================================================================
    double NinAncestors::operator()( const LHCb::MCParticle* p ) const { return nInAncestors( p ); }
    // ============================================================================
    ...
    // constructor from the predicate
    // ============================================================================
    InAncestors::InAncestors( const LoKi::MCTypes::MCCuts& cuts, const bool decayOnly )
    ...
    // MANDATORY: the only one important method
    // ============================================================================
    bool InAncestors::operator()( const LHCb::MCParticle* p ) const { return inAncestors( p ); }
    // ============================================================================
    // the actual evaluator
    // ============================================================================
    ...
    bool FromDecays::operator()( const LHCb::MCParticle* p ) const {
      ...
      while ( 0 != vertex ) {
        switch ( vertex->type() ) {
        case LHCb::MCVertex::MCVertexType::ppCollision:
          break;
        case LHCb::MCVertex::MCVertexType::DecayVertex:
          break;
        case LHCb::MCVertex::MCVertexType::OscillatedAndDecay:
          break;
        default:
          return false; // RETURN
        }
    ...
    // OPTIONAL: "SHORT" representation
    // ============================================================================
    std::ostream& FromDecays::fillStream( std::ostream& s ) const { return s << " MCFROMDECAYS "; }
    // ============================================================================

    // ============================================================================
    // MANDATORY: clone method ("virtual constructor")
    // ============================================================================
    FromInteractions* FromInteractions::clone() const { return new FromInteractions( *this ); }
    // ============================================================================
    // MANDATORY: the only one essential method
    // ============================================================================
    ...
    // OPTIONAL: "SHORT" representation
    // ============================================================================
    std::ostream& FromInteractions::fillStream( std::ostream& s ) const { return s << " MCFROMXS"; }
    // ============================================================================
    ...
    // OPTIONAL: "SHORT" representation
    // ============================================================================
    std::ostream& Signal::fillStream( std::ostream& s ) const { return s << " MCSIGNAL"; }
    // ============================================================================
    ...
    // OPTIONAL: "SHORT" representation
    // ============================================================================
    std::ostream& FromSignal::fillStream( std::ostream& s ) const { return s << " MCFROMSIGNAL"; }
    // ============================================================================
    ...
    // ============================================================================
    std::size_t hash( const LHCb::MCParticle* particle ) { return !particle ? 0 : s_hash( particle ); }
    // ============================================================================
    // get hash function for HepMC::GenVertex
    // ============================================================================
    std::size_t hash( const LHCb::MCVertex* vertex ) { return !vertex ? 0 : s_hash( vertex ); }
