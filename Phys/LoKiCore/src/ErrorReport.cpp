 ...
 */
// ============================================================================
const LoKi::IReporter* LoKi::ErrorReport::reporter() const { return m_reporter; }
// ============================================================================
/*  set new active Reporter
 *  @return status code
 */
// ============================================================================
StatusCode LoKi::ErrorReport::setReporter( const LoKi::IReporter* reporter ) {
  m_reporter = reporter;
  return StatusCode::SUCCESS;
}
// ============================================================================
...
StatusCode LoKi::ErrorReport::Print( const std::string& msg, const StatusCode& st, const MSG::Level lev ) const {
  ...
  if ( MSG::ALWAYS == lev ) {
    std::cerr << "  ALWAYS ";
  } else if ( MSG::FATAL == lev ) {
    std::cerr << "   FATAL ";
  } else if ( MSG::ERROR == lev ) {
    std::cerr << "   ERROR ";
  } else if ( MSG::WARNING == lev ) {
    std::cerr << " WARNING ";
  } else if ( MSG::INFO == lev ) {
    std::cerr << "    INFO ";
  } else if ( MSG::DEBUG == lev ) {
    std::cerr << "   DEBUG ";
  } else {
    std::cerr << "         ";
  }
