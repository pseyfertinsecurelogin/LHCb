...
// ============================================================================
LoKi::Base& LoKi::Base::operator=( const LoKi::Base& right ) {
 ...
 */
// ============================================================================
StatusCode LoKi::Base::Error( const std::string& msg, const StatusCode st, const size_t mx ) const {
  return m_reporter.validPointer() ? m_reporter->Error( msg, st, mx )
 ...
 */
// ============================================================================
StatusCode LoKi::Base::Warning( const std::string& msg, const StatusCode st, const size_t mx ) const {
  return m_reporter.validPointer() ? m_reporter->Warning( msg, st, mx )
 ...
 */
// ============================================================================
void LoKi::Base::Print( const std::string& msg, const StatusCode st, const MSG::Level lev ) const {
  st.ignore();
 ...
 */
// ============================================================================
void LoKi::Base::Exception( const std::string& msg, const GaudiException& exc, const StatusCode sc ) const {
  sc.ignore();
  if ( m_reporter.validPointer() ) {
 ...
 */
// ============================================================================
void LoKi::Base::Exception( const std::string& msg, const std::exception& exc, const StatusCode sc ) const {
  sc.ignore();
  if ( m_reporter.validPointer() ) {
    m_reporter->Exception( msg, exc, sc );
  } else {
 ...
 */
// ============================================================================
void LoKi::Base::Exception( const std::string& msg, const StatusCode sc ) const {
  sc.ignore();
  if ( m_reporter.validPointer() ) {
