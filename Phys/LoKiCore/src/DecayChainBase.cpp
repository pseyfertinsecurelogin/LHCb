...
// ============================================================================
std::string LoKi::DecayChainBase::toString( const LoKi::LorentzVector& v ) const
{ return toString( v , mode() ) ; }
// ============================================================================
namespace
{
  // ==========================================================================
  inline double adjust( const double value       ,
                        const double limit       ,
...
// Lorentz vector as string
// ============================================================================
std::string LoKi::DecayChainBase::toString( const LoKi::LorentzVector&  v    ,
                                            const DecayChainBase::Mode& mode ) const
{
  ...
  case LV_MASS : {
    boost::format fmter ( " M/E/PX/PY/PZ:" +
                          ...
                          m_fmt_p + "/"    +
                          m_fmt_p          + " [GeV] " ) ;
    fmter %  adjust ( v.M     () , s_Min , Gaudi::Units::GeV )
  ...
  case LV_ONLYP: {
    boost::format fmter ( " PX/PY/PZ:"   +
                          ...
                          m_fmt_p + "/"  +
                          m_fmt_p        + " [GeV] " ) ;
    fmter %  adjust ( v.Px    () , s_Min , Gaudi::Units::GeV  )
          %  adjust ( v.Py    () , s_Min , Gaudi::Units::GeV )
          %  adjust ( v.Pz    () , s_Min , Gaudi::Units::GeV ) ;
    //
    return fmter.str() ;
  ...
  default: { // the default scenario
    ...
    fmter %  adjust ( v.E     () , s_Min , Gaudi::Units::GeV )
          %  adjust ( v.Px    () , s_Min , Gaudi::Units::GeV )
          %  adjust ( v.Py    () , s_Min , Gaudi::Units::GeV )
          %  adjust ( v.Pz    () , s_Min , Gaudi::Units::GeV ) ;
    //
...
std::string LoKi::DecayChainBase::toString( const LoKi::Vector3D& v ) const
{
  ...
  boost::format fmter ( " X/Y/Z:"     +
                        ...
                        m_fmt_v + "/" +
                        m_fmt_v       + " [mm] " ) ;
  fmter %  adjust ( v.X() , s_Min , Gaudi::Units::mm )
