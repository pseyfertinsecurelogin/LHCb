...
// ============================================================================
LoKi::Status::Check::Check( const std::string& nickname )
    : LoKi::AuxFunBase( std::tie( nickname ) ), m_nickname( nickname ) {
  if ( gaudi() ) { getTool(); }
}
// ============================================================================
...
// ============================================================================
LoKi::Status::Check* LoKi::Status::Check::clone() const { return new LoKi::Status::Check( *this ); }
// ============================================================================
// MANDATORY: the only one essential method
// ============================================================================
bool LoKi::Status::Check::operator()() const {
  if ( !m_tool ) { getTool(); }
...
// ============================================================================
std::ostream& LoKi::Status::Check::fillStream( std::ostream& s ) const {
  s << " CHECK(";
...
// constructor from tool nickname
// ============================================================================
LoKi::Status::Accept::Accept( const std::string& nickname )
    : LoKi::AuxFunBase( std::tie( nickname ) ), m_nickname( nickname ), m_tool() {
  if ( gaudi() ) { getTool(); }
}
// ============================================================================
// MANDATORY: virtual destructor
...
// MANDATORY: clone method ("virtual constructor")
// ============================================================================
LoKi::Status::Accept* LoKi::Status::Accept::clone() const { return new LoKi::Status::Accept( *this ); }
// ============================================================================
// MANDATORY: the only one essential method
// ============================================================================
bool LoKi::Status::Accept::operator()() const {
  if ( !m_tool ) { getTool(); }
...
// OPTIONAL: nice printout
// ============================================================================
std::ostream& LoKi::Status::Accept::fillStream( std::ostream& s ) const {
  s << " ACCEPT(";
  Gaudi::Utils::toStream( m_nickname, s );
  return s << ") ";
}
