...
// ========================================================================
MsgStream& LoKi::Print::Printer::print_string( MsgStream& s, const std::string& what ) {
...
// make printout of DataObject
// ============================================================================
std::string LoKi::Print::toString( const DataObject* obj ) { return LoKi::Print::Printer::toString( obj ); }
// ============================================================================
// make printout of DataObject
// ============================================================================
std::string LoKi::Print::toString( const ContainedObject* obj ) { return LoKi::Print::Printer::toString( obj ); }
// ============================================================================
//  helper function
// ============================================================================
MsgStream& LoKi::Print::print_string( MsgStream& s, const std::string& what ) {
  if ( s.isActive() ) { s.stream() << what; }
  return s;
}
// ========================================================================
