...
# =============================================================================
def buildDoc(instances, ftypes, verbose=True):
...
def getSymbols(modules=[]):
    ...
    """
    if not modules:
        modules = ('LoKiCore.decorators', 'LoKiNumbers.decorators',
                   'LoKiGen.decorators', 'LoKiMC.decorators',
                   'LoKiGenMC.decorators', 'LoKiPhys.decorators',
                   'LoKiPhysMC.decorators', 'LoKiAlgo.decorators',
                   'LoKiAlgoMC.decorators', 'LoKiArrayFunctors.decorators',
                   'LoKiTrigger.decorators', 'LoKiHlt.decorators',
                   'LoKiHlt.algorithms')
...
# dump argument
    ...
    for fun in funcs:
        ...
        for attr in ('__or__', '__and__', '__invert__'):
...
# dump argument
    ...
    for cut in cuts:
        ...
        for attr in ('__eq__', '__ne__', '__lt__', '__lt__', '__gt__',
                     '__ge__'):
