...
namespace LoKi {
  ...
  namespace Functors {
    ...
    public:
       ...
       *  @param stream the stream
       */
      Dump1_( LoKi::Assignable_t<Fun_> fun, const std::string& open = "", const std::string& close = "\n",
              const bool right = true, std::ostream& stream = std::cout )
    ...
    // ========================================================================
    template <class TYPE1, class TYPE2>
    std::ostream& LoKi::Functors::Dump1_<TYPE1, TYPE2>::fillStream( std::ostream& s ) const {
      s << " dump1 ( " << this->m_fun;
