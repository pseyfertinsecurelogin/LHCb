 ...
 */
// ============================================================================
namespace LoKi::Kinematics::Polarization {
  // ========================================================================
  /** @class Polarization
   ...
   */
  Frame frame( const Frames f, const LoKi::LorentzVector& P, const LoKi::LorentzVector& beam1,
               const LoKi::LorentzVector& beam2, const UseMadisonConvention madison = UseMadisonConvention{true} );
  // =====================================================================
  /** get the polarization vectors from the frame
   *  @param f the frame
   *  @return polarization vectors (-1,0,+1)
   */
  PolVectors vectors( const Frame& f );
  // =====================================================================
   ...
   */
  Cosines cosines( const LoKi::LorentzVector& p, const Frame& f );
  // ====================================================================
  /** get the direction cosines of the particle direction
   ...
   */
  Cosines cosines( const LoKi::LorentzVector& p, const Frames f, const LoKi::LorentzVector& m,
   ...
   */
  Angles angles( const LoKi::LorentzVector& p, const Frame& f );
  // ====================================================================
  /** get the angles \$ (\cos \theta,\phi)\$ for the particle
   *  in the rest frame of particle m,  and the beam-momenta p1& p2
   *  @param p the particle
   ...
   *  @return  \$ (\cos \theta,\phi)\$ structure
   */
  Angles angles( const LoKi::LorentzVector& p, const Frames f, const LoKi::LorentzVector& m,
                 const LoKi::LorentzVector& beam1, const LoKi::LorentzVector& beam2,
                 const UseMadisonConvention madison = UseMadisonConvention{true} );
  // =====================================================================
  // =======================================================================
