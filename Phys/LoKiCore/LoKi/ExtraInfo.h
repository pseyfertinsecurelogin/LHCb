...
namespace LoKi {
  ...
  namespace ExtraInfo {
    ...
    public:
      ...
      GetInfo( const int index, T2 value = defaultValue )
          : LoKi::AuxFunBase( std::tie( index, value ) ), m_index( index ), m_default( value ) {}
    ...
    public:
      ...
      explicit CheckInfo( const int index ) : LoKi::AuxFunBase( std::tie( index ) ), m_index( index ) {}
      /// MANDATORY: clone method ("virtual constructor")
    ...
    public:
      ...
      GetSmartInfo( const int index, LoKi::FunctorFromFunctor<TYPE, TYPE2> fun, const bool update = false )
      ...
      TYPE2 operator()( typename LoKi::Functor<TYPE, TYPE2>::argument a ) const override {
        ...
        if ( LoKi::ExtraInfo::hasInfo( a, m_index ) ) {
          return LoKi::ExtraInfo::info( a, m_index, defaultValue );
        } // RETURN
  ...
  namespace ExtraInfo2 {
    ...
    public:
      ...
      LogInfo( const LoKi::FunctorFromFunctor<TYPE, TYPE2> fun, const int index )
          : LoKi::AuxFunBase( std::tie( fun, index ) ), m_fun( std::move( fun ) ), m_index( index ) {}
      /// MANDATORY: clone method ("virtual constructor")
