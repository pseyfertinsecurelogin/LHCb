...
namespace LoKi {
  ...
  public:
     ...
     *  @param range range
     */
    explicit RangeList_( const Range& range ) : m_ranges( 1, range ) {}
    /** constructor
     *  create list from 2 ranges
     *  @param range1 range
     *  @param range2 range
     */
    RangeList_( const Range& range1, const Range& range2 ) : m_ranges() {
  ...
  public:
    ...
    /// indexing operator
    const Range& operator()( size_t index ) const { return ( *this )[index]; }
    /// sequential access
...
inline LoKi::RangeList_<RANGE> operator+( const LoKi::RangeList_<RANGE>& range1, const OTHER& range2 ) {
...
// ============================================================================
template <class RANGE>
inline LoKi::RangeList_<RANGE> operator+( const typename LoKi::RangeList_<RANGE>::Range& range1,
