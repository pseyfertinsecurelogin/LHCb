...
namespace LoKi {
  ...
  namespace Particles {
     ...
     */
    GAUDI_API
    std::vector<LHCb::ParticleID> pidsFromNames( const std::vector<std::string>& names );
    // ========================================================================
    ...
    inline double lifeTime( const std::string& name ) { return ctau( name ); }
    // ========================================================================
    ...
    inline double lifeTime( const LHCb::ParticleID& pid ) { return ctau( pid ); }
    // ========================================================================
     ...
     */
    GAUDI_API
    const LHCb::ParticleProperty* antiParticle( const LHCb::ParticleProperty* pp );
    // ========================================================================
...
namespace std {
  //
  GAUDI_API
  std::vector<LHCb::ParticleID> abs( const std::vector<LHCb::ParticleID>& pid );
  //
} // namespace std
// ============================================================================
//                                                                      The END
