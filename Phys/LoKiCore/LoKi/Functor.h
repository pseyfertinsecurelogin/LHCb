...
namespace LoKi {
  ...
  public:
    ...
    FunctorFromFunctor( const Functor<TYPE, TYPE2>& right )
        : LoKi::AuxFunBase( right ), LoKi::Functor<TYPE, TYPE2>( right ), m_fun( right.clone() ) {}
    /// copy constructor (deep copy)
    FunctorFromFunctor( const FunctorFromFunctor& right )
        : LoKi::AuxFunBase( right ), LoKi::Functor<TYPE, TYPE2>( right ), m_fun( right.m_fun->clone() ) {}
    ...
    TYPE2
    operator()( typename functor::argument a ) const override { return fun( a ); }
  ...
  public:
    ...
    /// the only one essential method ("function")
    virtual TYPE2 evaluate() const { return ( *this )(); }
    /// the only one essential method ("function")
    virtual TYPE2 eval() const { return ( *this )(); }
    /// clone method
    virtual Functor* clone() const = 0;
    /// virtual destructor
    virtual ~Functor() = default;
  ...
  public:
    ...
    FunctorFromFunctor( const Functor<void, TYPE2>& right )
        : LoKi::AuxFunBase( right ), LoKi::Functor<void, TYPE2>( right ), m_fun( right.clone() ) {}
    /// copy constructor (deep copy)
    FunctorFromFunctor( const FunctorFromFunctor& right )
        : LoKi::AuxFunBase( right ), LoKi::Functor<void, TYPE2>( right ), m_fun( right.m_fun->clone() ) {}
    /// move constructor (avoid cloning)
    FunctorFromFunctor( FunctorFromFunctor&& right ) = default;
    // ========================================================================
    /// the assignement operator is enabled
  ...
  public:
    ...
    FunctorFromFunctor* clone() const override { return new FunctorFromFunctor( *this ); }
    /// MANDATORY: the only one essential method
    TYPE2 operator()() const override { return fun(); }
    /// OPTIONAL: the basic printout method, delegate to the underlying object
    std::ostream& fillStream( std::ostream& s ) const override { return m_fun->fillStream( s ); };
    /// OPTIONAL: unique function ID, delegate to the underlying objects
    std::size_t id() const override { return m_fun->id(); }
  ...
  namespace details {
    ...
    struct LF_ {
      ...
      static T1 test1( LoKi::Functor<T1, T2>* );
      template <typename T1, typename T2>
      static T2 test2( LoKi::Functor<T1, T2>* );
      using type1 = decltype( test1( std::declval<U*>() ) );
      using type2 = decltype( test2( std::declval<U*>() ) );
    };
    template <typename... Fs>
    using type1_t = std::common_type_t<typename LF_<Fs>::type1...>;
    template <typename... Fs>
    using type2_t = std::common_type_t<typename LF_<Fs>::type2...>;

    template <typename F>
    using result_t = type2_t<F>;
    template <typename F>
  ...
  public:
    // ========================================================================
    /// constructor
    Constant( T2 value ) : LoKi::AuxFunBase( std::tie( value ) ), m_value( std::move( value ) ) {}
    // ========================================================================
  public:
    // ========================================================================
    /// assignment
    ...
    /// the only one essential method ("function")
    TYPE2 operator()( typename LoKi::Functor<TYPE, TYPE2>::argument ) const override { return m_value; }
    /// the basic printout method
    std::ostream& fillStream( std::ostream& s ) const override { return Gaudi::Utils::toStream( this->m_value, s ); }
    // ========================================================================
  private:
    // ========================================================================
    /// the constant itself
  ...
  public:
    ...
    Constant* clone() const override { return new Constant( *this ); }
    /// the only one essential method ("function")
    TYPE2 operator()() const override { return m_value; }
    /// the basic printout method
    std::ostream& fillStream( std::ostream& s ) const override { return Gaudi::Utils::toStream( this->m_value, s ); }
    // ========================================================================
  private:
  ...
  namespace V2 {
    namespace details {
      ...
      struct functor_helper<Result( Arg )> {
