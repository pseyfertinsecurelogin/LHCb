...
namespace LoKi {
  ...
  public:
    // ========================================================================
    MarkStream( STREAM& stream, const bool mark, const MSG::Color& fg, const MSG::Color& bg )
        : m_stream( stream ), m_mark( mark ), m_fg( fg ), m_bg( bg ) {
      if ( m_mark ) { LoKi::Colors::setColor( m_stream, m_fg, m_bg ); }
    }
    //
    ~MarkStream() {
      if ( m_mark ) { LoKi::Colors::resetColor( m_stream ); }
    }
    // ========================================================================
  private:
    // ========================================================================
