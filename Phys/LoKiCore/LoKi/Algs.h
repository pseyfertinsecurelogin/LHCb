...
namespace LoKi {
  ...
  namespace Algs {
    ...
    inline RESULT accumulate( ITER first, ITER last, const FUNCTOR& functor, RESULT result, OPERATION binop ) {
      using reference = typename std::iterator_traits<ITER>::reference;
      return std::accumulate( first, last, result, [&]( RESULT r, reference o ) { return binop( r, functor( o ) ); } );
    }
    // ========================================================================
     ...
     *  @date   2006-02-10
     */
    template <class ITER, class RESULT, class FUNCTOR, class PREDICATE, class OPERATION>
    inline RESULT accumulate( ITER first, ITER last, const FUNCTOR& functor, const PREDICATE& predicate, RESULT result,
                              OPERATION binop ) {
    ...
    inline OUTPUT copy_if( OBJECT first, OBJECT last, OUTPUT output, PREDICATE cut ) {
    ...
    inline std::size_t count_if( OBJECT first, OBJECT last, const PREDICATE& cuts ) {
      return std::count_if( first, last, std::cref( cuts ) );
    }
    // ========================================================================
    /// a bit modified version of std::find_if
    template <class OBJECT, class PREDICATE>
    inline OBJECT find_if( OBJECT first, OBJECT last, const PREDICATE& cuts ) {
      return std::find_if( first, last, std::cref( cuts ) );
    }
    // ========================================================================
    /// useful shortcut
    template <class OBJECT, class PREDICATE>
    inline bool found( OBJECT first, OBJECT last, const PREDICATE& cuts ) {
    ...
    inline auto extremum( ITER first, ITER last, const FUNCTION& fun, BINOP binop )
    ...
    inline auto extremum( OBJECT first, OBJECT last, const FUNCTION& fun, const PREDICATE& cut, BINOP binop )
    ...
    inline OBJECT select_min( OBJECT first, OBJECT last, const FUNCTION& fun, const PREDICATE& cut ) {
      return LoKi::Algs::extremum( first, last, fun, cut, std::less{} ).first;
    }
    // ========================================================================
    /** select element from the sequence with maximal value of
     *  given function
     ...
     */
    template <class OBJECT, class FUNCTION, class PREDICATE>
    inline OBJECT select_max( OBJECT first, OBJECT last, const FUNCTION& fun, const PREDICATE& cut ) {
      return LoKi::Algs::extremum( first, last, fun, cut, std::greater{} ).first;
    }
    // ========================================================================
    /** select element from the sequence with maximal value of
     *  given function
    ...
    inline OBJECT select_min( OBJECT first, OBJECT last, const FUNCTION& fun ) {
      return LoKi::Algs::extremum( first, last, fun, std::less{} ).first;
    }
    // ========================================================================
     ...
     */
    template <class OBJECT, class FUNCTION>
    inline OBJECT select_max( OBJECT first, OBJECT last, const FUNCTION& fun ) {
      return LoKi::Algs::extremum( first, last, fun, std::greater{} ).first;
    }
    // ========================================================================
    ...
    inline RESULT min_value( OBJECT first, OBJECT last, const FUNCTION& fun, RESULT result ) {
      using arg_t = decltype( *first );
      return std::accumulate( first, last, result, [&]( RESULT r, arg_t v ) { return std::min( r, fun( v ) ); } );
    }
    // ========================================================================
    ...
    inline RESULT min_value( OBJECT first, OBJECT last, const FUNCTION& fun, const PREDICATE& cut, RESULT result ) {
      using arg_t = decltype( *first );
      return std::accumulate( first, last, result,
                              [&]( RESULT r, arg_t v ) { return cut( v ) ? std::min( r, fun( v ) ) : r; } );
    }
    // ========================================================================
    /** very simple algorithm for maximum value of the function over the
     *  sequence
     ...
     */
    template <class OBJECT, class FUNCTION, class RESULT>
    inline RESULT max_value( OBJECT first, OBJECT last, const FUNCTION& fun, RESULT result ) {
      using arg_t = decltype( *first );
      return std::accumulate( first, last, result, [&]( RESULT r, arg_t v ) { return std::max( r, fun( v ) ); } );
    }
    // ========================================================================
    /** very simple algorithm for maximum value of the function over the
     *  sequence
     ...
     */
    template <class OBJECT, class FUNCTION, class PREDICATE, class RESULT>
    inline RESULT max_value( OBJECT first, OBJECT last, const FUNCTION& fun, const PREDICATE& cut, RESULT result ) {
      using arg_t = decltype( *first );
      return std::accumulate( first, last, result,
                              [&]( RESULT r, arg_t v ) { return cut( v ) ? std::max( r, fun( v ) ) : r; } );
    }
    // ========================================================================
     ...
     */
    template <class OBJECT, class PREDICATE1, class PREDICATE2>
    inline bool found_2( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2 ) {
      return _found_2( first, last, cut1, cut2 );
    }
    // ========================================================================
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3>
    inline bool _found_3( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                          const PREDICATE3& cut3, const INDICES& except = INDICES() ) {
      //
      ...
      for ( auto f1 = first; f1 != last; ++f1 ) {
        ...
        if ( cut1( *f1 ) && _found_2( first, last, cut2, cut3, updated ) ) {
          return true;
        } else if ( cut2( *f1 ) && _found_2( first, last, cut1, cut3, updated ) ) {
          return true;
        } else if ( cut3( *f1 ) && _found_2( first, last, cut1, cut2, updated ) ) {
          return true;
        }
      }
      return false;
     ...
     */
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3>
    inline bool found_3( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                         const PREDICATE3& cut3 ) {
      return _found_3( first, last, cut1, cut2, cut3 );
    }
    // ========================================================================
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3, class PREDICATE4>
    inline bool _found_4( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                          const PREDICATE3& cut3, const PREDICATE4& cut4, const INDICES& except = INDICES() ) {
      //
      ...
      for ( auto f1 = first; f1 != last; ++f1 ) {
        ...
        updated.insert( index );
        //
        if ( cut1( *f1 ) && _found_3( first, last, cut2, cut3, cut4, updated ) ) {
          return true;
        } else if ( cut2( *f1 ) && _found_3( first, last, cut1, cut3, cut4, updated ) ) {
          return true;
        } else if ( cut3( *f1 ) && _found_3( first, last, cut1, cut2, cut4, updated ) ) {
          return true;
        } else if ( cut4( *f1 ) && _found_3( first, last, cut1, cut2, cut3, updated ) ) {
          return true;
        }
      }
      return false;
     ...
     */
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3, class PREDICATE4>
    inline bool found_4( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                         const PREDICATE3& cut3, const PREDICATE4& cut4 ) {
      return _found_4( first, last, cut1, cut2, cut3, cut4 );
    }
    // ========================================================================
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3, class PREDICATE4, class PREDICATE5>
    inline bool _found_5( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                          const PREDICATE3& cut3, const PREDICATE4& cut4, const PREDICATE5& cut5,
                          const INDICES& except = INDICES() ) {
      //
      if ( last - first < 4 ) { return false; } // RETURN
      //
      for ( OBJECT f1 = first; f1 != last; ++f1 ) {
        ...
        updated.insert( index );
        //
        if ( cut1( *f1 ) && _found_4( first, last, cut2, cut3, cut4, cut5, updated ) ) {
          return true;
        } else if ( cut2( *f1 ) && _found_4( first, last, cut1, cut3, cut4, cut5, updated ) ) {
          return true;
        } else if ( cut3( *f1 ) && _found_4( first, last, cut1, cut2, cut4, cut5, updated ) ) {
          return true;
        } else if ( cut4( *f1 ) && _found_4( first, last, cut1, cut2, cut3, cut5, updated ) ) {
          return true;
        } else if ( cut5( *f1 ) && _found_4( first, last, cut1, cut2, cut3, cut4, updated ) ) {
          return true;
        }
      }
      return false;
     ...
     */
    template <class OBJECT, class PREDICATE1, class PREDICATE2, class PREDICATE3, class PREDICATE4, class PREDICATE5>
    inline bool found_5( OBJECT first, OBJECT last, const PREDICATE1& cut1, const PREDICATE2& cut2,
                         const PREDICATE3& cut3, const PREDICATE4& cut4, const PREDICATE5& cut5 ) {
      return _found_5( first, last, cut1, cut2, cut3, cut4, cut5 );
    }
    // ========================================================================
    template <class OBJECT, class PREDICATE>
    inline bool _found_N_( OBJECT first, OBJECT last, const std::vector<const PREDICATE*>& cuts,
      ...
      for ( auto f = first; last != f; ++f ) {
        ...
        if ( except.end() != except.find( index ) ) { continue; }
        //
        auto icut = std::find_if( cuts.begin(), cuts.end(), [&]( const PREDICATE* cut ) { return ( *cut )( *f ); } );
        //
    ...
    // =======================================================================
    template <class OBJECT, class PREDICATE>
    inline bool _found_N( OBJECT first, OBJECT last, const std::vector<PREDICATE>& cuts,
                          const INDICES& except = INDICES() ) {
      const std::size_t size = last - first;
      if ( size < cuts.size() + except.size() ) { return false; }
      //
      std::vector<const PREDICATE*> _cuts;
      _cuts.reserve( cuts.size() );
     ...
     */
    template <class OBJECT, class PREDICATE>
    inline bool found_N( OBJECT first, OBJECT last, const std::vector<PREDICATE>& cuts ) {
      ...
      case 3:
        return found_3( first, last, *( cuts.begin() ), *( cuts.begin() + 1 ), *( cuts.begin() + 2 ) );
      ...
      //                          *( cuts.begin () + 4 ) ) ;
      default:
        return _found_N( first, last, cuts );
      }
      return false;
    }
    // ========================================================================
