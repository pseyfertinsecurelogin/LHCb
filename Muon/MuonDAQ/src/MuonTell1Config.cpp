...
namespace {
  static const std::map<std::string, long> TUName{
      {{"TSM2R1Map1", 0}, {"TSM2R1Map2", 1}, {"TSM2R2Map1", 2}, {"TSM2R3Map1", 3}, {"TSM2R4Map1", 3},
       {"TSM3R1Map1", 0}, {"TSM3R1Map2", 1}, {"TSM3R2Map1", 2}, {"TSM3R3Map1", 3}, {"TSM3R4Map1", 3},
       {"TSM4R1Map1", 4}, {"TSM4R1Map2", 5}, {"TSM4R2Map1", 6}, {"TSM4R3Map1", 7}, {"TSM4R4Map1", 7},
       {"TSM5R1Map1", 4}, {"TSM5R1Map2", 5}, {"TSM5R2Map1", 6}, {"TSM5R3Map1", 7}, {"TSM5R4Map1", 7}}};
}
...
StatusCode MuonTell1Config::configTell1( int Tell1 ) const {
  ...
  for ( int link = 0; link < 24; link++ ) {
    ...
    if ( l1->isLinkConnected( link ) ) {
      unsigned int  ode_num = m_muonDet->getDAQInfo()->getODENumberInLink( Tell1, link );
