...
public:
  ...
  MuonSystemLayout( const MuonStationLayout& lq1, const MuonStationLayout& lq2, const MuonStationLayout& lq3,
                    const MuonStationLayout& lq4, const MuonStationLayout& lq5 );
  ...
  const MuonLayout& regionLayout( int st, int reg ) const { return m_station_layouts[st].regionLayout( reg ); }
  /// Accessor to station MuonStationLayout
  const MuonStationLayout& stationLayout( int st ) const { return m_station_layouts[st]; }
