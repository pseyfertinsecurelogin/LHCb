...
MuonStationLayout::MuonStationLayout( const MuonLayout& lq1, const MuonLayout& lq2, const MuonLayout& lq3,
                                      const MuonLayout& lq4 )
    : m_layouts{lq1, lq2, lq3, lq4} {}

std::vector<LHCb::MuonTileID> MuonStationLayout::tiles( const LHCb::MuonTileID& pad ) const {
  return tilesInArea( pad, 0, 0 );
}

std::vector<LHCb::MuonTileID> MuonStationLayout::tilesInArea( const LHCb::MuonTileID& pad, int areaX,
                                                              int areaY ) const {
...
std::vector<LHCb::MuonTileID> MuonStationLayout::tiles( int iq, int ir ) const { return m_layouts[ir].tiles( iq, ir ); }

std::vector<LHCb::MuonTileID> MuonStationLayout::tilesInRegion( const LHCb::MuonTileID& pad, int pregion ) const {

  int reg = pad.region();
  return m_layouts[reg].tilesInRegion( pad, pregion );
}

std::vector<LHCb::MuonTileID> MuonStationLayout::neighbours( const LHCb::MuonTileID& pad ) const {
...
std::vector<LHCb::MuonTileID> MuonStationLayout::neighbours( const LHCb::MuonTileID& pad, int dirX, int dirY ) const {
...
std::vector<LHCb::MuonTileID> MuonStationLayout::neighbours( const LHCb::MuonTileID& pad, int dirX, int dirY,
                                                             int depth ) const {
...
std::vector<LHCb::MuonTileID> MuonStationLayout::neighboursInArea( const LHCb::MuonTileID& pad, int dirX, int dirY,
